...
describe('QA: complete scoring coverage', () => {
  ...
  it('crossword awards every correct word', () => {
    expect(scoreCrossword([{ questionIndex: 0, isCorrect: true }, { questionIndex: 1, isCorrect: true }])).toBe(2)
  })
  ...
  it('jeopardy sums every correct tile value', () => {
    expect(scoreJeopardy([{ value: 100, isCorrect: true }, { value: 500, isCorrect: true }])).toBe(600)
  })
})
