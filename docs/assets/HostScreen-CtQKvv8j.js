...
void main() {
	...
	`}class ud extends cn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new td(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new si(5,5,5),r=new dn({name:"CubemapFromEquirect",uniforms:Li(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:zt,blending:Mn});r.uniforms.tEquirect.value=t;const a=new lt(s,r),c=t.minFilter;return t.minFilter===Yn&&(t.minFilter=Nt),new Mf(1,10,this).update(e,a),t.minFilter=c,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,i=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,i,s);e.setRenderTarget(r)}}function mg(n){let e=new WeakMap,t=new WeakMap,i=null;function s(p,g=!1){return p==null?null:g?a(p):r(p)}function r(p){if(p&&p.isTexture){const g=p.mapping;if(g===hr||g===fr)if(e.has(p)){const _=e.get(p).texture;return c(_,p.mapping)}else{const _=p.image;if(_&&_.height>0){const v=new ud(_.height);return v.fromEquirectangularTexture(n,p),e.set(p,v),p.addEventListener("dispose",l),c(v.texture,p.mapping)}else return null}}return p}function a(p){if(p&&p.isTexture){const g=p.mapping,_=g===hr||g===fr,v=g===ni||g===Ni;if(_||v){let u=t.get(p);const f=u!==void 0?u.texture.pmremVersion:0;if(p.isRenderTargetTexture&&p.pmremVersion!==f)return i===null&&(i=new Nc(n)),u=_?i.fromEquirectangular(p,u):i.fromCubemap(p,u),u.texture.pmremVersion=p.pmremVersion,t.set(p,u),u.texture;if(u!==void 0)return u.texture;{const b=p.image;return _&&b&&b.height>0||v&&b&&d(b)?(i===null&&(i=new Nc(n)),u=_?i.fromEquirectangular(p):i.fromCubemap(p),u.texture.pmremVersion=p.pmremVersion,t.set(p,u),p.addEventListener("dispose",h),u.texture):null}}}return p}function c(p,g){return g===hr?p.mapping=ni:g===fr&&(p.mapping=Ni),p}function d(p){let g=0;const _=6;for(let v=0;v<_;v++)p[v]!==void 0&&g++;return g===_}function l(p){const g=p.target;g.removeEventListener("dispose",l);const _=e.get(g);_!==void 0&&(e.delete(g),_.dispose())}function h(p){const g=p.target;g.removeEventListener("dispose",h);const _=t.get(g);_!==void 0&&(t.delete(g),_.dispose())}function m(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:m}}function gg(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const s=n.getExtension(i);return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&Ti("WebGLRenderer: "+i+" extension not supported."),s}}}function xg(n,e,t,i){const s={},r=new WeakMap;function a(m){const p=m.target;p.index!==null&&e.remove(p.index);for(const _ in p.attributes)e.remove(p.attributes[_]);p.removeEventListener("dispose",a),delete s[p.id];const g=r.get(p);g&&(e.remove(g),r.delete(p)),i.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,t.memory.geometries--}function c(m,p){return s[p.id]===!0||(p.addEventListener("dispose",a),s[p.id]=!0,t.memory.geometries++),p}function d(m){const p=m.attributes;for(const g in p)e.update(p[g],n.ARRAY_BUFFER)}function l(m){const p=[],g=m.index,_=m.attributes.position;let v=0;if(_===void 0)return;if(g!==null){const b=g.array;v=g.version;for(let S=0,T=b.length;S<T;S+=3){const w=b[S+0],y=b[S+1],N=b[S+2];p.push(w,y,y,N,N,w)}}else{const b=_.array;v=_.version;for(let S=0,T=b.length/3-1;S<T;S+=3){const w=S+0,y=S+1,N=S+2;p.push(w,y,y,N,N,w)}}const u=new(_.count>=65535?Ql:Jl)(p,1);u.version=v;const f=r.get(m);f&&e.remove(f),r.set(m,u)}function h(m){const p=r.get(m);if(p){const g=m.index;g!==null&&p.version<g.version&&l(m)}else l(m);return r.get(m)}return{get:c,update:d,getWireframeAttribute:h}}function _g(n,e,t){let i;function s(m){i=m}let r,a;function c(m){r=m.type,a=m.bytesPerElement}function d(m,p){n.drawElements(i,p,r,m*a),t.update(p,i,1)}function l(m,p,g){g!==0&&(n.drawElementsInstanced(i,p,r,m*a,g),t.update(p,i,g))}function h(m,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,r,m,0,g);let v=0;for(let u=0;u<g;u++)v+=p[u];t.update(v,i,1)}this.setMode=s,this.setIndex=c,this.render=d,this.renderInstances=l,this.renderMultiDraw=h}function vg(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,c){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=c*(r/3);break;case n.LINES:t.lines+=c*(r/2);break;case n.LINE_STRIP:t.lines+=c*(r-1);break;case n.LINE_LOOP:t.lines+=c*r;break;case n.POINTS:t.points+=c*r;break;default:Qe("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function Mg(n,e,t){const i=new WeakMap,s=new ut;function r(a,c,d){const l=a.morphTargetInfluences,h=c.morphAttributes.position||c.morphAttributes.normal||c.morphAttributes.color,m=h!==void 0?h.length:0;let p=i.get(c);if(p===void 0||p.count!==m){let R=function(){N.dispose(),i.delete(c),c.removeEventListener("dispose",R)};p!==void 0&&p.texture.dispose();const g=c.morphAttributes.position!==void 0,_=c.morphAttributes.normal!==void 0,v=c.morphAttributes.color!==void 0,u=c.morphAttributes.position||[],f=c.morphAttributes.normal||[],b=c.morphAttributes.color||[];let S=0;g===!0&&(S=1),_===!0&&(S=2),v===!0&&(S=3);let T=c.attributes.position.count*S,w=1;T>e.maxTextureSize&&(w=Math.ceil(T/e.maxTextureSize),T=e.maxTextureSize);const y=new Float32Array(T*w*4*m),N=new $l(y,T,w,m);N.type=rn,N.needsUpdate=!0;const M=S*4;for(let L=0;L<m;L++){const I=u[L],B=f[L],K=b[L],O=T*w*4*L;for(let U=0;U<I.count;U++){const W=U*M;g===!0&&(s.fromBufferAttribute(I,U),y[O+W+0]=s.x,y[O+W+1]=s.y,y[O+W+2]=s.z,y[O+W+3]=0),_===!0&&(s.fromBufferAttribute(B,U),y[O+W+4]=s.x,y[O+W+5]=s.y,y[O+W+6]=s.z,y[O+W+7]=0),v===!0&&(s.fromBufferAttribute(K,U),y[O+W+8]=s.x,y[O+W+9]=s.y,y[O+W+10]=s.z,y[O+W+11]=K.itemSize===4?s.w:1)}}p={count:m,texture:N,size:new Ze(T,w)},i.set(c,p),c.addEventListener("dispose",R)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)d.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let g=0;for(let v=0;v<l.length;v++)g+=l[v];const _=c.morphTargetsRelative?1:1-g;d.getUniforms().setValue(n,"morphTargetBaseInfluence",_),d.getUniforms().setValue(n,"morphTargetInfluences",l)}d.getUniforms().setValue(n,"morphTargetsTexture",p.texture,t),d.getUniforms().setValue(n,"morphTargetsTextureSize",p.size)}return{update:r}}function yg(n,e,t,i,s){let r=new WeakMap;function a(l){const h=s.render.frame,m=l.geometry,p=e.get(l,m);if(r.get(p)!==h&&(e.update(p),r.set(p,h)),l.isInstancedMesh&&(l.hasEventListener("dispose",d)===!1&&l.addEventListener("dispose",d),r.get(l)!==h&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,h))),l.isSkinnedMesh){const g=l.skeleton;r.get(g)!==h&&(g.update(),r.set(g,h))}return p}function c(){r=new WeakMap}function d(l){const h=l.target;h.removeEventListener("dispose",d),i.releaseStatesOfObject(h),t.remove(h.instanceMatrix),h.instanceColor!==null&&t.remove(h.instanceColor)}return{update:a,dispose:c}}const Sg={[Ll]:"LINEAR_TONE_MAPPING",[Dl]:"REINHARD_TONE_MAPPING",[Il]:"CINEON_TONE_MAPPING",[Ul]:"ACES_FILMIC_TONE_MAPPING",[Ol]:"AGX_TONE_MAPPING",[Bl]:"NEUTRAL_TONE_MAPPING",[Fl]:"CUSTOM_TONE_MAPPING"};function bg(n,e,t,i,s,r){const a=new cn(e,t,{type:n,depthBuffer:s,stencilBuffer:r,samples:i?4:0,depthTexture:s?new Pi(e,t):void 0}),c=new cn(e,t,{type:Sn,depthBuffer:!1,stencilBuffer:!1}),d=new Lt;d.setAttribute("position",new Tt([-1,3,0,-1,-1,0,3,-1,0],3)),d.setAttribute("uv",new Tt([0,2,0,0,2,0],2));const l=new mf({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter(qi).join(`
`)),a=Ya(a),a=Vc(a,t),a=Wc(a,t),c=Ya(c),c=Vc(c,t),c=Wc(c,t),a=jc(a),c=jc(c),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
`,u=[g,"#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+u,f=["#define varying in",t.glslVersion===nc?"":"layout(location = 0) out highp vec4 pc_fragColor;",t.glslVersion===nc?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+f);const S=b+u+a,T=b+f+c,w=kc(s,s.VERTEX_SHADER,S),y=kc(s,s.FRAGMENT_SHADER,T);s.attachShader(v,w),s.attachShader(v,y),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function N(I){if(n.debug.checkShaderErrors){const B=s.getProgramInfoLog(v)||"",K=s.getShaderInfoLog(w)||"",O=s.getShaderInfoLog(y)||"",U=B.trim(),W=K.trim(),V=O.trim();let Y=!0,re=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(Y=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,v,w,y);else{const fe=Hc(s,w,"vertex"),pe=Hc(s,y,"fragment");Qe("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
