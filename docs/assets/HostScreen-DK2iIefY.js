...
void main() {
	...
	`}class dd extends dn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new ed(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new ri(5,5,5),r=new hn({name:"CubemapFromEquirect",uniforms:Ii(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:zt,blending:yn});r.uniforms.tEquirect.value=t;const a=new lt(s,r),c=t.minFilter;return t.minFilter===Zn&&(t.minFilter=Nt),new jh(1,10,this).update(e,a),t.minFilter=c,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,i=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,i,s);e.setRenderTarget(r)}}function Gm(n){let e=new WeakMap,t=new WeakMap,i=null;function s(h,g=!1){return h==null?null:g?a(h):r(h)}function r(h){if(h&&h.isTexture){const g=h.mapping;if(g===hr||g===fr)if(e.has(h)){const x=e.get(h).texture;return c(x,h.mapping)}else{const x=h.image;if(x&&x.height>0){const v=new dd(x.height);return v.fromEquirectangularTexture(n,h),e.set(h,v),h.addEventListener("dispose",l),c(v.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const g=h.mapping,x=g===hr||g===fr,v=g===ii||g===Li;if(x||v){let m=t.get(h);const f=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==f)return i===null&&(i=new Rc(n)),m=x?i.fromEquirectangular(h,m):i.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{const b=h.image;return x&&b&&b.height>0||v&&b&&d(b)?(i===null&&(i=new Rc(n)),m=x?i.fromEquirectangular(h):i.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function c(h,g){return g===hr?h.mapping=ii:g===fr&&(h.mapping=Li),h}function d(h){let g=0;const x=6;for(let v=0;v<x;v++)h[v]!==void 0&&g++;return g===x}function l(h){const g=h.target;g.removeEventListener("dispose",l);const x=e.get(g);x!==void 0&&(e.delete(g),x.dispose())}function u(h){const g=h.target;g.removeEventListener("dispose",u);const x=t.get(g);x!==void 0&&(t.delete(g),x.dispose())}function p(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:p}}function Hm(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const s=n.getExtension(i);return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&Ti("WebGLRenderer: "+i+" extension not supported."),s}}}function Vm(n,e,t,i){const s={},r=new WeakMap;function a(p){const h=p.target;h.index!==null&&e.remove(h.index);for(const x in h.attributes)e.remove(h.attributes[x]);h.removeEventListener("dispose",a),delete s[h.id];const g=r.get(h);g&&(e.remove(g),r.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function c(p,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function d(p){const h=p.attributes;for(const g in h)e.update(h[g],n.ARRAY_BUFFER)}function l(p){const h=[],g=p.index,x=p.attributes.position;let v=0;if(x===void 0)return;if(g!==null){const b=g.array;v=g.version;for(let E=0,y=b.length;E<y;E+=3){const A=b[E+0],S=b[E+1],C=b[E+2];h.push(A,S,S,C,C,A)}}else{const b=x.array;v=x.version;for(let E=0,y=b.length/3-1;E<y;E+=3){const A=E+0,S=E+1,C=E+2;h.push(A,S,S,C,C,A)}}const m=new(x.count>=65535?Jl:Kl)(h,1);m.version=v;const f=r.get(p);f&&e.remove(f),r.set(p,m)}function u(p){const h=r.get(p);if(h){const g=p.index;g!==null&&h.version<g.version&&l(p)}else l(p);return r.get(p)}return{get:c,update:d,getWireframeAttribute:u}}function Wm(n,e,t){let i;function s(p){i=p}let r,a;function c(p){r=p.type,a=p.bytesPerElement}function d(p,h){n.drawElements(i,h,r,p*a),t.update(h,i,1)}function l(p,h,g){g!==0&&(n.drawElementsInstanced(i,h,r,p*a,g),t.update(h,i,g))}function u(p,h,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,h,0,r,p,0,g);let v=0;for(let m=0;m<g;m++)v+=h[m];t.update(v,i,1)}this.setMode=s,this.setIndex=c,this.render=d,this.renderInstances=l,this.renderMultiDraw=u}function jm(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,c){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=c*(r/3);break;case n.LINES:t.lines+=c*(r/2);break;case n.LINE_STRIP:t.lines+=c*(r-1);break;case n.LINE_LOOP:t.lines+=c*r;break;case n.POINTS:t.points+=c*r;break;default:et("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function Xm(n,e,t){const i=new WeakMap,s=new ut;function r(a,c,d){const l=a.morphTargetInfluences,u=c.morphAttributes.position||c.morphAttributes.normal||c.morphAttributes.color,p=u!==void 0?u.length:0;let h=i.get(c);if(h===void 0||h.count!==p){let N=function(){C.dispose(),i.delete(c),c.removeEventListener("dispose",N)};h!==void 0&&h.texture.dispose();const g=c.morphAttributes.position!==void 0,x=c.morphAttributes.normal!==void 0,v=c.morphAttributes.color!==void 0,m=c.morphAttributes.position||[],f=c.morphAttributes.normal||[],b=c.morphAttributes.color||[];let E=0;g===!0&&(E=1),x===!0&&(E=2),v===!0&&(E=3);let y=c.attributes.position.count*E,A=1;y>e.maxTextureSize&&(A=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);const S=new Float32Array(y*A*4*p),C=new ql(S,y,A,p);C.type=on,C.needsUpdate=!0;const M=E*4;for(let U=0;U<p;U++){const O=m[U],k=f[U],Q=b[U],B=y*A*4*U;for(let D=0;D<O.count;D++){const q=D*M;g===!0&&(s.fromBufferAttribute(O,D),S[B+q+0]=s.x,S[B+q+1]=s.y,S[B+q+2]=s.z,S[B+q+3]=0),x===!0&&(s.fromBufferAttribute(k,D),S[B+q+4]=s.x,S[B+q+5]=s.y,S[B+q+6]=s.z,S[B+q+7]=0),v===!0&&(s.fromBufferAttribute(Q,D),S[B+q+8]=s.x,S[B+q+9]=s.y,S[B+q+10]=s.z,S[B+q+11]=Q.itemSize===4?s.w:1)}}h={count:p,texture:C,size:new Ke(y,A)},i.set(c,h),c.addEventListener("dispose",N)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)d.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let g=0;for(let v=0;v<l.length;v++)g+=l[v];const x=c.morphTargetsRelative?1:1-g;d.getUniforms().setValue(n,"morphTargetBaseInfluence",x),d.getUniforms().setValue(n,"morphTargetInfluences",l)}d.getUniforms().setValue(n,"morphTargetsTexture",h.texture,t),d.getUniforms().setValue(n,"morphTargetsTextureSize",h.size)}return{update:r}}function qm(n,e,t,i,s){let r=new WeakMap;function a(l){const u=s.render.frame,p=l.geometry,h=e.get(l,p);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",d)===!1&&l.addEventListener("dispose",d),r.get(l)!==u&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,u))),l.isSkinnedMesh){const g=l.skeleton;r.get(g)!==u&&(g.update(),r.set(g,u))}return h}function c(){r=new WeakMap}function d(l){const u=l.target;u.removeEventListener("dispose",d),i.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:c}}const $m={[Pl]:"LINEAR_TONE_MAPPING",[Ll]:"REINHARD_TONE_MAPPING",[Dl]:"CINEON_TONE_MAPPING",[Il]:"ACES_FILMIC_TONE_MAPPING",[Fl]:"AGX_TONE_MAPPING",[Ol]:"NEUTRAL_TONE_MAPPING",[Ul]:"CUSTOM_TONE_MAPPING"};function Ym(n,e,t,i,s,r){const a=new dn(e,t,{type:n,depthBuffer:s,stencilBuffer:r,samples:i?4:0,depthTexture:s?new Di(e,t):void 0}),c=new dn(e,t,{type:En,depthBuffer:!1,stencilBuffer:!1}),d=new Lt;d.setAttribute("position",new wt([-1,3,0,-1,-1,0,3,-1,0],3)),d.setAttribute("uv",new wt([0,2,0,0,2,0],2));const l=new kh({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter(Yi).join(`
`)),a=qa(a),a=Gc(a,t),a=Hc(a,t),c=qa(c),c=Gc(c,t),c=Hc(c,t),a=Vc(a),c=Vc(c),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
}`;class F0{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new nd(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new hn({vertexShader:I0,fragmentShader:U0,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new lt(new Oi(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class O0 extends oi{constructor(e,t){super();const i=this;let s=null,r=1,a=null,c="local-floor",d=1,l=null,u=null,p=null,h=null,g=null,x=null;const v=typeof XRWebGLBinding<"u",m=new F0,f={},b=t.getContextAttributes();let E=null,y=null;const A=[],S=[],C=new Ke;let M=null;const N=new Bt;N.viewport=new ut;const U=new Bt;U.viewport=new ut;const O=[N,U],k=new Xh;let Q=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ae){let fe=A[ae];return fe===void 0&&(fe=new yr,A[ae]=fe),fe.getTargetRaySpace()},this.getControllerGrip=function(ae){let fe=A[ae];return fe===void 0&&(fe=new yr,A[ae]=fe),fe.getGripSpace()},this.getHand=function(ae){let fe=A[ae];return fe===void 0&&(fe=new yr,A[ae]=fe),fe.getHandSpace()};function D(ae){const fe=S.indexOf(ae.inputSource);if(fe===-1)return;const W=A[fe];W!==void 0&&(W.update(ae.inputSource,ae.frame,l||a),W.dispatchEvent({type:ae.type,data:ae.inputSource}))}function q(){s.removeEventListener("select",D),s.removeEventListener("selectstart",D),s.removeEventListener("selectend",D),s.removeEventListener("squeeze",D),s.removeEventListener("squeezestart",D),s.removeEventListener("squeezeend",D),s.removeEventListener("end",q),s.removeEventListener("inputsourceschange",I);for(let ae=0;ae<A.length;ae++){const fe=S[ae];fe!==null&&(S[ae]=null,A[ae].disconnect(fe))}Q=null,B=null,m.reset();for(const ae in f)delete f[ae];e.setRenderTarget(E),g=null,h=null,p=null,s=null,y=null,ze.stop(),i.isPresenting=!1,e.setPixelRatio(M),e.setSize(C.width,C.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ae){r=ae,i.isPresenting===!0&&Fe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ae){c=ae,i.isPresenting===!0&&Fe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(ae){l=ae},this.getBaseLayer=function(){return h!==null?h:g},this.getBinding=function(){return p===null&&v&&(p=new XRWebGLBinding(s,t)),p},this.getFrame=function(){return x},this.getSession=function(){return s},this.setSession=async function(ae){if(s=ae,s!==null){if(E=e.getRenderTarget(),s.addEventListener("select",D),s.addEventListener("selectstart",D),s.addEventListener("selectend",D),s.addEventListener("squeeze",D),s.addEventListener("squeezestart",D),s.addEventListener("squeezeend",D),s.addEventListener("end",q),s.addEventListener("inputsourceschange",I),b.xrCompatible!==!0&&await t.makeXRCompatible(),M=e.getPixelRatio(),e.getSize(C),v&&"createProjectionLayer"in XRWebGLBinding.prototype){let W=null,ge=null,pe=null;b.depth&&(pe=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,W=b.stencil?Kn:wn,ge=b.stencil?Ji:un);const xe={colorFormat:t.RGBA8,depthFormat:pe,scaleFactor:r};p=this.getBinding(),h=p.createProjectionLayer(xe),s.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),y=new dn(h.textureWidth,h.textureHeight,{format:Jt,type:Wt,depthTexture:new Di(h.textureWidth,h.textureHeight,ge,void 0,void 0,void 0,void 0,void 0,void 0,W),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const W={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:r};g=new XRWebGLLayer(s,t,W),s.updateRenderState({baseLayer:g}),e.setPixelRatio(1),e.setSize(g.framebufferWidth,g.framebufferHeight,!1),y=new dn(g.framebufferWidth,g.framebufferHeight,{format:Jt,type:Wt,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(d),l=null,a=await s.requestReferenceSpace(c),ze.setContext(s),ze.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function I(ae){for(let fe=0;fe<ae.removed.length;fe++){const W=ae.removed[fe],ge=S.indexOf(W);ge>=0&&(S[ge]=null,A[ge].disconnect(W))}for(let fe=0;fe<ae.added.length;fe++){const W=ae.added[fe];let ge=S.indexOf(W);if(ge===-1){for(let xe=0;xe<A.length;xe++)if(xe>=S.length){S.push(W),ge=xe;break}else if(S[xe]===null){S[xe]=W,ge=xe;break}if(ge===-1)break}const pe=A[ge];pe&&pe.connect(W)}}const Y=new Z,de=new Z;function he(ae,fe,W){Y.setFromMatrixPosition(fe.matrixWorld),de.setFromMatrixPosition(W.matrixWorld);const ge=Y.distanceTo(de),pe=fe.projectionMatrix.elements,xe=W.projectionMatrix.elements,ke=pe[14]/(pe[10]-1),Be=pe[14]/(pe[10]+1),Je=(pe[9]+1)/pe[5],qe=(pe[9]-1)/pe[5],We=(pe[8]-1)/pe[0],ct=(xe[8]+1)/xe[0],dt=ke*We,ft=ke*ct,xt=ge/(-We+ct),rt=xt*-We;if(fe.matrixWorld.decompose(ae.position,ae.quaternion,ae.scale),ae.translateX(rt),ae.translateZ(xt),ae.matrixWorld.compose(ae.position,ae.quaternion,ae.scale),ae.matrixWorldInverse.copy(ae.matrixWorld).invert(),pe[10]===-1)ae.projectionMatrix.copy(fe.projectionMatrix),ae.projectionMatrixInverse.copy(fe.projectionMatrixInverse);else{const X=ke+xt,R=Be+xt,ie=dt-rt,se=ft+(ge-rt),w=Je*Be/R*X,_=qe*Be/R*X;ae.projectionMatrix.makePerspective(ie,se,w,_,X,R),ae.projectionMatrixInverse.copy(ae.projectionMatrix).invert()}}function me(ae,fe){fe===null?ae.matrixWorld.copy(ae.matrix):ae.matrixWorld.multiplyMatrices(fe.matrixWorld,ae.matrix),ae.matrixWorldInverse.copy(ae.matrixWorld).invert()}this.updateCamera=function(ae){if(s===null)return;let fe=ae.near,W=ae.far;m.texture!==null&&(m.depthNear>0&&(fe=m.depthNear),m.depthFar>0&&(W=m.depthFar)),k.near=U.near=N.near=fe,k.far=U.far=N.far=W,(Q!==k.near||B!==k.far)&&(s.updateRenderState({depthNear:k.near,depthFar:k.far}),Q=k.near,B=k.far),k.layers.mask=ae.layers.mask|6,N.layers.mask=k.layers.mask&-5,U.layers.mask=k.layers.mask&-3;const ge=ae.parent,pe=k.cameras;me(k,ge);for(let xe=0;xe<pe.length;xe++)me(pe[xe],ge);pe.length===2?he(k,N,U):k.projectionMatrix.copy(N.projectionMatrix),Te(ae,k,ge)};function Te(ae,fe,W){W===null?ae.matrix.copy(fe.matrixWorld):(ae.matrix.copy(W.matrixWorld),ae.matrix.invert(),ae.matrix.multiply(fe.matrixWorld)),ae.matrix.decompose(ae.position,ae.quaternion,ae.scale),ae.updateMatrixWorld(!0),ae.projectionMatrix.copy(fe.projectionMatrix),ae.projectionMatrixInverse.copy(fe.projectionMatrixInverse),ae.isPerspectiveCamera&&(ae.fov=Wa*2*Math.atan(1/ae.projectionMatrix.elements[5]),ae.zoom=1)}this.getCamera=function(){return k},this.getFoveation=function(){if(!(h===null&&g===null))return d},this.setFoveation=function(ae){d=ae,h!==null&&(h.fixedFoveation=ae),g!==null&&g.fixedFoveation!==void 0&&(g.fixedFoveation=ae)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(k)},this.getCameraTexture=function(ae){return f[ae]};let Ve=null;function Ae(ae,fe){if(u=fe.getViewerPose(l||a),x=fe,u!==null){const W=u.views;g!==null&&(e.setRenderTargetFramebuffer(y,g.framebuffer),e.setRenderTarget(y));let ge=!1;W.length!==k.cameras.length&&(k.cameras.length=0,ge=!0);for(let Be=0;Be<W.length;Be++){const Je=W[Be];let qe=null;if(g!==null)qe=g.getViewport(Je);else{const ct=p.getViewSubImage(h,Je);qe=ct.viewport,Be===0&&(e.setRenderTargetTextures(y,ct.colorTexture,ct.depthStencilTexture),e.setRenderTarget(y))}let We=O[Be];We===void 0&&(We=new Bt,We.layers.enable(Be),We.viewport=new ut,O[Be]=We),We.matrix.fromArray(Je.transform.matrix),We.matrix.decompose(We.position,We.quaternion,We.scale),We.projectionMatrix.fromArray(Je.projectionMatrix),We.projectionMatrixInverse.copy(We.projectionMatrix).invert(),We.viewport.set(qe.x,qe.y,qe.width,qe.height),Be===0&&(k.matrix.copy(We.matrix),k.matrix.decompose(k.position,k.quaternion,k.scale)),ge===!0&&k.cameras.push(We)}const pe=s.enabledFeatures;if(pe&&pe.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&v){p=i.getBinding();const Be=p.getDepthInformation(W[0]);Be&&Be.isValid&&Be.texture&&m.init(Be,s.renderState)}if(pe&&pe.includes("camera-access")&&v){e.state.unbindTexture(),p=i.getBinding();for(let Be=0;Be<W.length;Be++){const Je=W[Be].camera;if(Je){let qe=f[Je];qe||(qe=new nd,f[Je]=qe);const We=p.getCameraImage(Je);qe.sourceTexture=We}}}}for(let W=0;W<A.length;W++){const ge=S[W],pe=A[W];ge!==null&&pe!==void 0&&pe.update(ge,fe,l||a)}Ve&&Ve(ae,fe),fe.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:fe}),x=null}const ze=new cd;ze.setAnimationLoop(Ae),this.setAnimationLoop=function(ae){Ve=ae},this.dispose=function(){}}}const B0=new ht,md=new Oe;md.set(-1,0,0,0,1,0,0,0,1);function z0(n,e){function t(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function i(m,f){f.color.getRGB(m.fogColor.value,id(n)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function s(m,f,b,E,y){f.isNodeMaterial?f.uniformsNeedUpdate=!1:f.isMeshBasicMaterial?r(m,f):f.isMeshLambertMaterial?(r(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshToonMaterial?(r(m,f),p(m,f)):f.isMeshPhongMaterial?(r(m,f),u(m,f),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)):f.isMeshStandardMaterial?(r(m,f),h(m,f),f.isMeshPhysicalMaterial&&g(m,f,y)):f.isMeshMatcapMaterial?(r(m,f),x(m,f)):f.isMeshDepthMaterial?r(m,f):f.isMeshDistanceMaterial?(r(m,f),v(m,f)):f.isMeshNormalMaterial?r(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&c(m,f)):f.isPointsMaterial?d(m,f,b,E):f.isSpriteMaterial?l(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function r(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,t(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===zt&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,t(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===zt&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,t(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,t(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,t(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const b=e.get(f),E=b.envMap,y=b.envMapRotation;E&&(m.envMap.value=E,m.envMapRotation.value.setFromMatrix4(B0.makeRotationFromEuler(y)).transpose(),E.isCubeTexture&&E.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(md),m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,t(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,t(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform))}function c(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function d(m,f,b,E){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*b,m.scale.value=E*.5,f.map&&(m.map.value=f.map,t(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function l(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function u(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function p(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function h(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,t(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,t(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function g(m,f,b){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,t(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,t(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,t(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,t(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,t(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===zt&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,t(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,t(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=b.texture,m.transmissionSamplerSize.value.set(b.width,b.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,t(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,t(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,t(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,t(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,t(f.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,f){f.matcap&&(m.matcap.value=f.matcap)}function v(m,f){const b=e.get(f).light;m.referencePosition.value.setFromMatrixPosition(b.matrixWorld),m.nearDistance.value=b.shadow.camera.near,m.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function k0(n,e,t,i){let s={},r={},a=[];const c=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function d(y,A){const S=A.program;i.uniformBlockBinding(y,S)}function l(y,A){let S=s[y.id];S===void 0&&(m(y),S=u(y),s[y.id]=S,y.addEventListener("dispose",b));const C=A.program;i.updateUBOMapping(y,C);const M=e.render.frame;r[y.id]!==M&&(h(y),r[y.id]=M)}function u(y){const A=p();y.__bindingPointIndex=A;const S=n.createBuffer(),C=y.__size,M=y.usage;return n.bindBuffer(n.UNIFORM_BUFFER,S),n.bufferData(n.UNIFORM_BUFFER,C,M),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,A,S),S}function p(){for(let y=0;y<c;y++)if(a.indexOf(y)===-1)return a.push(y),y;return et("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(y){const A=s[y.id],S=y.uniforms,C=y.__cache;n.bindBuffer(n.UNIFORM_BUFFER,A);for(let M=0,N=S.length;M<N;M++){const U=S[M];if(Array.isArray(U))for(let O=0,k=U.length;O<k;O++)g(U[O],M,O,C);else g(U,M,0,C)}n.bindBuffer(n.UNIFORM_BUFFER,null)}function g(y,A,S,C){if(v(y,A,S,C)===!0){const M=y.__offset,N=y.value;if(Array.isArray(N)){let U=0;for(let O=0;O<N.length;O++){const k=N[O],Q=f(k);x(k,y.__data,U),typeof k!="number"&&typeof k!="boolean"&&!k.isMatrix3&&!ArrayBuffer.isView(k)&&(U+=Q.storage/Float32Array.BYTES_PER_ELEMENT)}}else x(N,y.__data,0);n.bufferSubData(n.UNIFORM_BUFFER,M,y.__data)}}function x(y,A,S){typeof y=="number"||typeof y=="boolean"?A[0]=y:y.isMatrix3?(A[0]=y.elements[0],A[1]=y.elements[1],A[2]=y.elements[2],A[3]=0,A[4]=y.elements[3],A[5]=y.elements[4],A[6]=y.elements[5],A[7]=0,A[8]=y.elements[6],A[9]=y.elements[7],A[10]=y.elements[8],A[11]=0):ArrayBuffer.isView(y)?A.set(new y.constructor(y.buffer,y.byteOffset,A.length)):y.toArray(A,S)}function v(y,A,S,C){const M=y.value,N=A+"_"+S;if(C[N]===void 0)return typeof M=="number"||typeof M=="boolean"?C[N]=M:ArrayBuffer.isView(M)?C[N]=M.slice():C[N]=M.clone(),!0;{const U=C[N];if(typeof M=="number"||typeof M=="boolean"){if(U!==M)return C[N]=M,!0}else{if(ArrayBuffer.isView(M))return!0;if(U.equals(M)===!1)return U.copy(M),!0}}return!1}function m(y){const A=y.uniforms;let S=0;const C=16;for(let N=0,U=A.length;N<U;N++){const O=Array.isArray(A[N])?A[N]:[A[N]];for(let k=0,Q=O.length;k<Q;k++){const B=O[k],D=Array.isArray(B.value)?B.value:[B.value];for(let q=0,I=D.length;q<I;q++){const Y=D[q],de=f(Y),he=S%C,me=he%de.boundary,Te=he+me;S+=me,Te!==0&&C-Te<de.storage&&(S+=C-Te),B.__data=new Float32Array(de.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=S,S+=de.storage}}}const M=S%C;return M>0&&(S+=C-M),y.__size=S,y.__cache={},this}function f(y){const A={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(A.boundary=4,A.storage=4):y.isVector2?(A.boundary=8,A.storage=8):y.isVector3||y.isColor?(A.boundary=16,A.storage=12):y.isVector4?(A.boundary=16,A.storage=16):y.isMatrix3?(A.boundary=48,A.storage=48):y.isMatrix4?(A.boundary=64,A.storage=64):y.isTexture?Fe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(y)?(A.boundary=16,A.storage=y.byteLength):Fe("WebGLRenderer: Unsupported uniform value type.",y),A}function b(y){const A=y.target;A.removeEventListener("dispose",b);const S=a.indexOf(A.__bindingPointIndex);a.splice(S,1),n.deleteBuffer(s[A.id]),delete s[A.id],delete r[A.id]}function E(){for(const y in s)n.deleteBuffer(s[y]);a=[],s={},r={}}return{bind:d,update:l,dispose:E}}const G0=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let sn=null;function H0(){return sn===null&&(sn=new Ph(G0,16,16,si,En),sn.name="DFG_LUT",sn.minFilter=Nt,sn.magFilter=Nt,sn.wrapS=Mn,sn.wrapT=Mn,sn.generateMipmaps=!1,sn.needsUpdate=!0),sn}class gd{constructor(e={}){const{canvas:t=lh(),context:i=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:c=!1,premultipliedAlpha:d=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:g=Wt}=e;this.isWebGLRenderer=!0;let x;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=i.getContextAttributes().alpha}else x=a;const v=g,m=new Set([ao,ro,so]),f=new Set([Wt,un,Ki,Ji,no,io]),b=new Uint32Array(4),E=new Int32Array(4),y=new Z;let A=null,S=null;const C=[],M=[];let N=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ln,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const U=this;let O=!1,k=null,Q=null,B=null,D=null;this._outputColorSpace=qt;let q=0,I=0,Y=null,de=-1,he=null;const me=new ut,Te=new ut;let Ve=null;const Ae=new $e(0);let ze=0,ae=t.width,fe=t.height,W=1,ge=null,pe=null;const xe=new ut(0,0,ae,fe),ke=new ut(0,0,ae,fe);let Be=!1;const Je=new uo;let qe=!1,We=!1;const ct=new ht,dt=new Z,ft=new ut,xt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let rt=!1;function X(){return Y===null?W:1}let R=i;function ie(T,j){return t.getContext(T,j)}try{const T={alpha:!0,depth:s,stencil:r,antialias:c,premultipliedAlpha:d,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:p};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${eo}`),t.addEventListener("webglcontextlost",pt,!1),t.addEventListener("webglcontextrestored",at,!1),t.addEventListener("webglcontextcreationerror",Qt,!1),R===null){const j="webgl2";if(R=ie(j,T),R===null)throw ie(j)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(T){throw et("WebGLRenderer: "+T.message),T}let se,w,_,P,L,z,$,G,F,H,ne,le,oe,re,Me,be,De,V,ve,ce,_e,we,ue;function Le(){se=new Hm(R),se.init(),_e=new D0(R,se),w=new Im(R,se,e,_e),_=new P0(R,se),w.reversedDepthBuffer&&h&&_.buffers.depth.setReversed(!0),Q=R.createFramebuffer(),B=R.createFramebuffer(),D=R.createFramebuffer(),P=new jm(R),L=new x0,z=new L0(R,se,_,L,w,_e,P),$=new Gm(U),G=new $h(R),we=new Lm(R,G),F=new Vm(R,G,P,we),H=new qm(R,F,G,we,P),V=new Xm(R,w,z),Me=new Um(L),ne=new g0(U,$,se,w,we,Me),le=new z0(U,L),oe=new v0,re=new w0(se),De=new Pm(U,$,_,H,x,d),be=new N0(U,H,w),ue=new k0(R,P,w,_),ve=new Dm(R,se,P),ce=new Wm(R,se,P),P.programs=ne.programs,U.capabilities=w,U.extensions=se,U.properties=L,U.renderLists=oe,U.shadowMap=be,U.state=_,U.info=P}Le(),v!==Wt&&(N=new Ym(v,t.width,t.height,c,s,r));const Ne=new O0(U,R);this.xr=Ne,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const T=se.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=se.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return W},this.setPixelRatio=function(T){T!==void 0&&(W=T,this.setSize(ae,fe,!1))},this.getSize=function(T){return T.set(ae,fe)},this.setSize=function(T,j,te=!0){if(Ne.isPresenting){Fe("WebGLRenderer: Can't change size while VR device is presenting.");return}ae=T,fe=j,t.width=Math.floor(T*W),t.height=Math.floor(j*W),te===!0&&(t.style.width=T+"px",t.style.height=j+"px"),N!==null&&N.setSize(t.width,t.height),this.setViewport(0,0,T,j)},this.getDrawingBufferSize=function(T){return T.set(ae*W,fe*W).floor()},this.setDrawingBufferSize=function(T,j,te){ae=T,fe=j,W=te,t.width=Math.floor(T*te),t.height=Math.floor(j*te),this.setViewport(0,0,T,j)},this.setEffects=function(T){if(v===Wt){et("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(T){for(let j=0;j<T.length;j++)if(T[j].isOutputPass===!0){Fe("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}N.setEffects(T||[])},this.getCurrentViewport=function(T){return T.copy(me)},this.getViewport=function(T){return T.copy(xe)},this.setViewport=function(T,j,te,K){T.isVector4?xe.set(T.x,T.y,T.z,T.w):xe.set(T,j,te,K),_.viewport(me.copy(xe).multiplyScalar(W).round())},this.getScissor=function(T){return T.copy(ke)},this.setScissor=function(T,j,te,K){T.isVector4?ke.set(T.x,T.y,T.z,T.w):ke.set(T,j,te,K),_.scissor(Te.copy(ke).multiplyScalar(W).round())},this.getScissorTest=function(){return Be},this.setScissorTest=function(T){_.setScissorTest(Be=T)},this.setOpaqueSort=function(T){ge=T},this.setTransparentSort=function(T){pe=T},this.getClearColor=function(T){return T.copy(De.getClearColor())},this.setClearColor=function(){De.setClearColor(...arguments)},this.getClearAlpha=function(){return De.getClearAlpha()},this.setClearAlpha=function(){De.setClearAlpha(...arguments)},this.clear=function(T=!0,j=!0,te=!0){let K=0;if(T){let J=!1;if(Y!==null){const Ee=Y.texture.format;J=m.has(Ee)}if(J){const Ee=Y.texture.type,Ce=f.has(Ee),ye=De.getClearColor(),Pe=De.getClearAlpha(),Ie=ye.r,Ge=ye.g,je=ye.b;Ce?(b[0]=Ie,b[1]=Ge,b[2]=je,b[3]=Pe,R.clearBufferuiv(R.COLOR,0,b)):(E[0]=Ie,E[1]=Ge,E[2]=je,E[3]=Pe,R.clearBufferiv(R.COLOR,0,E))}else K|=R.COLOR_BUFFER_BIT}j&&(K|=R.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),te&&(K|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),K!==0&&R.clear(K)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(T){T.setRenderer(this),k=T},this.dispose=function(){t.removeEventListener("webglcontextlost",pt,!1),t.removeEventListener("webglcontextrestored",at,!1),t.removeEventListener("webglcontextcreationerror",Qt,!1),De.dispose(),oe.dispose(),re.dispose(),L.dispose(),$.dispose(),H.dispose(),we.dispose(),ue.dispose(),ne.dispose(),Ne.dispose(),Ne.removeEventListener("sessionstart",So),Ne.removeEventListener("sessionend",yo),Gn.stop()};function pt(T){T.preventDefault(),nc("WebGLRenderer: Context Lost."),O=!0}function at(){nc("WebGLRenderer: Context Restored."),O=!1;const T=P.autoReset,j=be.enabled,te=be.autoUpdate,K=be.needsUpdate,J=be.type;Le(),P.autoReset=T,be.enabled=j,be.autoUpdate=te,be.needsUpdate=K,be.type=J}function Qt(T){et("WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function en(T){const j=T.target;j.removeEventListener("dispose",en),Sd(j)}function Sd(T){yd(T),L.remove(T)}function yd(T){const j=L.get(T).programs;j!==void 0&&(j.forEach(function(te){ne.releaseProgram(te)}),T.isShaderMaterial&&ne.releaseShaderCache(T))}this.renderBufferDirect=function(T,j,te,K,J,Ee){j===null&&(j=xt);const Ce=J.isMesh&&J.matrixWorld.determinantAffine()<0,ye=wd(T,j,te,K,J);_.setMaterial(K,Ce);let Pe=te.index,Ie=1;if(K.wireframe===!0){if(Pe=F.getWireframeAttribute(te),Pe===void 0)return;Ie=2}const Ge=te.drawRange,je=te.attributes.position;let Ue=Ge.start*Ie,nt=(Ge.start+Ge.count)*Ie;Ee!==null&&(Ue=Math.max(Ue,Ee.start*Ie),nt=Math.min(nt,(Ee.start+Ee.count)*Ie)),Pe!==null?(Ue=Math.max(Ue,0),nt=Math.min(nt,Pe.count)):je!=null&&(Ue=Math.max(Ue,0),nt=Math.min(nt,je.count));const _t=nt-Ue;if(_t<0||_t===1/0)return;we.setup(J,K,ye,te,Pe);let mt,it=ve;if(Pe!==null&&(mt=G.get(Pe),it=ce,it.setIndex(mt)),J.isMesh)K.wireframe===!0?(_.setLineWidth(K.wireframeLinewidth*X()),it.setMode(R.LINES)):it.setMode(R.TRIANGLES);else if(J.isLine){let At=K.linewidth;At===void 0&&(At=1),_.setLineWidth(At*X()),J.isLineSegments?it.setMode(R.LINES):J.isLineLoop?it.setMode(R.LINE_LOOP):it.setMode(R.LINE_STRIP)}else J.isPoints?it.setMode(R.POINTS):J.isSprite&&it.setMode(R.TRIANGLES);if(J.isBatchedMesh)if(se.get("WEBGL_multi_draw"))it.renderMultiDraw(J._multiDrawStarts,J._multiDrawCounts,J._multiDrawCount);else{const At=J._multiDrawStarts,Re=J._multiDrawCounts,Gt=J._multiDrawCount,Qe=Pe?G.get(Pe).bytesPerElement:1,jt=L.get(K).currentProgram.getUniforms();for(let tn=0;tn<Gt;tn++)jt.setValue(R,"_gl_DrawID",tn),it.render(At[tn]/Qe,Re[tn])}else if(J.isInstancedMesh)it.renderInstances(Ue,_t,J.count);else if(te.isInstancedBufferGeometry){const At=te._maxInstanceCount!==void 0?te._maxInstanceCount:1/0,Re=Math.min(te.instanceCount,At);it.renderInstances(Ue,_t,Re)}else it.render(Ue,_t)};function Mo(T,j,te){T.transparent===!0&&T.side===vn&&T.forceSinglePass===!1?(T.side=zt,T.needsUpdate=!0,ss(T,j,te),T.side=Bn,T.needsUpdate=!0,ss(T,j,te),T.side=vn):ss(T,j,te)}this.compile=function(T,j,te=null){te===null&&(te=T),S=re.get(te),S.init(j),M.push(S),te.traverseVisible(function(J){J.isLight&&J.layers.test(j.layers)&&(S.pushLight(J),J.castShadow&&S.pushShadow(J))}),T!==te&&T.traverseVisible(function(J){J.isLight&&J.layers.test(j.layers)&&(S.pushLight(J),J.castShadow&&S.pushShadow(J))}),S.setupLights();const K=new Set;return T.traverse(function(J){if(!(J.isMesh||J.isPoints||J.isLine||J.isSprite))return;const Ee=J.material;if(Ee)if(Array.isArray(Ee))for(let Ce=0;Ce<Ee.length;Ce++){const ye=Ee[Ce];Mo(ye,te,J),K.add(ye)}else Mo(Ee,te,J),K.add(Ee)}),S=M.pop(),K},this.compileAsync=function(T,j,te=null){const K=this.compile(T,j,te);return new Promise(J=>{function Ee(){if(K.forEach(function(Ce){L.get(Ce).currentProgram.isReady()&&K.delete(Ce)}),K.size===0){J(T);return}setTimeout(Ee,10)}se.get("KHR_parallel_shader_compile")!==null?Ee():setTimeout(Ee,10)})};let lr=null;function bd(T){lr&&lr(T)}function So(){Gn.stop()}function yo(){Gn.start()}const Gn=new cd;Gn.setAnimationLoop(bd),typeof self<"u"&&Gn.setContext(self),this.setAnimationLoop=function(T){lr=T,Ne.setAnimationLoop(T),T===null?Gn.stop():Gn.start()},Ne.addEventListener("sessionstart",So),Ne.addEventListener("sessionend",yo),this.render=function(T,j){if(j!==void 0&&j.isCamera!==!0){et("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(O===!0)return;k!==null&&k.renderStart(T,j);const te=Ne.enabled===!0&&Ne.isPresenting===!0,K=N!==null&&(Y===null||te)&&N.begin(U,Y);if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),j.parent===null&&j.matrixWorldAutoUpdate===!0&&j.updateMatrixWorld(),Ne.enabled===!0&&Ne.isPresenting===!0&&(N===null||N.isCompositing()===!1)&&(Ne.cameraAutoUpdate===!0&&Ne.updateCamera(j),j=Ne.getCamera()),T.isScene===!0&&T.onBeforeRender(U,T,j,Y),S=re.get(T,M.length),S.init(j),S.state.textureUnits=z.getTextureUnits(),M.push(S),ct.multiplyMatrices(j.projectionMatrix,j.matrixWorldInverse),Je.setFromProjectionMatrix(ct,cn,j.reversedDepth),We=this.localClippingEnabled,qe=Me.init(this.clippingPlanes,We),A=oe.get(T,C.length),A.init(),C.push(A),Ne.enabled===!0&&Ne.isPresenting===!0){const Ce=U.xr.getDepthSensingMesh();Ce!==null&&dr(Ce,j,-1/0,U.sortObjects)}dr(T,j,0,U.sortObjects),A.finish(),U.sortObjects===!0&&A.sort(ge,pe,j.reversedDepth),rt=Ne.enabled===!1||Ne.isPresenting===!1||Ne.hasDepthSensing()===!1,rt&&De.addToRenderList(A,T),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),qe===!0&&Me.beginShadows();const J=S.state.shadowsArray;if(be.render(J,T,j),qe===!0&&Me.endShadows(),(K&&N.hasRenderPass())===!1){const Ce=A.opaque,ye=A.transmissive;if(S.setupLights(),j.isArrayCamera){const Pe=j.cameras;if(ye.length>0)for(let Ie=0,Ge=Pe.length;Ie<Ge;Ie++){const je=Pe[Ie];Eo(Ce,ye,T,je)}rt&&De.render(T);for(let Ie=0,Ge=Pe.length;Ie<Ge;Ie++){const je=Pe[Ie];bo(A,T,je,je.viewport)}}else ye.length>0&&Eo(Ce,ye,T,j),rt&&De.render(T),bo(A,T,j)}Y!==null&&I===0&&(z.updateMultisampleRenderTarget(Y),z.updateRenderTargetMipmap(Y)),K&&N.end(U),T.isScene===!0&&T.onAfterRender(U,T,j),we.resetDefaultState(),de=-1,he=null,M.pop(),M.length>0?(S=M[M.length-1],z.setTextureUnits(S.state.textureUnits),qe===!0&&Me.setGlobalState(U.clippingPlanes,S.state.camera)):S=null,C.pop(),C.length>0?A=C[C.length-1]:A=null,k!==null&&k.renderEnd()};function dr(T,j,te,K){if(T.visible===!1)return;if(T.layers.test(j.layers)){if(T.isGroup)te=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(j);else if(T.isLightProbeGrid)S.pushLightProbeGrid(T);else if(T.isLight)S.pushLight(T),T.castShadow&&S.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||Je.intersectsSprite(T)){K&&ft.setFromMatrixPosition(T.matrixWorld).applyMatrix4(ct);const Ce=H.update(T),ye=T.material;ye.visible&&A.push(T,Ce,ye,te,ft.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||Je.intersectsObject(T))){const Ce=H.update(T),ye=T.material;if(K&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),ft.copy(T.boundingSphere.center)):(Ce.boundingSphere===null&&Ce.computeBoundingSphere(),ft.copy(Ce.boundingSphere.center)),ft.applyMatrix4(T.matrixWorld).applyMatrix4(ct)),Array.isArray(ye)){const Pe=Ce.groups;for(let Ie=0,Ge=Pe.length;Ie<Ge;Ie++){const je=Pe[Ie],Ue=ye[je.materialIndex];Ue&&Ue.visible&&A.push(T,Ce,Ue,te,ft.z,je)}}else ye.visible&&A.push(T,Ce,ye,te,ft.z,null)}}const Ee=T.children;for(let Ce=0,ye=Ee.length;Ce<ye;Ce++)dr(Ee[Ce],j,te,K)}function bo(T,j,te,K){const{opaque:J,transmissive:Ee,transparent:Ce}=T;S.setupLightsView(te),qe===!0&&Me.setGlobalState(U.clippingPlanes,te),K&&_.viewport(me.copy(K)),J.length>0&&is(J,j,te),Ee.length>0&&is(Ee,j,te),Ce.length>0&&is(Ce,j,te),_.buffers.depth.setTest(!0),_.buffers.depth.setMask(!0),_.buffers.color.setMask(!0),_.setPolygonOffset(!1)}function Eo(T,j,te,K){if((te.isScene===!0?te.overrideMaterial:null)!==null)return;if(S.state.transmissionRenderTarget[K.id]===void 0){const Ue=se.has("EXT_color_buffer_half_float")||se.has("EXT_color_buffer_float");S.state.transmissionRenderTarget[K.id]=new dn(1,1,{generateMipmaps:!0,type:Ue?En:Wt,minFilter:Zn,samples:Math.max(4,w.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ye.workingColorSpace})}const Ee=S.state.transmissionRenderTarget[K.id],Ce=K.viewport||me;Ee.setSize(Ce.z*U.transmissionResolutionScale,Ce.w*U.transmissionResolutionScale);const ye=U.getRenderTarget(),Pe=U.getActiveCubeFace(),Ie=U.getActiveMipmapLevel();U.setRenderTarget(Ee),U.getClearColor(Ae),ze=U.getClearAlpha(),ze<1&&U.setClearColor(16777215,.5),U.clear(),rt&&De.render(te);const Ge=U.toneMapping;U.toneMapping=ln;const je=K.viewport;if(K.viewport!==void 0&&(K.viewport=void 0),S.setupLightsView(K),qe===!0&&Me.setGlobalState(U.clippingPlanes,K),is(T,te,K),z.updateMultisampleRenderTarget(Ee),z.updateRenderTargetMipmap(Ee),se.has("WEBGL_multisampled_render_to_texture")===!1){let Ue=!1;for(let nt=0,_t=j.length;nt<_t;nt++){const mt=j[nt],{object:it,geometry:At,material:Re,group:Gt}=mt;if(Re.side===vn&&it.layers.test(K.layers)){const Qe=Re.side;Re.side=zt,Re.needsUpdate=!0,wo(it,te,K,At,Re,Gt),Re.side=Qe,Re.needsUpdate=!0,Ue=!0}}Ue===!0&&(z.updateMultisampleRenderTarget(Ee),z.updateRenderTargetMipmap(Ee))}U.setRenderTarget(ye,Pe,Ie),U.setClearColor(Ae,ze),je!==void 0&&(K.viewport=je),U.toneMapping=Ge}function is(T,j,te){const K=j.isScene===!0?j.overrideMaterial:null;for(let J=0,Ee=T.length;J<Ee;J++){const Ce=T[J],{object:ye,geometry:Pe,group:Ie}=Ce;let Ge=Ce.material;Ge.allowOverride===!0&&K!==null&&(Ge=K),ye.layers.test(te.layers)&&wo(ye,j,te,Pe,Ge,Ie)}}function wo(T,j,te,K,J,Ee){T.onBeforeRender(U,j,te,K,J,Ee),T.modelViewMatrix.multiplyMatrices(te.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),J.onBeforeRender(U,j,te,K,T,Ee),J.transparent===!0&&J.side===vn&&J.forceSinglePass===!1?(J.side=zt,J.needsUpdate=!0,U.renderBufferDirect(te,j,K,J,T,Ee),J.side=Bn,J.needsUpdate=!0,U.renderBufferDirect(te,j,K,J,T,Ee),J.side=vn):U.renderBufferDirect(te,j,K,J,T,Ee),T.onAfterRender(U,j,te,K,J,Ee)}function ss(T,j,te){j.isScene!==!0&&(j=xt);const K=L.get(T),J=S.state.lights,Ee=S.state.shadowsArray,Ce=J.state.version,ye=ne.getParameters(T,J.state,Ee,j,te,S.state.lightProbeGridArray),Pe=ne.getProgramCacheKey(ye);let Ie=K.programs;K.environment=T.isMeshStandardMaterial||T.isMeshLambertMaterial||T.isMeshPhongMaterial?j.environment:null,K.fog=j.fog;const Ge=T.isMeshStandardMaterial||T.isMeshLambertMaterial&&!T.envMap||T.isMeshPhongMaterial&&!T.envMap;K.envMap=$.get(T.envMap||K.environment,Ge),K.envMapRotation=K.environment!==null&&T.envMap===null?j.environmentRotation:T.envMapRotation,Ie===void 0&&(T.addEventListener("dispose",en),Ie=new Map,K.programs=Ie);let je=Ie.get(Pe);if(je!==void 0){if(K.currentProgram===je&&K.lightsStateVersion===Ce)return Ao(T,ye),je}else ye.uniforms=ne.getUniforms(T),k!==null&&T.isNodeMaterial&&k.build(T,te,ye),T.onBeforeCompile(ye,U),je=ne.acquireProgram(ye,Pe),Ie.set(Pe,je),K.uniforms=ye.uniforms;const Ue=K.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Ue.clippingPlanes=Me.uniform),Ao(T,ye),K.needsLights=Ad(T),K.lightsStateVersion=Ce,K.needsLights&&(Ue.ambientLightColor.value=J.state.ambient,Ue.lightProbe.value=J.state.probe,Ue.directionalLights.value=J.state.directional,Ue.directionalLightShadows.value=J.state.directionalShadow,Ue.spotLights.value=J.state.spot,Ue.spotLightShadows.value=J.state.spotShadow,Ue.rectAreaLights.value=J.state.rectArea,Ue.ltc_1.value=J.state.rectAreaLTC1,Ue.ltc_2.value=J.state.rectAreaLTC2,Ue.pointLights.value=J.state.point,Ue.pointLightShadows.value=J.state.pointShadow,Ue.hemisphereLights.value=J.state.hemi,Ue.directionalShadowMatrix.value=J.state.directionalShadowMatrix,Ue.spotLightMatrix.value=J.state.spotLightMatrix,Ue.spotLightMap.value=J.state.spotLightMap,Ue.pointShadowMatrix.value=J.state.pointShadowMatrix),K.lightProbeGrid=S.state.lightProbeGridArray.length>0,K.currentProgram=je,K.uniformsList=null,je}function To(T){if(T.uniformsList===null){const j=T.currentProgram.getUniforms();T.uniformsList=zs.seqWithValue(j.seq,T.uniforms)}return T.uniformsList}function Ao(T,j){const te=L.get(T);te.outputColorSpace=j.outputColorSpace,te.batching=j.batching,te.batchingColor=j.batchingColor,te.instancing=j.instancing,te.instancingColor=j.instancingColor,te.instancingMorph=j.instancingMorph,te.skinning=j.skinning,te.morphTargets=j.morphTargets,te.morphNormals=j.morphNormals,te.morphColors=j.morphColors,te.morphTargetsCount=j.morphTargetsCount,te.numClippingPlanes=j.numClippingPlanes,te.numIntersection=j.numClipIntersection,te.vertexAlphas=j.vertexAlphas,te.vertexTangents=j.vertexTangents,te.toneMapping=j.toneMapping}function Ed(T,j){if(T.length===0)return null;if(T.length===1)return T[0].texture!==null?T[0]:null;y.setFromMatrixPosition(j.matrixWorld);for(let te=0,K=T.length;te<K;te++){const J=T[te];if(J.texture!==null&&J.boundingBox.containsPoint(y))return J}return null}function wd(T,j,te,K,J){j.isScene!==!0&&(j=xt),z.resetTextureUnits();const Ee=j.fog,Ce=K.isMeshStandardMaterial||K.isMeshLambertMaterial||K.isMeshPhongMaterial?j.environment:null,ye=Y===null?U.outputColorSpace:Y.isXRRenderTarget===!0?Y.texture.colorSpace:Ye.workingColorSpace,Pe=K.isMeshStandardMaterial||K.isMeshLambertMaterial&&!K.envMap||K.isMeshPhongMaterial&&!K.envMap,Ie=$.get(K.envMap||Ce,Pe),Ge=K.vertexColors===!0&&!!te.attributes.color&&te.attributes.color.itemSize===4,je=!!te.attributes.tangent&&(!!K.normalMap||K.anisotropy>0),Ue=!!te.morphAttributes.position,nt=!!te.morphAttributes.normal,_t=!!te.morphAttributes.color;let mt=ln;K.toneMapped&&(Y===null||Y.isXRRenderTarget===!0)&&(mt=U.toneMapping);const it=te.morphAttributes.position||te.morphAttributes.normal||te.morphAttributes.color,At=it!==void 0?it.length:0,Re=L.get(K),Gt=S.state.lights;if(qe===!0&&(We===!0||T!==he)){const ot=T===he&&K.id===de;Me.setState(K,T,ot)}let Qe=!1;K.version===Re.__version?(Re.needsLights&&Re.lightsStateVersion!==Gt.state.version||Re.outputColorSpace!==ye||J.isBatchedMesh&&Re.batching===!1||!J.isBatchedMesh&&Re.batching===!0||J.isBatchedMesh&&Re.batchingColor===!0&&J.colorTexture===null||J.isBatchedMesh&&Re.batchingColor===!1&&J.colorTexture!==null||J.isInstancedMesh&&Re.instancing===!1||!J.isInstancedMesh&&Re.instancing===!0||J.isSkinnedMesh&&Re.skinning===!1||!J.isSkinnedMesh&&Re.skinning===!0||J.isInstancedMesh&&Re.instancingColor===!0&&J.instanceColor===null||J.isInstancedMesh&&Re.instancingColor===!1&&J.instanceColor!==null||J.isInstancedMesh&&Re.instancingMorph===!0&&J.morphTexture===null||J.isInstancedMesh&&Re.instancingMorph===!1&&J.morphTexture!==null||Re.envMap!==Ie||K.fog===!0&&Re.fog!==Ee||Re.numClippingPlanes!==void 0&&(Re.numClippingPlanes!==Me.numPlanes||Re.numIntersection!==Me.numIntersection)||Re.vertexAlphas!==Ge||Re.vertexTangents!==je||Re.morphTargets!==Ue||Re.morphNormals!==nt||Re.morphColors!==_t||Re.toneMapping!==mt||Re.morphTargetsCount!==At||!!Re.lightProbeGrid!=S.state.lightProbeGridArray.length>0)&&(Qe=!0):(Qe=!0,Re.__version=K.version);let jt=Re.currentProgram;Qe===!0&&(jt=ss(K,j,J),k&&K.isNodeMaterial&&k.onUpdateProgram(K,jt,Re));let tn=!1,Tn=!1,ci=!1;const st=jt.getUniforms(),vt=Re.uniforms;if(_.useProgram(jt.program)&&(tn=!0,Tn=!0,ci=!0),K.id!==de&&(de=K.id,Tn=!0),Re.needsLights){const ot=Ed(S.state.lightProbeGridArray,J);Re.lightProbeGrid!==ot&&(Re.lightProbeGrid=ot,Tn=!0)}if(tn||he!==T){_.buffers.depth.getReversed()&&T.reversedDepth!==!0&&(T._reversedDepth=!0,T.updateProjectionMatrix()),st.setValue(R,"projectionMatrix",T.projectionMatrix),st.setValue(R,"viewMatrix",T.matrixWorldInverse);const Rn=st.map.cameraPosition;Rn!==void 0&&Rn.setValue(R,dt.setFromMatrixPosition(T.matrixWorld)),w.logarithmicDepthBuffer&&st.setValue(R,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(K.isMeshPhongMaterial||K.isMeshToonMaterial||K.isMeshLambertMaterial||K.isMeshBasicMaterial||K.isMeshStandardMaterial||K.isShaderMaterial)&&st.setValue(R,"isOrthographic",T.isOrthographicCamera===!0),he!==T&&(he=T,Tn=!0,ci=!0)}if(Re.needsLights&&(Gt.state.directionalShadowMap.length>0&&st.setValue(R,"directionalShadowMap",Gt.state.directionalShadowMap,z),Gt.state.spotShadowMap.length>0&&st.setValue(R,"spotShadowMap",Gt.state.spotShadowMap,z),Gt.state.pointShadowMap.length>0&&st.setValue(R,"pointShadowMap",Gt.state.pointShadowMap,z)),J.isSkinnedMesh){st.setOptional(R,J,"bindMatrix"),st.setOptional(R,J,"bindMatrixInverse");const ot=J.skeleton;ot&&(ot.boneTexture===null&&ot.computeBoneTexture(),st.setValue(R,"boneTexture",ot.boneTexture,z))}J.isBatchedMesh&&(st.setOptional(R,J,"batchingTexture"),st.setValue(R,"batchingTexture",J._matricesTexture,z),st.setOptional(R,J,"batchingIdTexture"),st.setValue(R,"batchingIdTexture",J._indirectTexture,z),st.setOptional(R,J,"batchingColorTexture"),J._colorsTexture!==null&&st.setValue(R,"batchingColorTexture",J._colorsTexture,z));const An=te.morphAttributes;if((An.position!==void 0||An.normal!==void 0||An.color!==void 0)&&V.update(J,te,jt),(Tn||Re.receiveShadow!==J.receiveShadow)&&(Re.receiveShadow=J.receiveShadow,st.setValue(R,"receiveShadow",J.receiveShadow)),(K.isMeshStandardMaterial||K.isMeshLambertMaterial||K.isMeshPhongMaterial)&&K.envMap===null&&j.environment!==null&&(vt.envMapIntensity.value=j.environmentIntensity),vt.dfgLUT!==void 0&&(vt.dfgLUT.value=H0()),Tn){if(st.setValue(R,"toneMappingExposure",U.toneMappingExposure),Re.needsLights&&Td(vt,ci),Ee&&K.fog===!0&&le.refreshFogUniforms(vt,Ee),le.refreshMaterialUniforms(vt,K,W,fe,S.state.transmissionRenderTarget[T.id]),Re.needsLights&&Re.lightProbeGrid){const ot=Re.lightProbeGrid;vt.probesSH.value=ot.texture,vt.probesMin.value.copy(ot.boundingBox.min),vt.probesMax.value.copy(ot.boundingBox.max),vt.probesResolution.value.copy(ot.resolution)}zs.upload(R,To(Re),vt,z)}if(K.isShaderMaterial&&K.uniformsNeedUpdate===!0&&(zs.upload(R,To(Re),vt,z),K.uniformsNeedUpdate=!1),K.isSpriteMaterial&&st.setValue(R,"center",J.center),st.setValue(R,"modelViewMatrix",J.modelViewMatrix),st.setValue(R,"normalMatrix",J.normalMatrix),st.setValue(R,"modelMatrix",J.matrixWorld),K.uniformsGroups!==void 0){const ot=K.uniformsGroups;for(let Rn=0,li=ot.length;Rn<li;Rn++){const Ro=ot[Rn];ue.update(Ro,jt),ue.bind(Ro,jt)}}return jt}function Td(T,j){T.ambientLightColor.needsUpdate=j,T.lightProbe.needsUpdate=j,T.directionalLights.needsUpdate=j,T.directionalLightShadows.needsUpdate=j,T.pointLights.needsUpdate=j,T.pointLightShadows.needsUpdate=j,T.spotLights.needsUpdate=j,T.spotLightShadows.needsUpdate=j,T.rectAreaLights.needsUpdate=j,T.hemisphereLights.needsUpdate=j}function Ad(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return q},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return Y},this.setRenderTargetTextures=function(T,j,te){const K=L.get(T);K.__autoAllocateDepthBuffer=T.resolveDepthBuffer===!1,K.__autoAllocateDepthBuffer===!1&&(K.__useRenderToTexture=!1),L.get(T.texture).__webglTexture=j,L.get(T.depthTexture).__webglTexture=K.__autoAllocateDepthBuffer?void 0:te,K.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(T,j){const te=L.get(T);te.__webglFramebuffer=j,te.__useDefaultFramebuffer=j===void 0},this.setRenderTarget=function(T,j=0,te=0){Y=T,q=j,I=te;let K=null,J=!1,Ee=!1;if(T){const ye=L.get(T);if(ye.__useDefaultFramebuffer!==void 0){_.bindFramebuffer(R.FRAMEBUFFER,ye.__webglFramebuffer),me.copy(T.viewport),Te.copy(T.scissor),Ve=T.scissorTest,_.viewport(me),_.scissor(Te),_.setScissorTest(Ve),de=-1;return}else if(ye.__webglFramebuffer===void 0)z.setupRenderTarget(T);else if(ye.__hasExternalTextures)z.rebindTextures(T,L.get(T.texture).__webglTexture,L.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const Ge=T.depthTexture;if(ye.__boundDepthTexture!==Ge){if(Ge!==null&&L.has(Ge)&&(T.width!==Ge.image.width||T.height!==Ge.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");z.setupDepthRenderbuffer(T)}}const Pe=T.texture;(Pe.isData3DTexture||Pe.isDataArrayTexture||Pe.isCompressedArrayTexture)&&(Ee=!0);const Ie=L.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(Ie[j])?K=Ie[j][te]:K=Ie[j],J=!0):T.samples>0&&z.useMultisampledRTT(T)===!1?K=L.get(T).__webglMultisampledFramebuffer:Array.isArray(Ie)?K=Ie[te]:K=Ie,me.copy(T.viewport),Te.copy(T.scissor),Ve=T.scissorTest}else me.copy(xe).multiplyScalar(W).floor(),Te.copy(ke).multiplyScalar(W).floor(),Ve=Be;if(te!==0&&(K=Q),_.bindFramebuffer(R.FRAMEBUFFER,K)&&_.drawBuffers(T,K),_.viewport(me),_.scissor(Te),_.setScissorTest(Ve),J){const ye=L.get(T.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+j,ye.__webglTexture,te)}else if(Ee){const ye=j;for(let Pe=0;Pe<T.textures.length;Pe++){const Ie=L.get(T.textures[Pe]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+Pe,Ie.__webglTexture,te,ye)}}else if(T!==null&&te!==0){const ye=L.get(T.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,ye.__webglTexture,te)}de=-1},this.readRenderTargetPixels=function(T,j,te,K,J,Ee,Ce,ye=0){if(!(T&&T.isWebGLRenderTarget)){et("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pe=L.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Ce!==void 0&&(Pe=Pe[Ce]),Pe){_.bindFramebuffer(R.FRAMEBUFFER,Pe);try{const Ie=T.textures[ye],Ge=Ie.format,je=Ie.type;if(T.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+ye),!w.textureFormatReadable(Ge)){et("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!w.textureTypeReadable(je)){et("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}j>=0&&j<=T.width-K&&te>=0&&te<=T.height-J&&R.readPixels(j,te,K,J,_e.convert(Ge),_e.convert(je),Ee)}finally{const Ie=Y!==null?L.get(Y).__webglFramebuffer:null;_.bindFramebuffer(R.FRAMEBUFFER,Ie)}}},this.readRenderTargetPixelsAsync=async function(T,j,te,K,J,Ee,Ce,ye=0){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pe=L.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Ce!==void 0&&(Pe=Pe[Ce]),Pe)if(j>=0&&j<=T.width-K&&te>=0&&te<=T.height-J){_.bindFramebuffer(R.FRAMEBUFFER,Pe);const Ie=T.textures[ye],Ge=Ie.format,je=Ie.type;if(T.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+ye),!w.textureFormatReadable(Ge))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!w.textureTypeReadable(je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ue=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,Ue),R.bufferData(R.PIXEL_PACK_BUFFER,Ee.byteLength,R.STREAM_READ),R.readPixels(j,te,K,J,_e.convert(Ge),_e.convert(je),0);const nt=Y!==null?L.get(Y).__webglFramebuffer:null;_.bindFramebuffer(R.FRAMEBUFFER,nt);const _t=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await dh(R,_t,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,Ue),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,Ee),R.deleteBuffer(Ue),R.deleteSync(_t),Ee}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(T,j=null,te=0){const K=Math.pow(2,-te),J=Math.floor(T.image.width*K),Ee=Math.floor(T.image.height*K),Ce=j!==null?j.x:0,ye=j!==null?j.y:0;z.setTexture2D(T,0),R.copyTexSubImage2D(R.TEXTURE_2D,te,0,0,Ce,ye,J,Ee),_.unbindTexture()},this.copyTextureToTexture=function(T,j,te=null,K=null,J=0,Ee=0){let Ce,ye,Pe,Ie,Ge,je,Ue,nt,_t;const mt=T.isCompressedTexture?T.mipmaps[Ee]:T.image;if(te!==null)Ce=te.max.x-te.min.x,ye=te.max.y-te.min.y,Pe=te.isBox3?te.max.z-te.min.z:1,Ie=te.min.x,Ge=te.min.y,je=te.isBox3?te.min.z:0;else{const vt=Math.pow(2,-J);Ce=Math.floor(mt.width*vt),ye=Math.floor(mt.height*vt),T.isDataArrayTexture?Pe=mt.depth:T.isData3DTexture?Pe=Math.floor(mt.depth*vt):Pe=1,Ie=0,Ge=0,je=0}K!==null?(Ue=K.x,nt=K.y,_t=K.z):(Ue=0,nt=0,_t=0);const it=_e.convert(j.format),At=_e.convert(j.type);let Re;j.isData3DTexture?(z.setTexture3D(j,0),Re=R.TEXTURE_3D):j.isDataArrayTexture||j.isCompressedArrayTexture?(z.setTexture2DArray(j,0),Re=R.TEXTURE_2D_ARRAY):(z.setTexture2D(j,0),Re=R.TEXTURE_2D),_.activeTexture(R.TEXTURE0),_.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,j.flipY),_.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,j.premultiplyAlpha),_.pixelStorei(R.UNPACK_ALIGNMENT,j.unpackAlignment);const Gt=_.getParameter(R.UNPACK_ROW_LENGTH),Qe=_.getParameter(R.UNPACK_IMAGE_HEIGHT),jt=_.getParameter(R.UNPACK_SKIP_PIXELS),tn=_.getParameter(R.UNPACK_SKIP_ROWS),Tn=_.getParameter(R.UNPACK_SKIP_IMAGES);_.pixelStorei(R.UNPACK_ROW_LENGTH,mt.width),_.pixelStorei(R.UNPACK_IMAGE_HEIGHT,mt.height),_.pixelStorei(R.UNPACK_SKIP_PIXELS,Ie),_.pixelStorei(R.UNPACK_SKIP_ROWS,Ge),_.pixelStorei(R.UNPACK_SKIP_IMAGES,je);const ci=T.isDataArrayTexture||T.isData3DTexture,st=j.isDataArrayTexture||j.isData3DTexture;if(T.isDepthTexture){const vt=L.get(T),An=L.get(j),ot=L.get(vt.__renderTarget),Rn=L.get(An.__renderTarget);_.bindFramebuffer(R.READ_FRAMEBUFFER,ot.__webglFramebuffer),_.bindFramebuffer(R.DRAW_FRAMEBUFFER,Rn.__webglFramebuffer);for(let li=0;li<Pe;li++)ci&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,L.get(T).__webglTexture,J,je+li),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,L.get(j).__webglTexture,Ee,_t+li)),R.blitFramebuffer(Ie,Ge,Ce,ye,Ue,nt,Ce,ye,R.DEPTH_BUFFER_BIT,R.NEAREST);_.bindFramebuffer(R.READ_FRAMEBUFFER,null),_.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(J!==0||T.isRenderTargetTexture||L.has(T)){const vt=L.get(T),An=L.get(j);_.bindFramebuffer(R.READ_FRAMEBUFFER,B),_.bindFramebuffer(R.DRAW_FRAMEBUFFER,D);for(let ot=0;ot<Pe;ot++)ci?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,vt.__webglTexture,J,je+ot):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,vt.__webglTexture,J),st?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,An.__webglTexture,Ee,_t+ot):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,An.__webglTexture,Ee),J!==0?R.blitFramebuffer(Ie,Ge,Ce,ye,Ue,nt,Ce,ye,R.COLOR_BUFFER_BIT,R.NEAREST):st?R.copyTexSubImage3D(Re,Ee,Ue,nt,_t+ot,Ie,Ge,Ce,ye):R.copyTexSubImage2D(Re,Ee,Ue,nt,Ie,Ge,Ce,ye);_.bindFramebuffer(R.READ_FRAMEBUFFER,null),_.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else st?T.isDataTexture||T.isData3DTexture?R.texSubImage3D(Re,Ee,Ue,nt,_t,Ce,ye,Pe,it,At,mt.data):j.isCompressedArrayTexture?R.compressedTexSubImage3D(Re,Ee,Ue,nt,_t,Ce,ye,Pe,it,mt.data):R.texSubImage3D(Re,Ee,Ue,nt,_t,Ce,ye,Pe,it,At,mt):T.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,Ee,Ue,nt,Ce,ye,it,At,mt.data):T.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,Ee,Ue,nt,mt.width,mt.height,it,mt.data):R.texSubImage2D(R.TEXTURE_2D,Ee,Ue,nt,Ce,ye,it,At,mt);_.pixelStorei(R.UNPACK_ROW_LENGTH,Gt),_.pixelStorei(R.UNPACK_IMAGE_HEIGHT,Qe),_.pixelStorei(R.UNPACK_SKIP_PIXELS,jt),_.pixelStorei(R.UNPACK_SKIP_ROWS,tn),_.pixelStorei(R.UNPACK_SKIP_IMAGES,Tn),Ee===0&&j.generateMipmaps&&R.generateMipmap(Re),_.unbindTexture()},this.initRenderTarget=function(T){L.get(T).__webglFramebuffer===void 0&&z.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?z.setTextureCube(T,0):T.isData3DTexture?z.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?z.setTexture2DArray(T,0):z.setTexture2D(T,0),_.unbindTexture()},this.resetState=function(){q=0,I=0,Y=null,_.reset(),we.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return cn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Ye._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ye._getUnpackColorSpace()}}const Ns=[{text:"ВЫ ГОТОВЫ?",sub:"канал синхронизирован",crack:0,light:2875596},{text:"УСАЖИВАЙТЕСЬ ПОУДОБНЕЕ",sub:"протокол начат",crack:1,light:15357964},{text:"ВЫБИРАЙТЕ КАПИТАНОВ",sub:"формирование команд",crack:2,light:2875596},{text:"ПОЧТИ ЗАГРУЗИЛИ ВОПРОСЫ...",sub:"база вопросов синхронизируется",crack:3,light:15357964},{text:"ВСЕ НА МЕСТЕ",sub:"все каналы подтверждены",crack:3,light:10116351},{text:"ПОГНАЛИ!",sub:"раунд 01 // на связи",crack:4,light:15357964,final:!0}],xd=620,V0=560,W0=300,j0=2800,Yc=850,Zc=["#2be0cc","#ea580c","#9a5cff","#ff3d7f","#4d9fff","#c6ff3d"],Kc=210,Xr=300,Jc=.42,Qc=740,Ps=n=>-(n+1)*xd,X0=n=>n===1?1:1-Math.pow(2,-10*n),qr=n=>new Promise(e=>setTimeout(e,n)),el=["SYNC","AUTH","NODE","PING","LOAD","SCAN","LINK","BUFF","CORE","GRID"];function tl(n){return Array.from({length:n},(e,t)=>`0x${Math.floor(Math.random()*65535).toString(16).toUpperCase().padStart(4,"0")} ${el[t%el.length]}`)}function q0({onDone:n}){const e=ee.useRef(null),t=ee.useRef(null),i=ee.useRef(null),s=ee.useRef(null),r=ee.useRef(null),a=ee.useRef(null),c=ee.useRef(null),d=ee.useRef(null),l=ee.useRef(null),u=ee.useRef(null),p=ee.useRef(n);p.current=n,Ja();const h=ee.useMemo(()=>tl(16),[]),g=ee.useMemo(()=>tl(16),[]);return ee.useEffect(()=>{let x=!1,v=!1;const m=()=>{v||(v=!0,p.current())};let f=null;function b(){if(!f)try{const X=window.AudioContext??window.webkitAudioContext;f=new X}catch{}return f}function E(){const X=b();if(!X)return;X.state==="suspended"&&X.resume();const R=X.currentTime,ie=X.createOscillator();ie.type="sine",ie.frequency.setValueAtTime(130,R),ie.frequency.exponentialRampToValueAtTime(42,R+.16);const se=X.createGain();se.gain.setValueAtTime(1,R),se.gain.exponentialRampToValueAtTime(.001,R+.38),ie.connect(se).connect(X.destination),ie.start(R),ie.stop(R+.42);const w=Math.floor(X.sampleRate*.14),_=X.createBuffer(1,w,X.sampleRate),P=_.getChannelData(0);for(let G=0;G<w;G++)P[G]=(Math.random()*2-1)*Math.pow(1-G/w,2.2);const L=X.createBufferSource();L.buffer=_;const z=X.createBiquadFilter();z.type="lowpass",z.frequency.value=850;const $=X.createGain();$.gain.setValueAtTime(.55,R),$.gain.exponentialRampToValueAtTime(.001,R+.13),L.connect(z).connect($).connect(X.destination),L.start(R)}function y(){const X=i.current;X&&(X.currentTime=0,X.play().catch(()=>{}))}const A=t.current,S=(A==null?void 0:A.getContext("2d"))??null;let C=[],M=0;function N(){A&&(A.width=window.innerWidth,A.height=window.innerHeight)}N();function U(X,R){C=[];let ie=0;const se=6;function w(P,L,z,$,G,F){const H=3+Math.floor(Math.random()*3),ne=[[P,L]];let le=z,oe=P,re=L;for(let Me=0;Me<H;Me++){le+=(Math.random()-.5)*.6;const be=$/H;if(oe+=Math.cos(le)*be,re+=Math.sin(le)*be,ne.push([oe,re]),G>0&&Math.random()<.5){const De=le+(Math.random()<.5?1:-1)*(.5+Math.random()*.9);w(oe,re,De,$*(.35+Math.random()*.3),G-1,F*.78)}}C.push({pts:ne,color:Zc[ie++%Zc.length],width:F})}const _=[R*(.06+Math.random()*.1),R*(.84+Math.random()*.1)];for(let P=0;P<se;P++){const L=X*(.15+Math.random()*.7),z=P<_.length?_[P]:R*(.1+Math.random()*.8),$=9+Math.floor(Math.random()*6);for(let G=0;G<$;G++){const F=G/$*Math.PI*2+(Math.random()-.5)*.4,H=Math.max(X,R)*(.18+Math.random()*.38);w(L,z,F,H,2,.9)}}}function O(X){if(!S||X<=0)return;const R=Math.min(1,X/2.4),ie=Math.round(C.length*R);for(let se=0;se<ie;se++){const w=C[se];S.lineWidth=w.width*(.9+X*.1),S.strokeStyle=w.color,S.globalAlpha=.75+X*.1,S.shadowColor=w.color,S.shadowBlur=5+X*2.2,S.beginPath(),w.pts.forEach(([_,P],L)=>L===0?S.moveTo(_,P):S.lineTo(_,P)),S.stroke()}S.globalAlpha=1,S.shadowBlur=0}function k(X,R,ie){S&&(S.clearRect(0,0,R,ie),O(X))}function Q(){const X=l.current;X&&(X.classList.remove("intro-hit"),X.offsetWidth,X.classList.add("intro-hit"))}function B(){var R,ie,se,w;const X=(R=r.current)==null?void 0:R.firstElementChild;X&&(X.classList.remove("intro-rgbslam"),X.offsetWidth,X.classList.add("intro-rgbslam")),(ie=r.current)==null||ie.classList.remove("intro-jitter"),(se=r.current)==null||se.offsetWidth,(w=r.current)==null||w.classList.add("intro-jitter"),Q(),qe()}async function D(){for(let X=5;X>=1&&!x;X--){const R=r.current;if(!R)return;R.innerHTML="";const ie=document.createElement("div");ie.className="intro-glyph",ie.setAttribute("data-t",String(X)),ie.textContent=String(X),R.appendChild(ie),B(),E(),await ie.animate([{transform:"scale(.4)",opacity:0,filter:"blur(14px)"},{transform:"scale(1.22)",opacity:1,filter:"blur(0px)",offset:.55},{transform:"scale(1)",opacity:1,filter:"blur(0px)"}],{duration:Yc*.7,easing:"cubic-bezier(.2,1.4,.4,1)"}).finished,await qr(Yc*.3)}}let q=null,I=null,Y=null,de=0,he=!1,me=-1;const Ve=document.createElement("canvas").getContext("2d");Ve.font=`700 ${Kc}px "Rajdhani", sans-serif`;const Ae=[],ze=[];function ae(X,R){const ie=Math.ceil(Ve.measureText(X).width),se=Math.max(200,ie+120),w=document.createElement("canvas");w.width=se,w.height=Xr;const _=w.getContext("2d");_.font=`700 ${Kc}px "Rajdhani", sans-serif`,_.textAlign="center",_.textBaseline="middle",_.shadowColor=R,_.shadowBlur=56,_.fillStyle="#d24e01",_.fillText(X,se/2,Xr/2);const P=new td(w);P.anisotropy=4;let L=se*Jc,z=Xr*Jc;if(L>Qc){const $=Qc/L;L*=$,z*=$}return{tex:P,worldW:L,worldH:z}}function fe(X,R,ie){const{tex:se,worldW:w,worldH:_}=ae(X,ie),P=new Oi(w,_),L=new On({map:se,transparent:!0,depthWrite:!1,opacity:0}),z=new lt(P,L);z.position.set(0,10,R),z.visible=!1,I.add(z);const $=new lt(P,new On({map:se,transparent:!0,depthWrite:!1,blending:ni,color:2875596,opacity:0})),G=new lt(P,new On({map:se,transparent:!0,depthWrite:!1,blending:ni,color:10116351,opacity:0}));return $.position.copy(z.position),G.position.copy(z.position),$.visible=!1,G.visible=!1,I.add($),I.add(G),ze.push(P,L,se,$.material,G.material),{mesh:z,ghostCy:$,ghostMg:G}}const W={camZ:0,camX:0,warpKick:0,yawKick:0,focusZ:-300,fovKick:0};let ge,pe;function xe(){const X=e.current;if(!X)return;q=new gd({canvas:X,antialias:!0,alpha:!0,preserveDrawingBuffer:!0}),q.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),I=new Zl,I.fog=new sr(263946,.0011),Y=new Bt(62,window.innerWidth/window.innerHeight,1,6e3),Y.position.set(0,0,40),I.add(new od(928300,1.1));const R=xd*Ns.length+500,ie=900,se=new Lt,w=new Float32Array(ie*3),_=new Float32Array(ie*3),P=[2875596,15357964,15357964,10116351];for(let G=0;G<ie;G++){const F=60+Math.random()*260,H=Math.random()*Math.PI*2;w[G*3]=Math.cos(H)*F,w[G*3+1]=Math.sin(H)*F,w[G*3+2]=-Math.random()*R;const ne=new $e(P[G%P.length]);_[G*3]=ne.r,_[G*3+1]=ne.g,_[G*3+2]=ne.b}se.setAttribute("position",new Ut(w,3)),se.setAttribute("color",new Ut(_,3));const L=new ar({size:3.4,vertexColors:!0,transparent:!0,opacity:.85});I.add(new ho(se,L)),ze.push(se,L),Ns.forEach((G,F)=>{const H=Ps(F),ne="#"+G.light.toString(16).padStart(6,"0");Ae.push(fe(G.text,H,ne));const le=new ei(G.light,2.4,900,2);le.position.set(0,40,H+60),I.add(le)}),ge=new ei(15357964,4,550,2),pe=new ei(10116351,2.6,550,2),I.add(ge),I.add(pe),he=!0,ke();const z=Math.random()*1e3;W.camZ=0;function $(G){if(!q||!I||!Y)return;{const le=Math.sin(G*.0016+z)*1.1+Math.sin(G*.0043)*.5,oe=Math.cos(G*.002+z)*.9+Math.cos(G*.0038)*.45;Y.position.x=le+W.camX,Y.position.y=oe+6}Y.position.z=W.camZ+W.warpKick;const F=W.yawKick,H=Y.position.x+Math.sin(F)*640;Y.lookAt(H,Y.position.y-4,W.focusZ),Y.rotateZ(-F*.5);const ne=62+W.fovKick*14;Y.fov!==ne&&(Y.fov=ne,Y.updateProjectionMatrix()),ge.position.set(Math.sin(G*6e-4)*80,30,W.camZ-120),pe.position.set(Math.cos(G*7e-4)*80,-10,W.camZ-200),Ae.forEach(le=>{le.mesh.visible&&le.mesh.quaternion.copy(Y.quaternion),le.ghostCy.visible&&le.ghostCy.quaternion.copy(Y.quaternion),le.ghostMg.visible&&le.ghostMg.quaternion.copy(Y.quaternion)}),q.render(I,Y),de=requestAnimationFrame($)}de=requestAnimationFrame($)}function ke(){!he||!q||!Y||(q.setSize(window.innerWidth,window.innerHeight),Y.aspect=window.innerWidth/window.innerHeight,Y.updateProjectionMatrix())}function Be(){ke(),N(),U(window.innerWidth,window.innerHeight),k(M,window.innerWidth,window.innerHeight)}window.addEventListener("resize",Be,{passive:!0});function Je(X,R=650){const ie=me;me=X;const se=Ae[X];if(!se)return;se.mesh.visible=!0,se.mesh.material.opacity=0;const w=ie>=0?Ae[ie]:null,_=performance.now();function P(){const L=Math.min(1,(performance.now()-_)/R);se.mesh.material.opacity=L,w&&(w.mesh.material.opacity=1-L),L<1?requestAnimationFrame(P):w&&(w.mesh.visible=!1)}P()}function qe(){if(me<0)return;const X=Ae[me];if(!X)return;const R=16+Math.random()*14;X.ghostCy.visible=!0,X.ghostCy.material.opacity=.6,X.ghostCy.position.x=-R,X.ghostMg.visible=!0,X.ghostMg.material.opacity=.6,X.ghostMg.position.x=R,setTimeout(()=>{X.ghostCy.material.opacity=0,X.ghostCy.visible=!1,X.ghostCy.position.x=0,X.ghostMg.material.opacity=0,X.ghostMg.visible=!1,X.ghostMg.position.x=0},140+Math.random()*100)}async function We(X,R,ie,se,w){const _=W.camZ,P=W.camX,L=performance.now();return W.warpKick=(Math.random()-.5)*34,W.yawKick=w*se,W.fovKick=1,new Promise(z=>{function $(G){const F=Math.min(1,(G-L)/ie),H=X0(F);W.camZ=_+(X-_)*H,W.camX=P+(R-P)*H,W.warpKick*=.92,W.yawKick*=.975,W.fovKick*=.965,F<1?requestAnimationFrame($):z()}requestAnimationFrame($)})}function ct(X=1,R=420){if(!he||!S||!e.current)return;const ie=window.innerWidth,se=window.innerHeight,w=performance.now()+R;function _(){if(performance.now()>w){k(M,ie,se);return}S.clearRect(0,0,ie,se),O(M);const L=5+Math.floor(Math.random()*8*X);for(let $=0;$<L;$++){const G=Math.random()*se,F=4+Math.random()*52*X,H=(Math.random()-.5)*130*X;try{S.drawImage(e.current,0,G,ie,F,H,G,ie,F)}catch{}}const z=Math.round(6*X);S.globalCompositeOperation="screen";for(let $=0;$<z;$++){const G=Math.random()*se;S.strokeStyle=["#2be0cc","#ea580c","#9a5cff"][Math.floor(Math.random()*3)],S.globalAlpha=.35+Math.random()*.35,S.lineWidth=.6+Math.random()*1.6,S.beginPath(),S.moveTo(0,G),S.lineTo(ie,G),S.stroke()}if(S.globalCompositeOperation="source-over",S.globalAlpha=1,Math.random()<X*.12){S.globalAlpha=.5;for(let $=0;$<220;$++)S.fillStyle=Math.random()<.5?"#eef6f4":"#04070a",S.fillRect(Math.random()*ie,Math.random()*se,2,2);S.globalAlpha=1}requestAnimationFrame(_)}_()}function dt(X=1,R=340){if(!he||!S)return;const ie=window.innerWidth,se=window.innerHeight,w=ie/2,_=se/2,P=12+Math.floor(10*X),L=Array.from({length:P},()=>Math.random()*Math.PI*2),z=performance.now();function $(){const F=(performance.now()-z)/R;if(F>=1){k(M,ie,se);return}S.save(),S.globalCompositeOperation="screen",L.forEach(H=>{const ne=30+F*300,le=ne+90+Math.random()*150,oe=w+Math.cos(H)*ne,re=_+Math.sin(H)*ne,Me=w+Math.cos(H)*le,be=_+Math.sin(H)*le;S.strokeStyle=Math.random()<.5?"#ea580c":"#eef6f4",S.globalAlpha=(1-F)*(.28+Math.random()*.32)*X,S.lineWidth=1.2+Math.random()*1.8,S.beginPath(),S.moveTo(oe,re),S.lineTo(Me,be),S.stroke()}),S.restore(),requestAnimationFrame($)}$()}async function ft(X=900){const R=window.innerWidth,ie=window.innerHeight;if(!S)return;const se=performance.now(),w=C.map(()=>Math.random()*.25);await new Promise(_=>{function P(){const L=Math.min(1,(performance.now()-se)/X);S.clearRect(0,0,R,ie),C.forEach((z,$)=>{const G=Math.min(1,Math.max(0,(L-w[$])/(1-w[$])));if(G<=0)return;const F=z.pts,H=F.length-1,ne=G*H;S.lineWidth=z.width*(1+L*.4),S.strokeStyle=z.color,S.globalAlpha=.65+L*.3,S.shadowColor=z.color,S.shadowBlur=3+L*5,S.beginPath(),S.moveTo(F[0][0],F[0][1]);for(let re=0;re<Math.floor(ne);re++)S.lineTo(F[re+1][0],F[re+1][1]);const le=Math.floor(ne),oe=ne-le;if(le<H&&oe>0){const[re,Me]=F[le],[be,De]=F[le+1];S.lineTo(re+(be-re)*oe,Me+(De-Me)*oe)}S.stroke()}),S.globalAlpha=1,S.shadowBlur=0,L<1?requestAnimationFrame(P):_()}P()})}async function xt(){var G;Q(),(G=r.current)==null||G.classList.add("intro-jitter");const X=u.current;if(!X)return;X.innerHTML="";const R=window.innerWidth,ie=window.innerHeight,se=11,w=8,_=R/se,P=ie/w,L=R/2,z=ie/2,$=[];for(let F=0;F<w;F++)for(let H=0;H<se;H++){const ne=H*_,le=F*P,oe=()=>(Math.random()-.5)*16,re=document.createElement("div");re.className="intro-shard",re.style.left=ne+"px",re.style.top=le+"px",re.style.width=_+2+"px",re.style.height=P+2+"px",re.style.clipPath=`polygon(${oe()}px ${oe()}px, ${_+oe()}px ${oe()}px, ${_+oe()}px ${P+oe()}px, ${oe()}px ${P+oe()}px)`,X.appendChild(re);const Me=ne+_/2-L,be=le+P/2-z,De=Math.hypot(Me,be)||1;$.push({div:re,dx:Me/De,dy:be/De,delay:De/Math.max(R,ie)*220+Math.random()*80})}$.forEach(({div:F,dx:H,dy:ne,delay:le})=>{const oe=60+Math.random()*140,re=420+Math.random()*420,Me=(Math.random()-.5)*420;F.animate([{transform:"translate(0,0) rotate(0deg) scale(1)",opacity:.95,offset:0},{transform:`translate(${H*oe}px, ${ne*oe-20}px) rotate(${Me*.3}deg) scale(.9)`,opacity:.9,offset:.22},{transform:`translate(${H*oe*1.4}px, ${ne*oe+re}px) rotate(${Me}deg) scale(.35)`,opacity:0,offset:1}],{duration:1300,delay:le,easing:"cubic-bezier(.35,.02,.6,1)",fill:"forwards"})}),await qr(1600),X.innerHTML=""}async function rt(){var X;if(U(window.innerWidth,window.innerHeight),xe(),s.current&&(s.current.style.display="flex"),await D(),!x){s.current&&(s.current.style.display="none"),(X=c.current)==null||X.classList.add("intro-on"),y();for(let R=0;R<Ns.length&&!x;R++){const ie=Ns[R];M=ie.crack,d.current&&(d.current.innerHTML=ie.final?ie.sub:`${ie.sub} · трещина канала <b>${ie.crack}/4</b>`),Je(R),W.focusZ=Ps(R);const se=R%2===0?1:-1,w=ie.final?0:se*60,_=ie.final?Ps(R)-W0:Ps(R)+V0;if(await We(_,w,j0,.5+ie.crack*.09,se),x)return;B(),ct(Math.min(1,.5+ie.crack*.14),ie.final?300:260),ie.final||dt(.8+ie.crack*.1,320),k(M,window.innerWidth,window.innerHeight)}x||(await ft(900),!x&&(await qr(150),await xt(),!x&&m()))}}return rt(),()=>{x=!0,window.removeEventListener("resize",Be),cancelAnimationFrame(de),ze.forEach(X=>X.dispose()),q==null||q.dispose(),f==null||f.close().catch(()=>{})}},[]),o.jsx("div",{className:"host-screen grid-bg intro-screen",children:o.jsxs("div",{className:"intro-root",children:[o.jsx("canvas",{ref:e,className:"intro-gl"}),o.jsx("canvas",{ref:t,className:"intro-crack"}),o.jsx("div",{ref:u,className:"intro-shatter-layer"}),o.jsx("div",{className:"intro-vignette"}),o.jsx("div",{className:"intro-scanlines"}),o.jsx("div",{ref:l,className:"intro-noise"}),o.jsx("div",{className:"intro-bracket tl",children:o.jsx("b",{})}),o.jsx("div",{className:"intro-bracket tr",children:o.jsx("b",{})}),o.jsx("div",{className:"intro-bracket bl",children:o.jsx("b",{})}),o.jsx("div",{className:"intro-bracket br",children:o.jsx("b",{})}),o.jsx("div",{className:"intro-ticker left",children:o.jsx("div",{className:"intro-ticker-col",children:[...h,...h].map((x,v)=>o.jsx("span",{className:v%6===0?"hi":void 0,children:x},v))})}),o.jsx("div",{className:"intro-ticker right",children:o.jsx("div",{className:"intro-ticker-col",children:[...g,...g].map((x,v)=>o.jsx("span",{className:v%5===0?"hi":void 0,children:x},v))})}),o.jsxs("div",{ref:s,className:"intro-stage",children:[o.jsx("div",{className:"intro-eyebrow",children:"protocol // boot sequence"}),o.jsx("div",{ref:r,className:"intro-frame"}),o.jsx("div",{ref:a,className:"intro-subline",children:"инициализация канала связи…"})]}),o.jsx("div",{ref:c,className:"intro-flight-label",children:o.jsx("div",{ref:d,className:"intro-subline"})}),o.jsx(Qa,{}),o.jsx("audio",{ref:i,src:"/quiz-party/intro.mp3",preload:"auto"})]})})}const $0=[{text:"Вопросы кончились",sub:"сближение с массивом данных",crack:0,light:2875596},{text:"Считаем результаты..",sub:"манёвр уклонения выполнен",crack:1,light:15357964},{text:"Финал уже близко",sub:"отказ двигателя левого борта",crack:2,light:16723804},{text:"Кто же победил?",sub:"критический разлом системы",crack:4,light:10116351,final:!0}],$r=[3400,2700,2200,1900],$a=640,nl=560,Y0=320,il=["#2be0cc","#ea580c","#9a5cff","#ff2f5c","#4d9fff"],Yr=220,Ls=300,sl=.46,rl=820,Xi=n=>-(n+1)*$a,Z0=n=>n===1?1:1-Math.pow(2,-10*n),qi=n=>new Promise(e=>setTimeout(e,n));function K0(){const n=new Jn,e=[],t=new Xn({color:8003624,metalness:.55,roughness:.38,emissive:1705224,emissiveIntensity:.4}),i=new fo(.42,.95,12),s=new lt(i,t);s.rotation.x=Math.PI/2,s.position.set(0,0,-1.55),n.add(s),e.push(i,t);const r=new Ri(.42,.36,1.9,12),a=new lt(r,t);a.rotation.x=Math.PI/2,a.position.set(0,0,-.15),n.add(a),e.push(r);const c=new ri(.5,.14,1),d=new Xn({color:1316636,metalness:.5,roughness:.6}),l=new lt(c,d);l.position.set(.08,.38,-.1),l.rotation.z=.1,n.add(l),e.push(c,d);const u=new Xn({color:790547,emissive:2875596,emissiveIntensity:2.2,metalness:.2,roughness:.3}),p=new Zs(.13,12,12),h=new lt(p,u);h.position.set(0,-.05,-2),n.add(h),e.push(p,u);const g=new Zs(.06,8,8);[-.22,.22].forEach(N=>{const U=new lt(g,u);U.position.set(N,.12,-1.7),n.add(U)}),e.push(g);const x=new Ri(.06,.06,1.4,6),v=new Xn({color:1711394,metalness:.7,roughness:.4});e.push(x,v);const m=new ri(.04,.86,.05),f=new Xn({color:658447,metalness:.4,roughness:.6});e.push(m,f);const b=new Ri(.5,.5,.07,16),E=new Xn({color:1382429,metalness:.6,roughness:.45});e.push(b,E);const y=new po(.6,.09,8,20);e.push(y);function A(N,U){const O=new Jn,k=new lt(x,v);k.rotation.z=Math.PI/2,k.position.set(N*.72,-.08,.15),O.add(k);const Q=N*1.45,B=new lt(b,E);B.rotation.x=Math.PI/2,B.position.set(Q,-.08,.15),O.add(B);const D=new Xn({color:855826,metalness:.75,roughness:.3,emissive:U,emissiveIntensity:1.4}),q=new lt(y,D);q.position.copy(B.position),O.add(q),e.push(D);const I=new Jn;I.position.copy(B.position);for(let Y=0;Y<5;Y++){const de=new lt(m,f);de.rotation.z=Y/5*Math.PI,I.add(de)}return O.add(I),{pod:O,rim:q,spokes:I}}const S=A(-1,2875596),C=A(1,15357964);n.add(S.pod,C.pod);const M=new ei(2875596,2.2,14,2);return M.position.set(0,0,-1.4),n.add(M),{group:n,rotorL:S,rotorR:C,engineLight:M,disposables:e}}function J0(n=60){const e=new Lt,t=new Float32Array(n*3),i=new Float32Array(n),s=new Float32Array(n*3);e.setAttribute("position",new Ut(t,3));const r=new ar({color:16757575,size:2.6,transparent:!0,opacity:.9,blending:ni,depthWrite:!1}),a=new ho(e,r);let c=0;function d(u,p,h,g){for(let x=0;x<g;x++){const v=c;c=(c+1)%n,i[v]=.4+Math.random()*.35,t[v*3]=u,t[v*3+1]=p,t[v*3+2]=h,s[v*3]=(Math.random()-.5)*3.2,s[v*3+1]=(Math.random()-.5)*3.2-1,s[v*3+2]=(Math.random()-.5)*3.2}}function l(u){for(let p=0;p<n;p++){if(i[p]<=0){t[p*3+1]=-9999;continue}i[p]-=u,t[p*3]+=s[p*3]*u,t[p*3+1]+=s[p*3+1]*u,t[p*3+2]+=s[p*3+2]*u,i[p]<=0&&(t[p*3+1]=-9999)}e.attributes.position.needsUpdate=!0}return{points:a,geo:e,mat:r,spawn:d,tick:l}}function Q0({onDone:n,phases:e=$0}){const t=ee.useRef(null),i=ee.useRef(null),s=ee.useRef(null),r=ee.useRef(null),a=ee.useRef(null),c=ee.useRef(null),d=ee.useRef(null),l=ee.useRef(n);l.current=n;const u=ee.useRef(e);u.current=e;const p=ee.useRef(()=>{});Ja();const h=ee.useMemo(()=>e.map(g=>g.text).join(" → "),[e]);return ee.useEffect(()=>{let g=!1,x=!1;const v=()=>{x||(x=!0,l.current())};p.current=v;const m=u.current,f=d.current,b=i.current,E=(b==null?void 0:b.getContext("2d"))??null;let y=[],A=0;function S(){b&&(b.width=window.innerWidth,b.height=window.innerHeight)}S();function C(X,R){y=[];let ie=0;const se=7;function w(P,L,z,$,G,F){const H=3+Math.floor(Math.random()*4),ne=[[P,L]];let le=z,oe=P,re=L;for(let Me=0;Me<H;Me++){le+=(Math.random()-.5)*.9;const be=$/H*(.55+Math.random()*.85);if(oe+=Math.cos(le)*be,re+=Math.sin(le)*be,ne.push([oe,re]),G>0&&Math.random()<.58){const De=le+(Math.random()<.5?1:-1)*(.4+Math.random()*1.1);w(oe,re,De,$*(.3+Math.random()*.35),G-1,F*.76)}}y.push({pts:ne,color:il[ie++%il.length],width:F})}for(let P=0;P<se;P++){const L=X*(.1+Math.random()*.8),z=R*(.08+Math.random()*.84),$=7+Math.floor(Math.random()*7);let G=Math.random()*Math.PI*2;for(let F=0;F<$;F++){G+=Math.PI*2/$*(.55+Math.random()*.9);const H=Math.max(X,R)*(.16+Math.random()*.46);w(L,z,G,H,2,.9)}}y.slice().forEach(P=>{if(P.pts.length<3||Math.random()>=.55)return;const[L,z]=P.pts[1+Math.floor(Math.random()*(P.pts.length-2))];w(L,z,Math.random()*Math.PI*2,Math.max(X,R)*(.08+Math.random()*.22),1,.55)})}function M(X){if(!E||X<=0)return;const R=Math.min(1,X/2.5),ie=Math.round(y.length*R);for(let se=0;se<ie;se++){const w=y[se];E.lineWidth=w.width*(.9+X*.1),E.strokeStyle=w.color,E.globalAlpha=.7+X*.07,E.shadowColor=w.color,E.shadowBlur=5+X*2.4,E.beginPath(),w.pts.forEach(([_,P],L)=>L===0?E.moveTo(_,P):E.lineTo(_,P)),E.stroke()}E.globalAlpha=1,E.shadowBlur=0}function N(X,R,ie){E&&(E.clearRect(0,0,R,ie),M(X))}function U(X=!1){const R=a.current;if(!R)return;const ie=X?"fincine-hit-big":"fincine-hit";R.classList.remove("fincine-hit","fincine-hit-big"),R.offsetWidth,R.classList.add(ie)}function O(){f&&(f.currentTime=0,f.play().catch(()=>{}))}let k=null,Q=null,B=null,D=0,q=!1,I=-1;const de=document.createElement("canvas").getContext("2d");de.font=`700 ${Yr}px "Rajdhani", sans-serif`;const he=[],me=[];function Te(X,R,ie=1){const se=X.toUpperCase(),w=Yr*.05,_=Math.ceil(de.measureText(se).width),P=Math.max(200,_+140+w*2),L=document.createElement("canvas");L.width=P,L.height=Ls;const z=L.getContext("2d");z.font=`700 ${Yr}px "Rajdhani", sans-serif`,z.textAlign="center",z.textBaseline="middle",z.lineJoin="round",z.shadowColor=R,z.shadowBlur=60,z.strokeStyle="#eef6f4",z.lineWidth=w,z.strokeText(se,P/2,Ls/2),z.fillStyle="#eef6f4",z.fillText(se,P/2,Ls/2);const $=new td(L);$.anisotropy=4;let G=P*sl*ie,F=Ls*sl*ie;if(G>rl*ie){const H=rl*ie/G;G*=H,F*=H}return{tex:$,worldW:G,worldH:F}}function Ve(X,R,ie,se){const{tex:w,worldW:_,worldH:P}=Te(X,ie,se),L=new Oi(_,P),z=new On({map:w,transparent:!0,depthWrite:!1,opacity:0}),$=new lt(L,z);$.position.set(0,8,R),$.visible=!1,Q.add($);const G=new lt(L,new On({map:w,transparent:!0,depthWrite:!1,blending:ni,color:2875596,opacity:0})),F=new lt(L,new On({map:w,transparent:!0,depthWrite:!1,blending:ni,color:16723804,opacity:0}));return G.position.copy($.position),F.position.copy($.position),G.visible=!1,F.visible=!1,Q.add(G),Q.add(F),me.push(L,z,w,G.material,F.material),{mesh:$,ghostCy:G,ghostMg:F}}const Ae={camZ:0,camX:0,warpKick:0,yawKick:0,focusZ:-300,fovKick:0,focusY:null,droneRoll:0,droneBob:0,engineOutT:0,impactT:0};let ze,ae,fe=null,W=null,ge=0;function pe(){const X=t.current;if(!X)return;k=new gd({canvas:X,antialias:!0,alpha:!0,preserveDrawingBuffer:!0}),k.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),Q=new Zl,Q.fog=new sr(263946,.0012),B=new Bt(58,window.innerWidth/window.innerHeight,1,6e3),B.position.set(0,0,40),Q.add(new od(928300,1));const R=$a*m.length+600,ie=700,se=new Lt,w=new Float32Array(ie*3),_=new Float32Array(ie*3),P=[2875596,10116351,15357964];for(let G=0;G<ie;G++){const F=60+Math.random()*280,H=Math.random()*Math.PI*2;w[G*3]=Math.cos(H)*F,w[G*3+1]=Math.sin(H)*F,w[G*3+2]=-Math.random()*R;const ne=new $e(P[G%P.length]);_[G*3]=ne.r,_[G*3+1]=ne.g,_[G*3+2]=ne.b}se.setAttribute("position",new Ut(w,3)),se.setAttribute("color",new Ut(_,3));const L=new ar({size:3,vertexColors:!0,transparent:!0,opacity:.8});Q.add(new ho(se,L)),me.push(se,L),m.forEach((G,F)=>{const H=Xi(F),ne="#"+G.light.toString(16).padStart(6,"0");he.push(Ve(G.text,H,ne,G.final?1.35:1));const le=new ei(G.light,2.6,950,2);le.position.set(0,40,H+60),Q.add(le)}),ze=new ei(15357964,3.4,550,2),ae=new ei(10116351,2.2,550,2),Q.add(ze),Q.add(ae),fe=K0(),B.add(fe.group),fe.group.position.set(1.3,-1,-6.5),W=J0(),fe.group.add(W.points),me.push(W.geo,W.mat),Q.add(B),q=!0,xe();const z=Math.random()*1e3;Ae.camZ=-$a*.6;function $(G){if(!k||!Q||!B||!fe||!W)return;const F=ge?Math.min(.05,(G-ge)/1e3):.016;ge=G;const H=.15+Math.min(1,Math.max(0,(I+1)/m.length))*.85,ne=Ae.impactT;ne>0&&(Ae.impactT=Math.max(0,ne-F));const le=Math.sin(G*.0016+z)*(1+H*2.2+ne*6)+Math.sin(G*.0043)*.5*H,oe=Math.cos(G*.002+z)*(.9+H*1.8+ne*5)+Math.cos(G*.0038)*.45*H;B.position.x=le+Ae.camX,B.position.y=oe+6,B.position.z=Ae.camZ+Ae.warpKick;const re=Ae.yawKick,Me=B.position.x+Math.sin(re)*640,be=Ae.focusY??B.position.y-4;B.lookAt(Me,be,Ae.focusZ),B.rotateZ(-re*.55);const De=58+Ae.fovKick*(14+H*10)+ne*24;Math.abs(B.fov-De)>.01&&(B.fov=De,B.updateProjectionMatrix()),ze.position.set(Math.sin(G*6e-4)*80,30,Ae.camZ-120),ae.position.set(Math.cos(G*7e-4)*80,-10,Ae.camZ-200),Ae.droneRoll=Ae.droneRoll*.9+-re*1.4*.1;const V=1.6+H*2.4;Ae.droneBob=Math.sin(G*.001*V)*(.12+H*.35),fe.group.rotation.z=Ae.droneRoll*.6+(ne>0?Math.sin(G*.09)*1.15*ne:0),fe.group.rotation.x=Math.sin(G*.0013)*.06*(1+H)+(ne>0?Math.cos(G*.11)*.75*ne:0);const ve=F*(6+H*10);fe.rotorR.spokes.rotation.z+=ve;let ce=-1+Ae.droneBob;Ae.engineOutT>0?(Ae.engineOutT-=F,ce-=1-Math.max(0,Ae.engineOutT)/.5<1?Math.sin((.5-Ae.engineOutT)*9)*.4:0,fe.rotorL.spokes.rotation.z+=ve*.12,fe.rotorL.rim.material.emissiveIntensity=Math.random()*.6,Math.random()<.5&&W.spawn(-1.45,-.08,.15,2)):(fe.rotorL.spokes.rotation.z+=ve,fe.rotorL.rim.material.emissiveIntensity=1.4+Math.sin(G*.01)*.3),fe.group.position.y=ce,fe.group.position.x=1.3+Math.sin(G*9e-4)*.25*(1+H),fe.group.position.z=-6.5-(ne>0?ne*2.6:0),W.tick(F),he.forEach(_e=>{_e.mesh.visible&&_e.mesh.quaternion.copy(B.quaternion),_e.ghostCy.visible&&_e.ghostCy.quaternion.copy(B.quaternion),_e.ghostMg.visible&&_e.ghostMg.quaternion.copy(B.quaternion)}),k.render(Q,B),D=requestAnimationFrame($)}D=requestAnimationFrame($)}function xe(){!q||!k||!B||(k.setSize(window.innerWidth,window.innerHeight),B.aspect=window.innerWidth/window.innerHeight,B.updateProjectionMatrix())}function ke(){xe(),S(),C(window.innerWidth,window.innerHeight),N(A,window.innerWidth,window.innerHeight)}window.addEventListener("resize",ke,{passive:!0});function Be(X,R=600){const ie=I;I=X;const se=he[X];if(!se)return;se.mesh.visible=!0,se.mesh.material.opacity=0;const w=ie>=0?he[ie]:null,_=performance.now();function P(){const L=Math.min(1,(performance.now()-_)/R);se.mesh.material.opacity=L,w&&(w.mesh.material.opacity=1-L),L<1?requestAnimationFrame(P):w&&(w.mesh.visible=!1)}P()}function Je(X=.5){if(I<0)return;const R=he[I];if(!R)return;const ie=(14+Math.random()*12)*(.7+X*.6),se=Math.min(1,.45+X*.3);R.ghostCy.visible=!0,R.ghostCy.material.opacity=se,R.ghostCy.position.x=-ie,R.ghostMg.visible=!0,R.ghostMg.material.opacity=se,R.ghostMg.position.x=ie,setTimeout(()=>{R.ghostCy.material.opacity=0,R.ghostCy.visible=!1,R.ghostCy.position.x=0,R.ghostMg.material.opacity=0,R.ghostMg.visible=!1,R.ghostMg.position.x=0},(120+Math.random()*90)*(.8+X*.5)),X>.75&&Math.random()<.65&&setTimeout(()=>Je(X*.55),70+Math.random()*70)}async function qe(X,R,ie,se,w){const _=Ae.camZ,P=Ae.camX,L=performance.now();return Ae.warpKick=(Math.random()-.5)*40,Ae.yawKick=w*se,Ae.fovKick=1,new Promise(z=>{function $(G){if(g){z();return}const F=Math.min(1,(G-L)/ie),H=Z0(F);Ae.camZ=_+(X-_)*H,Ae.camX=P+(R-P)*H,Ae.warpKick*=.91,Ae.yawKick*=.972,Ae.fovKick*=.96,F<1?requestAnimationFrame($):z()}requestAnimationFrame($)})}function We(X=1,R=420){if(!q||!E||!t.current)return;const ie=window.innerWidth,se=window.innerHeight,w=performance.now()+R;function _(){if(performance.now()>w){N(A,ie,se);return}E.clearRect(0,0,ie,se),M(A);const L=5+Math.floor(Math.random()*9*X);for(let $=0;$<L;$++){const G=Math.random()*se,F=4+Math.random()*56*X,H=(Math.random()-.5)*150*X;try{E.drawImage(t.current,0,G,ie,F,H,G,ie,F)}catch{}}E.globalCompositeOperation="screen";const z=Math.round(6*X);for(let $=0;$<z;$++){const G=Math.random()*se;E.strokeStyle=["#2be0cc","#ea580c","#9a5cff"][Math.floor(Math.random()*3)],E.globalAlpha=.35+Math.random()*.35,E.lineWidth=.6+Math.random()*1.8,E.beginPath(),E.moveTo(0,G),E.lineTo(ie,G),E.stroke()}if(E.globalCompositeOperation="source-over",E.globalAlpha=1,Math.random()<X*.14){E.globalAlpha=.5;for(let $=0;$<240;$++)E.fillStyle=Math.random()<.5?"#eef6f4":"#04070a",E.fillRect(Math.random()*ie,Math.random()*se,2,2);E.globalAlpha=1}requestAnimationFrame(_)}_()}function ct(X=1,R=340){if(!q||!E)return;const ie=window.innerWidth,se=window.innerHeight,w=ie/2,_=se/2,P=14+Math.floor(14*X),L=Array.from({length:P},()=>Math.random()*Math.PI*2),z=performance.now();function $(){const F=(performance.now()-z)/R;if(F>=1){N(A,ie,se);return}E.save(),E.globalCompositeOperation="screen",L.forEach(H=>{const ne=30+F*340,le=ne+100+Math.random()*170,oe=w+Math.cos(H)*ne,re=_+Math.sin(H)*ne,Me=w+Math.cos(H)*le,be=_+Math.sin(H)*le;E.strokeStyle=Math.random()<.5?"#ea580c":"#eef6f4",E.globalAlpha=(1-F)*(.3+Math.random()*.34)*X,E.lineWidth=1.2+Math.random()*2,E.beginPath(),E.moveTo(oe,re),E.lineTo(Me,be),E.stroke()}),E.restore(),requestAnimationFrame($)}$()}async function dt(X=900){const R=window.innerWidth,ie=window.innerHeight;if(!E)return;const se=performance.now(),w=y.map(()=>Math.random()*.25);await new Promise(_=>{function P(){if(g){_();return}const L=Math.min(1,(performance.now()-se)/X);E.clearRect(0,0,R,ie),y.forEach((z,$)=>{const G=Math.min(1,Math.max(0,(L-w[$])/(1-w[$])));if(G<=0)return;const F=z.pts,H=F.length-1,ne=G*H;E.lineWidth=z.width*(1+L*.45),E.strokeStyle=z.color,E.globalAlpha=.65+L*.32,E.shadowColor=z.color,E.shadowBlur=3+L*6,E.beginPath(),E.moveTo(F[0][0],F[0][1]);for(let re=0;re<Math.floor(ne);re++)E.lineTo(F[re+1][0],F[re+1][1]);const le=Math.floor(ne),oe=ne-le;if(le<H&&oe>0){const[re,Me]=F[le],[be,De]=F[le+1];E.lineTo(re+(be-re)*oe,Me+(De-Me)*oe)}E.stroke()}),E.globalAlpha=1,E.shadowBlur=0,L<1?requestAnimationFrame(P):_()}P()})}async function ft(){Ae.impactT=.55,U(!0),W&&(W.spawn(0,-.05,-2,28),W.spawn(-1.45,-.08,.15,16),W.spawn(1.45,-.08,.15,16)),We(1.6,340),ct(1.4,260),await qi(160)}async function xt(){U(!0);const X=c.current;if(!X)return;X.innerHTML="";const R=window.innerWidth,ie=window.innerHeight,se=12,w=8,_=R/se,P=ie/w,L=R/2,z=ie/2,$=[];for(let G=0;G<w;G++)for(let F=0;F<se;F++){const H=F*_,ne=G*P,le=()=>(Math.random()-.5)*16,oe=document.createElement("div");oe.className="fincine-shard",oe.style.left=H+"px",oe.style.top=ne+"px",oe.style.width=_+2+"px",oe.style.height=P+2+"px",oe.style.clipPath=`polygon(${le()}px ${le()}px, ${_+le()}px ${le()}px, ${_+le()}px ${P+le()}px, ${le()}px ${P+le()}px)`,X.appendChild(oe);const re=H+_/2-L,Me=ne+P/2-z,be=Math.hypot(re,Me)||1;$.push({div:oe,dx:re/be,dy:Me/be,delay:be/Math.max(R,ie)*200+Math.random()*70})}$.forEach(({div:G,dx:F,dy:H,delay:ne})=>{const le=70+Math.random()*160,oe=460+Math.random()*460,re=(Math.random()-.5)*460;G.animate([{transform:"translate(0,0) rotate(0deg) scale(1)",opacity:.96,offset:0},{transform:`translate(${F*le}px, ${H*le-22}px) rotate(${re*.3}deg) scale(.9)`,opacity:.9,offset:.2},{transform:`translate(${F*le*1.4}px, ${H*le+oe}px) rotate(${re}deg) scale(.32)`,opacity:0,offset:1}],{duration:1250,delay:ne,easing:"cubic-bezier(.35,.02,.6,1)",fill:"forwards"})}),await qi(1530),X.innerHTML=""}async function rt(){if(C(window.innerWidth,window.innerHeight),pe(),O(),s.current&&s.current.classList.add("fincine-on"),await qi(900),!g){for(let X=0;X<m.length&&!g;X++){const R=m[X];A=R.crack,r.current&&(r.current.innerHTML=R.final?R.sub:`${R.sub} · рассинхрон канала <b>${R.crack}/4</b>`),Be(X),Ae.focusZ=Xi(X),R.final&&(Ae.focusY=8);const ie=X%2===0?1:-1;if(R.final){const se=Xi(X)+nl+280;if(await qe(se,0,$r[X]??2200,.35,ie),g||(Je(.4+R.crack*.2),We(Math.min(1.5,.45+R.crack*.27),300),N(A,window.innerWidth,window.innerHeight),await qi(700),await qe(Xi(X)-Y0,-150,950,.5,ie),g))return}else{const se=ie*70,w=Xi(X)+nl;if(R.crack>=2&&setTimeout(()=>{g||(Ae.engineOutT=.5)},$r[X]*.4),await qe(w,se,$r[X]??2200,.55+R.crack*.1,ie),g)return}Je(.4+R.crack*.2),We(Math.min(1.5,.45+R.crack*.27),R.final?360:240+R.crack*30),R.final||ct(.8+R.crack*.2,300+R.crack*20),R.crack>=3&&U(!0),N(A,window.innerWidth,window.innerHeight)}g||(await ft(),!g&&(await dt(850),!g&&(await qi(140),await xt(),!g&&v())))}}return rt(),()=>{g=!0,window.removeEventListener("resize",ke),cancelAnimationFrame(D),me.forEach(X=>X.dispose()),fe==null||fe.disposables.forEach(X=>X.dispose()),k==null||k.dispose();try{f==null||f.pause()}catch{}}},[]),o.jsxs("div",{className:"fincine-root",onClick:()=>p.current(),children:[o.jsx("canvas",{ref:t,className:"fincine-gl"}),o.jsx("canvas",{ref:i,className:"fincine-crack"}),o.jsx("div",{ref:c,className:"fincine-shatter-layer"}),o.jsx("div",{className:"fincine-vignette"}),o.jsx("div",{className:"fincine-scanlines"}),o.jsx("div",{ref:a,className:"fincine-noise"}),o.jsxs("div",{ref:s,className:"fincine-label","aria-hidden":!h,children:[o.jsx("div",{className:"fincine-eyebrow",children:"// финальный заход"}),o.jsx("div",{ref:r,className:"fincine-sub"})]}),o.jsx("div",{className:"fincine-skip",children:"нажмите, чтобы пропустить →"}),o.jsx(Qa,{}),o.jsx("audio",{ref:d,src:"/quiz-party/intro.mp3",preload:"auto"})]})}async function ex(n,e){var i;await kt.from("game_sessions").update({melody:{}}).eq("id",ti());const t=Ml(e,n.round_number,"show_answers");if(t.kind==="scoreboard")return void xl();if(t.kind==="break")return void _l();if(t.kind==="finale")return void tr(n.pack_id,((i=e.settings)==null?void 0:i.play_mode)==="paper");await kt.from("game_sessions").update({phase:"round_intro",round_number:n.round_number+1,question_index:0,timer_started_at:null,reveal:!1,melody:{}}).eq("id",ti())}let Ot=null;function tx(){Ot||(Ot=Et(),Ot.play().catch(()=>{}),Ot.pause())}function Ds(n){return Ot||(Ot=Et()),Ot.pause(),Ot.loop=!1,Ot.volume=1,Al(Ot,n),Ot}function nx(){if(Ot)try{Ot.pause(),Ot.currentTime=0}catch{}}async function gt(n){await kt.from("game_sessions").update({melody:n}).eq("id",ti())}const rn=n=>new Date(Date.now()+n*1e3).toISOString();function ix({src:n}){return ee.useEffect(()=>{const e=Et();e.src=n,e.currentTime=0;let t=!1;e.play().then(()=>{if(t)try{e.pause(),e.src=""}catch{}}).catch(()=>{});const i=setTimeout(()=>{try{e.pause()}catch{}},15e3);return()=>{t=!0,clearTimeout(i);try{e.pause(),e.src=""}catch{}}},[n]),o.jsx("div",{className:"mel-reveal-track",children:"♪ играет 15 секунд"})}function sx({pack:n,round:e,gameState:t}){var he,me,Te,Ve,Ae,ze,ae,fe;const i=e.settings,s=i.themes??[],r=t.melody??{},a=fn(t.game_id),c=kn(t.game_id,t.round_number),d=r.played??[],l=ee.useRef(null),[u,p]=ee.useState(Date.now());ee.useEffect(()=>{const W=setInterval(()=>p(Date.now()),200);return()=>clearInterval(W)},[]);const h=r.deadline?new Date(r.deadline).getTime():0,g=h?Math.max(0,Math.ceil((h-u)/1e3)):0,x=ee.useRef(0);ee.useEffect(()=>{x.current=0},[r.stage,r.key]),g>x.current&&(x.current=g);const v=x.current,m=!!h&&u>=h,[f,b]=(r.key??"0-0").split("-").map(Number),E=(he=s[f])==null?void 0:he.tracks[b],y=`q-mel-${r.key}-bid`,A=`q-mel-${r.key}`,S=c.filter(W=>W.question_ref===y);ee.useEffect(()=>{if(r.stage!=="bids")return;const W=S.map(pe=>({id:pe.team_id,sec:Number(pe.answer_text)||99,at:pe.updated_at})).sort((pe,xe)=>pe.sec-xe.sec||+new Date(pe.at)-+new Date(xe.at)).map(pe=>pe.id),ge=[...W,...a.map(pe=>pe.id).filter(pe=>!W.includes(pe))];JSON.stringify(ge)!==JSON.stringify(r.order)&&gt({...r,order:ge,turn:0})},[r.stage,S.map(W=>`${W.team_id}:${W.answer_text}`).join("|")]),ee.useEffect(()=>{if(r.stage!=="snippet")return;const W=r.snippetSec??5,ge=window.setTimeout(()=>{gt({...r,stage:"answering",deadline:rn(i.answerSec??30)})},(W+10)*1e3);return()=>clearTimeout(ge)},[r.stage,r.key,r.snippetSec]),ee.useEffect(()=>{if(r.stage!=="snippet"||!(E!=null&&E.audio)||document.hidden)return;const W=r.snippetSec??5,ge=Ds(Xe(E.audio));l.current=ge;let pe,xe=!1;const ke=()=>{xe||(xe=!0,ge.pause(),gt({...r,stage:"answering",deadline:rn(i.answerSec??30)}))};ge.addEventListener("playing",()=>{gt({...r,deadline:rn(W)}),pe=window.setTimeout(ke,W*1e3)},{once:!0});const Be=window.setTimeout(ke,(W+4)*1e3);return()=>{pe&&clearTimeout(pe),clearTimeout(Be)}},[r.stage,r.key]),ee.useEffect(()=>{var W;if(!(!m||document.hidden))if(r.stage==="spinning")gt({...r,stage:"listen",deadline:rn(2)});else if(r.stage==="bidding"){const ge=S.map(xe=>({id:xe.team_id,sec:Number(xe.answer_text)||99,at:xe.updated_at})).sort((xe,ke)=>xe.sec-ke.sec||+new Date(xe.at)-+new Date(ke.at)).map(xe=>xe.id),pe=[...ge,...a.map(xe=>xe.id).filter(xe=>!ge.includes(xe))];gt({...r,stage:"bids",order:pe,turn:0,deadline:void 0})}else(r.stage==="answering"||r.stage==="passed")&&(c.some(pe=>{var xe,ke;return pe.question_ref===`q-mel-${r.key}`&&pe.team_id===((xe=r.order)==null?void 0:xe[r.turn??0])&&!!((ke=pe.answer_text)!=null&&ke.trim())})?gt({...r,deadline:void 0}):(nx(),(r.turn??0)===0&&(((W=r.order)==null?void 0:W.length)??0)>1?gt({...r,stage:"passed",turn:1,deadline:void 0}):gt({...r,stage:"done",deadline:void 0,played:[...d,r.key]})))},[m,r.stage,c]),ee.useEffect(()=>{if(r.stage!=="listen"||!(E!=null&&E.audio)||document.hidden)return;const W=Ds(Xe(E.audio));l.current=W;let ge,pe=!1;const xe=()=>{pe||(pe=!0,W.pause(),gt({...r,stage:"bidding",deadline:rn(i.bidSec??10)}))};W.addEventListener("playing",()=>{ge=window.setTimeout(xe,1e3)},{once:!0});const ke=window.setTimeout(xe,4e3);return()=>{ge&&clearTimeout(ge),clearTimeout(ke)}},[r.stage,r.key]),ee.useEffect(()=>{var pe;const W=e.settings.bg_music??((pe=n.settings)==null?void 0:pe.bg_music);if(r.stage!=="answering"&&r.stage!=="bidding"||!W||document.hidden)return;const ge=Ds(Xe(W));return ge.loop=!0,ge.volume=.45,()=>{ge.pause(),ge.loop=!1,ge.volume=1}},[r.stage]),ee.useEffect(()=>{if(r.stage!=="passed"||r.deadline||!(E!=null&&E.audio)||document.hidden)return;const W=Ds(Xe(E.audio));return l.current=W,W.onended=()=>void gt({...r,deadline:rn(i.passAnswerSec??10)}),()=>{W.pause(),W.onended=null}},[r.stage]);const[C,M]=ee.useState(!1);if(s.length===0)return o.jsxs("div",{className:"host-screen grid-bg",children:[o.jsx("div",{className:"mono-tag",children:"УГАДАЙ МЕЛОДИЮ"}),o.jsx("p",{children:"Темы не заполнены — добавь их в редакторе раунда"})]});const U=s.flatMap((W,ge)=>W.tracks.map((pe,xe)=>`${ge}-${xe}`)).filter(W=>!d.includes(W)),O=!r.stage||r.stage==="idle"||r.stage==="done",k=W=>{M(!1),gt({...r,key:W,stage:"listen",deadline:rn(3),order:void 0,turn:0,chooser:void 0})},Q=()=>{const W=U[Math.floor(Math.random()*U.length)];if(U.length===1){gt({...r,key:W,stage:"listen",deadline:rn(3),order:void 0,turn:0,chooser:void 0});return}gt({...r,key:W,stage:"spinning",deadline:rn(Math.min(i.spinSec??5,8)),order:void 0,turn:0,chooser:void 0})},B=(me=r.order)==null?void 0:me[r.turn??0],D=a.find(W=>W.id===B),q=Number((Te=S.find(W=>W.team_id===B))==null?void 0:Te.answer_text)||0,I=c.find(W=>W.question_ref===A&&W.team_id===B),Y=async W=>{if(!I)return;const pe=(r.turn??0)===0?q<=5?2:1:.5;await kt.from("answers").update({is_correct:W,stake:pe}).eq("id",I.id),await gt({...r,stage:"reveal",deadline:void 0,played:[...d,r.key],wonPts:pe,wonTeam:B,chooser:void 0})},de=async()=>{var W;(r.turn??0)===0&&(((W=r.order)==null?void 0:W.length)??0)>1?await gt({...r,stage:"passed",turn:1,deadline:void 0}):await gt({...r,stage:"done",deadline:void 0,played:[...d,r.key]})};return o.jsxs("div",{className:"host-screen grid-bg mel-screen",onPointerDown:tx,children:[o.jsx(rx,{themes:s,played:d,spinning:r.stage==="spinning",spinKey:r.key,spinLeft:g,spinTotal:i.spinSec??10,onPick:C?k:void 0}),O&&o.jsx("div",{className:"host-actions",children:U.length>0?C?o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"mono-tag",children:"ВЫБЕРИТЕ ПЛИТКУ НА ЭКРАНЕ"}),o.jsx("button",{className:"ghost",onClick:()=>M(!1),children:"Отмена"})]}):o.jsxs(o.Fragment,{children:[o.jsx("button",{onClick:Q,children:d.length===0?"Стартуем!":"Рулетка"}),o.jsx("button",{className:"ghost",onClick:()=>M(!0),children:"Выбрать вручную"})]}):o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"mono-tag",children:"ВСЕ ТРЕКИ ОТЫГРАНЫ"}),o.jsx("button",{onClick:()=>void ex(t,n),children:"Завершить раунд →"})]})}),r.stage&&!O&&r.stage!=="spinning"&&ml.createPortal(o.jsx("div",{className:`mel-overlay theme-${n.theme??"classic"}`,children:o.jsxs("div",{className:"mel-modal",children:[o.jsxs("div",{className:"mel-modal-head",children:[o.jsxs("div",{className:"mel-modal-theme",children:[(Ve=s[f])==null?void 0:Ve.name," · трек ",b+1]}),!!h&&o.jsx("div",{className:"mel-count",children:n.theme==="potter"?o.jsx(Cl,{left:g,seconds:v,low:g<=5}):g})]}),r.stage==="listen"&&o.jsx("div",{className:"mel-big",children:"СЛУШАЕМ 1 СЕКУНДУ…"}),r.stage==="bidding"&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"mel-big",children:"ЗА СКОЛЬКО СЕКУНД УГАДАЕТЕ?"}),o.jsx("div",{className:"mel-points-hint",children:"2–5 сек → 2 балла · 6–10 сек → 1 балл · передача хода → 0.5 балла"}),o.jsx("div",{className:"mel-bids",children:[...a].sort((W,ge)=>W.name.localeCompare(ge.name)).map(W=>{const ge=S.find(pe=>pe.team_id===W.id);return o.jsxs("div",{className:`mel-bid-row${ge?" win":""}`,children:[o.jsx("span",{style:{color:W.color},children:W.name}),o.jsx("b",{children:ge?"ставка принята ✓":"…"}),o.jsx("span",{})]},W.id)})})]}),r.stage==="bids"&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"mono-tag",children:"СТАВКИ КОМАНД"}),o.jsxs("div",{className:"mel-bids",children:[(r.order??[]).map((W,ge)=>{const pe=a.find(ke=>ke.id===W),xe=S.find(ke=>ke.team_id===W);return o.jsxs("div",{className:`mel-bid-row${ge===0?" win":""}`,children:[o.jsx("span",{style:{color:pe==null?void 0:pe.color},children:pe==null?void 0:pe.name}),o.jsxs("b",{children:[xe==null?void 0:xe.answer_text," сек"]}),ge===0?o.jsx("span",{className:"mel-win-tag",children:"ИГРАЕТ"}):o.jsx("span",{})]},W)}),(r.order??[]).length===0&&o.jsx("div",{style:{opacity:.6},children:"ставок нет"})]}),o.jsxs("div",{className:"mel-actions",children:[o.jsxs("button",{disabled:!B,onClick:()=>void gt({...r,stage:"snippet",snippetSec:q||5,deadline:void 0}),children:["Играем ",q||5," сек →"]}),o.jsx("button",{className:"ghost dark",onClick:()=>void gt({...r,stage:"done",deadline:void 0,played:[...d,r.key]}),children:"Пропустить трек"})]})]}),r.stage==="snippet"&&o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"mel-big",style:{color:D==null?void 0:D.color},children:[D==null?void 0:D.name," · играет ",q," сек"]}),o.jsx("div",{className:"mel-actions",children:o.jsx("button",{onClick:()=>void gt({...r,stage:"answering",deadline:rn(i.answerSec??30)}),children:"Принимаем ответ →"})})]}),r.stage==="reveal"&&o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"answer-reveal",style:{padding:"18px 28px"},children:[o.jsxs("div",{className:"answer-label",children:["ВЕРНО ✓ · +",r.wonPts??0]}),o.jsx("div",{className:"answer-main",children:E==null?void 0:E.correct})]}),(E==null?void 0:E.audio)&&o.jsx(ix,{src:Xe(E.audio)}),o.jsxs("div",{className:"mel-big",style:{color:(Ae=a.find(W=>W.id===r.wonTeam))==null?void 0:Ae.color},children:[(ze=a.find(W=>W.id===r.wonTeam))==null?void 0:ze.name," забирает баллы"]}),o.jsx("div",{className:"mel-actions",children:o.jsx("button",{onClick:()=>void gt({...r,stage:"done"}),children:"К доске →"})})]}),r.stage!=="reveal"&&r.stage!=="done"&&o.jsx("button",{className:"mel-escape",onClick:async()=>{confirm(`Закрыть трек и вернуться к доске?

Баллы за него никто не получит.`)&&await gt({...r,stage:"done",deadline:void 0,played:[...d,r.key]})},children:"Закрыть"}),(r.stage==="answering"||r.stage==="passed")&&o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"mel-big",style:{color:D==null?void 0:D.color},children:[r.stage==="passed"?"ХОД ПЕРЕДАН · ":"",(D==null?void 0:D.name)??"—"]}),o.jsx("div",{className:"mel-points-hint",children:r.stage==="passed"?"за верный ответ — 0.5 балла":`ставка ${q} сек → за верный ответ ${q<=5?2:1} балла`}),o.jsx("div",{className:"mel-answer",children:I!=null&&I.answer_text?o.jsxs(o.Fragment,{children:["Ответ: ",o.jsx("b",{children:I.answer_text})]}):o.jsx("span",{style:{opacity:.6},children:"ждём ответ…"})}),(I==null?void 0:I.is_correct)===!0&&o.jsxs("div",{className:"answer-reveal hud-frame",children:[o.jsx("div",{className:"answer-label",children:"ВЕРНО ✓"}),o.jsx("div",{className:"answer-main",children:E==null?void 0:E.correct})]}),(I==null?void 0:I.is_correct)===!1&&o.jsxs("div",{className:"mel-wrong",children:["✗ НЕВЕРНО · ответ не раскрываем",(r.turn??0)===0&&(((ae=r.order)==null?void 0:ae.length)??0)>1?" — передайте ход второй команде":" — трек закрывается"]}),o.jsxs("div",{className:"mel-actions",children:[o.jsx("button",{disabled:!I,onClick:()=>void Y(!0),children:"✓ Верно"}),o.jsx("button",{className:"ghost",onClick:async()=>{I&&I.is_correct==null&&await kt.from("answers").update({is_correct:!1,stake:0}).eq("id",I.id),await de()},children:(r.turn??0)===0&&(((fe=r.order)==null?void 0:fe.length)??0)>1?"✗ Передать ход →":"✗ Закрыть трек"})]})]})]})}),document.body)]})}function rx({themes:n,played:e,spinning:t,spinKey:i,spinLeft:s,spinTotal:r,onPick:a}){const d=n.flatMap((g,x)=>g.tracks.map((v,m)=>`${x}-${m}`)).filter(g=>!e.includes(g)),[l,u]=ee.useState(0),p=ee.useRef(s);p.current=s,ee.useEffect(()=>{if(!t||d.length===0||s<=0)return;let g=!1,x;const v=()=>{if(g)return;u(f=>{let b=Math.floor(Math.random()*d.length);return d.length>1&&b===f&&(b=(b+1)%d.length),b});const m=1-Math.max(0,p.current)/Math.max(1,r);x=window.setTimeout(v,180+m*m*720)};return x=window.setTimeout(v,180),()=>{g=!0,x&&clearTimeout(x)}},[t]);const h=t?s<=1?i:d[l%Math.max(1,d.length)]:void 0;return o.jsxs("div",{className:"mel-board",style:{gridTemplateColumns:`repeat(${n.length}, minmax(0,1fr))`,gridTemplateRows:`auto repeat(${Math.max(...n.map(g=>g.tracks.length),1)}, minmax(0, 1fr))`},children:[n.map((g,x)=>o.jsx("div",{className:"mel-theme",children:g.name||`Тема ${x+1}`},`h${x}`)),n.map((g,x)=>g.tracks.map((v,m)=>{const f=`${x}-${m}`,b=e.includes(f),E=h===f;return o.jsx("div",{className:`mel-tile${b?" done":""}${E?" spin":""}${a&&!b?" pickable":""}`,onClick:a&&!b?()=>a(f):void 0,"data-c":String(x%4),style:{gridColumn:x+1,gridRow:m+2},children:o.jsx("span",{className:"mel-face",children:b?"":m+1})},f)}))]})}const al=[{body:"#f2e3c9",mask:"#b99a7d",name:"кремовый"},{body:"#8a5a33",mask:"#4c2f17",name:"тигровый"},{body:"#3b3b40",mask:"#232326",name:"чёрный"},{body:"#e8e2d8",mask:"#c96f3b",name:"бело-рыжий"},{body:"#9aa7b5",mask:"#6c7886",name:"голубой"}];function ax(n){let e=n>>>0;return()=>{e|=0,e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296}}function ox(n,e){const t=ax(n),i=8,s=Array.from({length:5},()=>{const v=Array.from({length:i},()=>.45+t()*.9),m=v.reduce((f,b)=>f+b,0);return{speeds:v,total:m}}),r=Math.max(...s.map(v=>v.total)),a=s.map(v=>e*.92*(r/v.total)),c=(v,m)=>{const f=a[v],E=Math.min(1,Math.max(0,m/f))*i,y=Math.floor(E),A=E-y;let S=0;for(let C=0;C<y;C++)S+=s[v].speeds[C];return S+=(s[v].speeds[Math.min(y,i-1)]??0)*A,Math.min(1,S/s[v].total)},d=["🦋","💤","🐦","🍂"],l=Array.from({length:5},()=>{const v=[];return t()<.6&&v.push({at:(.25+t()*.3)*e,dur:.6+t()*.9,icon:d[Math.floor(t()*d.length)]}),t()<.25&&v.push({at:(.62+t()*.22)*e,dur:.5+t()*.7,icon:d[Math.floor(t()*d.length)]}),v}),u=(v,m)=>l[v].find(f=>m>=f.at&&m<f.at+f.dur),p=(v,m)=>{let f=0;for(const b of l[v])f+=Math.min(Math.max(0,m-b.at),b.dur);return m-f},h=(v,m)=>c(v,p(v,m)),g=a.map((v,m)=>v+l[m].reduce((f,b)=>f+b.dur,0)),x=g.map((v,m)=>({i:m,f:v})).sort((v,m)=>v.f-m.f).map(v=>v.i);return{progress:h,finish:g,places:x,pausedAt:u}}function cx({pack:n,round:e,gameState:t}){var y;const i=e.settings,s=(i.dogs??[]).length===5?i.dogs:["Френк","Батон","Пельмень","Турбо","Ракета"],r=i.raceSec??18,a=((y=t.melody)==null?void 0:y.race)??{},c=fn(t.game_id),l=kn(t.game_id,t.round_number).filter(A=>A.question_ref===`q-race-${t.round_number}`),u=ee.useRef(!1);ee.useEffect(()=>{var C;const A=e.settings.race_music??((C=n.settings)==null?void 0:C.bg_music);if(a.stage!=="running"||!A||document.hidden)return;const S=Et();return S.src=Xe(A),S.loop=!0,S.volume=.55,S.play().catch(()=>{}),()=>S.pause()},[a.stage]);const[p,h]=ee.useState(Date.now());ee.useEffect(()=>{const A=setInterval(()=>h(Date.now()),66);return()=>clearInterval(A)},[]);const g=ee.useMemo(()=>a.seed!=null?ox(a.seed,r):null,[a.seed,r]),x=a.startedAt?(p-new Date(a.startedAt).getTime())/1e3:0,v=a.stage==="running"&&g,m=a.stage==="done",f=g&&x>=Math.max(...g.finish)+1;ee.useEffect(()=>{if(!v||!f||u.current||document.hidden)return;u.current=!0;const A=new Map(g.places.map((S,C)=>[S,C]));(async()=>{for(const S of l){const C=Number(S.answer_text)-1,M=A.get(C),N=M!=null?5-M:0;await kt.from("answers").update({is_correct:!0,stake:N}).eq("id",S.id)}await kt.from("game_sessions").update({melody:{...t.melody,race:{...a,stage:"done"}}}).eq("id",ti())})()},[v,f]),ee.useEffect(()=>{!a.stage&&!document.hidden&&E()},[a.stage]);const b=()=>Jd(t),E=()=>Kd(t);return o.jsxs("div",{className:"host-screen grid-bg race-screen",children:[o.jsx("div",{className:"host-topbar",children:o.jsx("span",{className:"qnum",children:e.title_lines.join(" ")||"СКАЧКИ БУЛЬДОГОВ"})}),(a.stage==="running"||m)&&o.jsxs("div",{className:"race-track hud-frame",children:[o.jsx("div",{className:"race-stands",children:Array.from({length:26},(A,S)=>o.jsx("span",{style:{animationDelay:`${S%5*.3}s`},children:["🎉","👏","🙌","⭐","🎊"][S%5]},S))}),o.jsx("div",{className:"race-finish"}),s.map((A,S)=>{const C=(v||m)&&g?g.progress(S,m?999:x):0,M=g&&(m||f)?g.places.indexOf(S):null,N=v&&!m?g==null?void 0:g.pausedAt(S,x):void 0,U=!!g&&x>=g.finish[S];return o.jsxs("div",{className:"race-lane",children:[o.jsx("span",{className:"race-num",children:S+1}),o.jsxs("div",{className:"race-dog",style:{left:`calc(${6+C*82}% )`},children:[N&&o.jsx("span",{className:"race-pause",children:N.icon}),o.jsx(dx,{color:al[S],running:!!v&&!f&&!N&&!U}),o.jsxs("span",{className:"race-name",children:[A,M!=null&&` · ${M+1} место`]})]}),o.jsx("span",{className:"race-treat",children:"🍖"})]},S)})]}),(!a.stage||a.stage==="betting")&&o.jsxs("div",{className:"race-panel",children:[o.jsx("div",{className:"mono-tag",children:"ВЫБЕРИТЕ СВОЕГО БУЛЬДОГА · СТАВКИ ТАЙНЫЕ"}),o.jsx("div",{className:"race-lineup",children:s.map((A,S)=>o.jsxs("div",{className:"race-candidate",children:[o.jsx(lx,{color:al[S],n:S+1}),o.jsxs("span",{className:"race-tag",children:[o.jsxs("b",{children:["№",S+1]})," ",A]})]},S))}),o.jsxs("div",{className:"mono-tag",style:{color:l.length===c.length&&c.length>0?"var(--answer)":void 0},children:["СТАВКИ СДЕЛАЛИ: ",l.length," / ",c.length]}),o.jsx("div",{className:"host-actions",children:o.jsx("button",{disabled:l.length===0,onClick:()=>void b(),children:"🏁 Старт! (ставки закрываются)"})})]}),m&&g&&o.jsxs("div",{className:"race-result",children:[o.jsx("div",{className:"host-actions",children:o.jsx(ai,{pack:n,gameState:t})}),o.jsxs("div",{className:"answer-reveal",style:{padding:"14px 30px"},children:[o.jsx("div",{className:"answer-label",children:"ПОБЕДИТЕЛЬ"}),o.jsxs("div",{className:"answer-main",children:["№",g.places[0]+1," ",s[g.places[0]]]})]}),o.jsx("div",{className:"mono-tag",children:g.places.map((A,S)=>`${S+1}. ${s[A]}`).join("  ·  ")})]})]})}function lx({color:n,n:e}){const t=n.body;return o.jsxs("svg",{viewBox:"0 0 150 144",className:"bulldog-sit",children:[o.jsx("path",{d:"M75,60 C112,60 122,86 118,112 C116,128 34,128 32,112 C28,86 38,60 75,60 Z",fill:t}),o.jsx("ellipse",{cx:"34",cy:"112",rx:"17",ry:"13",fill:t}),o.jsx("ellipse",{cx:"116",cy:"112",rx:"17",ry:"13",fill:t}),o.jsx("path",{d:"M75,72 C89,72 93,96 91,118 C90,123 60,123 59,118 C57,96 61,72 75,72 Z",fill:"#fff",opacity:".88"}),o.jsx("rect",{x:"54",y:"94",width:"13",height:"34",rx:"6.5",fill:t}),o.jsx("rect",{x:"83",y:"94",width:"13",height:"34",rx:"6.5",fill:t}),o.jsx("ellipse",{cx:"60.5",cy:"129",rx:"9",ry:"5.5",fill:"#fff"}),o.jsx("ellipse",{cx:"89.5",cy:"129",rx:"9",ry:"5.5",fill:"#fff"}),o.jsx("circle",{cx:"75",cy:"42",r:"34",fill:t}),o.jsx("path",{d:"M43,26 C29,11 33,-4 47,-2 C58,0 63,13 61,28 C56,34 47,34 43,26 Z",fill:t}),o.jsx("path",{d:"M107,26 C121,11 117,-4 103,-2 C92,0 87,13 89,28 C94,34 103,34 107,26 Z",fill:t}),o.jsx("path",{d:"M47,23 C38,12 41,1 49,2 C56,3 58,15 56,24 Z",fill:"#f1b8c8"}),o.jsx("path",{d:"M103,23 C112,12 109,1 101,2 C94,3 92,15 94,24 Z",fill:"#f1b8c8"}),o.jsx("ellipse",{cx:"59",cy:"40",rx:"6.6",ry:"7.6",fill:"#241d22"}),o.jsx("ellipse",{cx:"91",cy:"40",rx:"6.6",ry:"7.6",fill:"#241d22"}),o.jsx("circle",{cx:"61.4",cy:"37.2",r:"2.6",fill:"#fff"}),o.jsx("circle",{cx:"93.4",cy:"37.2",r:"2.6",fill:"#fff"}),o.jsx("path",{d:"M53,52 C53,45 97,45 97,52 C97,66 87,73 75,73 C63,73 53,66 53,52 Z",fill:"#fff",opacity:".92"}),o.jsx("ellipse",{cx:"75",cy:"53",rx:"7.4",ry:"5.2",fill:"#3a2e33"}),o.jsx("path",{d:"M75,57 v6.5",stroke:"#3a2e33",strokeWidth:"2",strokeLinecap:"round"}),o.jsx("path",{d:"M65,64 Q70,69.5 75,65 Q80,69.5 85,64",fill:"none",stroke:"#3a2e33",strokeWidth:"2",strokeLinecap:"round"}),o.jsx("path",{d:"M51,71 C60,79 90,79 99,71 L99,78 C90,85 60,85 51,78 Z",fill:"#e63946"}),o.jsx("circle",{cx:"75",cy:"83",r:"10.5",fill:"#f5c542",stroke:"#c99a1e",strokeWidth:"2"}),o.jsx("text",{x:"75",y:"88.5",textAnchor:"middle",fontSize:"14.5",fontWeight:"700",fill:"#5a4210",children:e})]})}function dx({color:n,running:e}){const t=n.body,i=n.mask;return o.jsxs("svg",{viewBox:"0 0 160 112",className:`bulldog${e?" run":""}`,children:[o.jsxs("g",{className:"bd-dust",children:[o.jsx("circle",{cx:"26",cy:"92",r:"3.4",fill:"#cfd8e3"}),o.jsx("circle",{cx:"18",cy:"86",r:"2.2",fill:"#cfd8e3"}),o.jsx("circle",{cx:"33",cy:"96",r:"1.9",fill:"#cfd8e3"})]}),o.jsxs("g",{className:"bd-speed",stroke:"#9fc3e8",strokeWidth:"2.2",strokeLinecap:"round",opacity:".5",children:[o.jsx("line",{x1:"6",y1:"46",x2:"26",y2:"46"}),o.jsx("line",{x1:"10",y1:"60",x2:"28",y2:"60"})]}),o.jsxs("g",{className:"bd-all",children:[o.jsx("path",{className:"bd-hind h2",d:"M64,74 Q60,84 63,92 Q64,96 71,96 L71,92 Q67,90 68,82 Q70,76 71,74 Z",fill:t}),o.jsx("path",{className:"bd-fore f2",d:"M101,72 Q106,82 104,90 Q105,94 112,94 L112,90 Q108,88 108,81 Q108,74 107,70 Z",fill:t}),o.jsx("path",{d:"M40,60 C36,42 54,34 74,34 C96,34 108,44 110,56 C112,70 100,81 80,82 C58,83 42,76 40,60 Z",fill:t}),o.jsx("path",{d:"M56,74 C66,80 88,80 100,72 C96,80 66,84 56,74 Z",fill:"#fff",opacity:".85"}),o.jsx("circle",{cx:"38",cy:"52",r:"4.5",fill:t,stroke:i,strokeWidth:"1"}),o.jsx("path",{className:"bd-hind h1",d:"M50,70 Q44,80 48,89 Q49,94 57,94 L57,89 Q52,88 53,80 Q56,73 58,70 Z",fill:t}),o.jsx("path",{className:"bd-fore f1",d:"M90,72 Q94,82 91,90 Q92,95 100,95 L100,90 Q96,88 97,80 Q99,74 98,71 Z",fill:t}),o.jsxs("g",{className:"bd-head",children:[o.jsx("circle",{cx:"118",cy:"44",r:"30",fill:t}),o.jsx("path",{d:"M88,32 C74,14 78,-2 92,-1 C103,0 108,14 106,30 C100,36 92,37 88,32 Z",fill:t}),o.jsx("path",{d:"M148,32 C162,14 158,-2 144,-1 C133,0 128,14 130,30 C136,36 144,37 148,32 Z",fill:t}),o.jsx("path",{d:"M92,28 C83,15 86,3 94,4 C101,5 103,17 101,27 Z",fill:"#f1b8c8"}),o.jsx("path",{d:"M144,28 C153,15 150,3 142,4 C135,5 133,17 135,27 Z",fill:"#f1b8c8"}),o.jsx("ellipse",{cx:"105",cy:"42",rx:"6",ry:"7",fill:"#241d22"}),o.jsx("ellipse",{cx:"131",cy:"42",rx:"6",ry:"7",fill:"#241d22"}),o.jsx("circle",{cx:"107",cy:"39.5",r:"2.4",fill:"#fff"}),o.jsx("circle",{cx:"133",cy:"39.5",r:"2.4",fill:"#fff"}),o.jsx("path",{d:"M100,52 C100,45 136,45 136,52 C136,64 128,71 118,71 C108,71 100,64 100,52 Z",fill:"#fff",opacity:".92"}),o.jsx("ellipse",{cx:"118",cy:"53",rx:"6.4",ry:"4.6",fill:"#3a2e33"}),o.jsx("path",{d:"M118,56.5 v6",stroke:"#3a2e33",strokeWidth:"1.8",strokeLinecap:"round"}),o.jsx("path",{d:"M110,62 Q114,67 118,63 Q122,67 126,62",fill:"none",stroke:"#3a2e33",strokeWidth:"1.9",strokeLinecap:"round"}),o.jsx("path",{className:"bd-tongue",d:"M112,65 Q118,76 124,65 Q122,71 118,71.5 Q114,71 112,65 Z",fill:"#ff8da1"})]})]})]})}function t_(){var c;const{gameState:n,loading:e,roomId:t}=Pd(),[i,s]=ee.useState(null);if(ee.useEffect(()=>{n!=null&&n.pack_id?eu(n.pack_id).then(s).catch(()=>{}):s(null)},[n==null?void 0:n.pack_id]),!e&&!t)return o.jsx(Ld,{route:"/"});const r=(i==null?void 0:i.theme)??"classic",a=n?n.phase==="finale"||n.phase==="recap"?`${n.phase}-${n.round_number}`:`${n.phase}-${n.round_number}-${n.question_index}`:"";return o.jsxs(nu,{theme:r,isProjector:!0,children:[r==="new_year"&&o.jsx(iu,{trigger:`${n==null?void 0:n.phase}-${n==null?void 0:n.round_number}-${n==null?void 0:n.question_index}`}),o.jsx(ux,{gameState:n,pack:i}),o.jsx(fu,{theme:r,trigger:a}),i&&o.jsx("div",{className:`pack-badge${(n==null?void 0:n.phase)==="lobby"&&((c=i.settings)==null?void 0:c.play_mode)!=="paper"?" pack-badge-lobby":""}`,children:i.name})]})}function Ks({theme:n}){return n==="new_year"?o.jsx("div",{className:"title-deco",children:"🎄 ❄ 🎁 ❄ 🎄"}):n==="potter"?o.jsx("div",{className:"title-deco",children:"⚡ ✦ 🪄 ✦ ⚡"}):null}function ol({theme:n}){return n!=="classic"?null:o.jsxs("div",{className:"cyber-deco","aria-hidden":"true",children:[o.jsx("span",{className:"cd-line"}),o.jsx("span",{className:"cd-chip",children:"◆"}),o.jsx("span",{className:"cd-line"})]})}function ux({gameState:n,pack:e}){var m,f,b,E;const[t,i]=ee.useState([]),[s,r]=ee.useState("");ee.useEffect(()=>{tu().then(i).catch(()=>i([]))},[]);const a=fn((n==null?void 0:n.game_id)??null),c=ee.useMemo(()=>{const y=`${location.origin}${location.pathname}#/player?room=${ti()??""}`;return n!=null&&n.pack_id?`${y}&pack=${n.pack_id}`:y},[n==null?void 0:n.pack_id]),d=((n==null?void 0:n.random_groups)??[]).filter(y=>Array.isArray(y)&&y.length>0),l=d.map(y=>y.join(",")).join("|"),[u,p]=ee.useState(!0);ee.useEffect(()=>{p(!0)},[l]);const h=d.length>0&&u;if(Rx((m=e==null?void 0:e.rounds)==null?void 0:m[(n==null?void 0:n.round_number)??0],(n==null?void 0:n.question_index)??0),!n)return o.jsx("div",{className:"host-screen grid-bg",children:"Загрузка…"});const g=((f=e==null?void 0:e.settings)==null?void 0:f.play_mode)==="paper";if(n.phase==="lobby"||!n.pack_id||!e)return o.jsxs("div",{className:`host-screen grid-bg${g?" paper-lobby":""}`,children:[n.phase==="lobby"&&!!n.pack_id&&e&&o.jsx(Ax,{pack:e}),((e==null?void 0:e.theme)??"classic")==="classic"?o.jsxs("div",{className:"cyber-lobby-head",children:[o.jsx(fl,{side:"left"}),o.jsxs("div",{className:"clh-title",children:[o.jsx(Sn,{theme:"classic",lines:["QUIZ","PARTY"]}),o.jsx(ol,{theme:"classic"})]}),o.jsx(fl,{side:"right"})]}):o.jsxs(o.Fragment,{children:[o.jsx(Sn,{theme:(e==null?void 0:e.theme)??"classic",lines:["QUIZ PARTY"]}),o.jsx(Ks,{theme:(e==null?void 0:e.theme)??"classic"})]}),n.pack_id?o.jsxs(o.Fragment,{children:[h&&o.jsx(Ex,{groups:d,onClose:()=>p(!1)}),d.length>0&&!u&&o.jsx("button",{className:"ghost dark lobby-groups-btn",onClick:()=>p(!0),children:"СОСТАВЫ КОМАНД"}),o.jsxs("div",{className:"lobby-teams",children:[a.length>0&&o.jsxs("div",{className:"mono-tag",children:["ПОДКЛЮЧИЛИСЬ (",a.length,")"]}),a.length===0?g?null:o.jsx("span",{style:{opacity:.5},children:"ждём команды…"}):a.map(y=>o.jsxs("span",{className:"lobby-team team-chip-fx",style:{"--tc":y.color,opacity:Qd(y)?1:.4},children:[y.icon&&o.jsx("span",{className:"lobby-team-icon",children:y.icon}),y.name]},y.id))]}),!g&&o.jsx("img",{alt:"QR",className:`lobby-qr-corner${h?" lobby-qr-lit":""}`,src:`https://api.qrserver.com/v1/create-qr-code/?size=240x240&margin=1&data=${encodeURIComponent(c)}`}),!g&&h&&o.jsx("div",{className:"lobby-qr-hint",children:"СКАНИРУЙ, ЧТОБЫ ИГРАТЬ"}),o.jsxs("div",{className:"host-actions",children:[o.jsx("button",{className:"ghost dark",onClick:()=>{confirm("Сбросить игру и выбрать другой пакет?")&&Kr()},children:"⟲ Сменить пакет"}),o.jsx("button",{onClick:()=>{var y,A;return void((y=e==null?void 0:e.settings)!=null&&y.show_intro?Id():Zr(0,Jr((A=e==null?void 0:e.settings)==null?void 0:A.info_slides,0)??void 0))},children:"К первому раунду →"})]})]}):o.jsxs("div",{style:{display:"flex",gap:12,alignItems:"center"},children:[o.jsxs("select",{value:s,onChange:y=>r(y.target.value),style:{fontSize:"1.2rem"},children:[o.jsx("option",{value:"",children:"— выбрать пакет —"}),t.map(y=>o.jsxs("option",{value:y.id,children:[y.name," (",y.status==="ready"?"готов":y.status==="played"?"сыгран":y.status,")"]},y.id))]}),o.jsx("button",{disabled:!s,style:{fontSize:"1.2rem"},onClick:()=>{const y=t.find(A=>A.id===s);y&&y.status==="draft"&&!confirm("Пакет — черновик (валидатор не пройден). Играть как есть?")||Dd(s)},children:"Начать игру"})]})]});if(n.phase==="intro")return o.jsx(q0,{onDone:()=>{var y;Zr(0,Jr((y=e==null?void 0:e.settings)==null?void 0:y.info_slides,0)??void 0)}});const x=e.rounds[n.round_number];if(!x)return o.jsx("div",{className:"host-screen grid-bg",children:"Раунд не найден — проверь пакет"});const v=x.questions[n.question_index];if(n.phase==="round_intro"){const y=x.settings.grid;return o.jsxs("div",{className:"host-screen grid-bg round-intro",children:[x.rules_audio&&o.jsx("audio",{autoPlay:!0,src:Xe(x.rules_audio)}),x.mechanic==="crossword"&&y?o.jsxs("div",{className:"cw-layout",children:[o.jsx(su,{grid:y,cellSize:Math.max(18,Math.min(44,Math.floor(Math.min(innerWidth*.48/y.cols,innerHeight*.8/y.rows))))}),o.jsxs("div",{className:"side",children:[o.jsxs("div",{className:"mono-tag",children:["РАУНД ",Qn(e,n.round_number)]}),o.jsx(Sn,{theme:e.theme,lines:x.title_lines}),o.jsx("div",{className:"meta-line",style:{alignSelf:"flex-start"},children:Oo(x)}),x.rules.map((A,S)=>o.jsxs("div",{className:"rule-item",style:{animationDelay:`${.5+S*.5}s`},children:[o.jsx("span",{className:"idx",children:String(S+1).padStart(2,"0")}),A]},S))]})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"round-badge",children:[o.jsx("span",{className:"rb-word",children:"РАУНД"}),o.jsx("span",{className:"rb-num",children:Qn(e,n.round_number)})]}),o.jsxs("div",{className:"ri-main",children:[o.jsx(Sn,{theme:e.theme,lines:x.title_lines}),o.jsx(Ks,{theme:e.theme}),o.jsx(ol,{theme:e.theme}),o.jsx("div",{className:"meta-line",children:Oo(x)})]}),x.rules.length>0&&o.jsxs("div",{className:"rules-frame","data-count":x.rules.length,children:[o.jsx("div",{className:"rules-frame-label",children:"ПРАВИЛА"}),x.rules.map((A,S)=>o.jsxs("div",{className:"rule-item",style:{animationDelay:`${.5+S*.7}s`},children:[o.jsx("span",{className:"idx",children:String(S+1).padStart(2,"0")}),A]},S))]})]}),o.jsx("div",{className:"host-actions",children:o.jsx("button",{onClick:()=>void Ci(0),children:x.mechanic==="jeopardy"?"Начать раунд →":x.mechanic==="race"?"К скачкам →":x.mechanic==="melody"?"К трекам →":x.mechanic==="sprint"?"Поехали →":"Первый вопрос →"})})]})}if(n.phase==="question"&&x.mechanic==="sprint")return o.jsxs("div",{className:"host-screen grid-bg",children:[o.jsx(wu,{pack:e,round:x,gameState:n,timerNode:o.jsx(Za,{startedAt:n.timer_started_at,seconds:x.timer_seconds,theme:e.theme})}),o.jsx("div",{className:"host-actions",children:o.jsx("button",{className:"ghost dark",onClick:()=>void Zi(0),children:"К ответам →"})})]});if(n.phase==="question"&&x.mechanic==="blitz")return o.jsx(Lx,{pack:e,round:x,gameState:n});if(n.phase==="question"&&x.mechanic==="race")return o.jsx(cx,{pack:e,round:x,gameState:n});if(n.phase==="question"&&x.mechanic==="melody")return o.jsx(sx,{pack:e,round:x,gameState:n});if(n.phase==="question"&&x.mechanic==="jeopardy")return o.jsx(zx,{pack:e,round:x,gameState:n});if(n.phase==="question"&&v){const y=v.media.question??[],A=y.filter(I=>!/\.(mp3|mp4|webm|wav)$/i.test(I)),S=y.filter(I=>/\.(mp3|mp4|webm|wav)$/i.test(I)),C=!!v.question_text.trim()&&A.length===1&&!v.media.hidden,M=v.answer.mode==="choice"||v.answer.mode==="order"?v.answer.choices:null,N=e.theme==="new_year",U=!!n.timer_started_at&&(Date.now()-new Date(n.timer_started_at).getTime())/1e3>x.timer_seconds-10,O=e.theme==="classic",k=!!v.question_text.trim(),B=e.theme==="potter"&&x.mechanic!=="rebus"?"pt-frame":N&&x.mechanic!=="rebus"?`q-frame${U?" low":""}`:O?"cyber-frame":"",D=!v.media.hidden&&A.length>1&&(v.answer.mode==="choice"&&v.answer.choices.length===A.length||v.answer.mode==="match"&&v.answer.left.length===A.length),q=((b=e.settings)!=null&&b.answers_reveal&&x.answers_reveal==="after_question",x.answers_reveal??"after_round");return o.jsxs("div",{className:`host-screen grid-bg${k?"":" no-qtext"}${A.length&&!v.media.hidden?" has-media":""}${M&&!D||v.answer.mode==="match"&&(v.answer.right_labels??[]).some(Boolean)?" has-choices":""}`,children:[o.jsx(Qa,{}),x.mechanic!=="jeopardy"&&o.jsxs(o.Fragment,{children:[o.jsx(Ix,{startedAt:n.timer_started_at,seconds:x.timer_seconds,q:v,round:x,pack:e,timerRunning:!!n.timer_started_at,manual:g,gameId:n.game_id,roundNumber:n.round_number}),o.jsx(Bx,{round:x,gameState:n,isLast:n.question_index+1>=x.questions.length}),o.jsx(Ox,{enabled:q==="after_question"&&!n.reveal,startedAt:n.timer_started_at,seconds:x.timer_seconds})]}),o.jsxs("div",{className:"host-topbar",children:[o.jsxs("span",{className:"qnum",children:["Р",Qn(e,n.round_number)," · ВОПРОС"," ",o.jsx("b",{children:n.question_index+1})," / ",x.questions.length]}),x.mechanic!=="jeopardy"&&o.jsx(Za,{startedAt:n.timer_started_at,seconds:x.timer_seconds,theme:e.theme},v.id)]}),C?o.jsxs("div",{className:"q-split",children:[o.jsxs("div",{className:B,children:[N&&o.jsx(cl,{seed:v.id,low:U}),O&&o.jsx("span",{className:"cf-scan","aria-hidden":"true"}),o.jsx(ll,{text:v.question_text},v.id)]}),o.jsx("div",{className:"q-media-grid n1",style:Js(v),children:A.map((I,Y)=>o.jsxs("figure",{className:"q-img",children:[o.jsx("img",{src:Xe(I),alt:""}),v.answer.mode==="match"&&o.jsx("figcaption",{children:Y+1})]},Y))})]}):o.jsxs(o.Fragment,{children:[k&&o.jsxs("div",{className:B,children:[N&&o.jsx(cl,{seed:v.id,low:U}),O&&o.jsx("span",{className:"cf-scan","aria-hidden":"true"}),o.jsx(ll,{text:v.question_text},v.id)]}),!v.media.hidden&&A.length>0&&(D?o.jsx("div",{className:`img-answers n${Math.min(A.length,5)}${A.length>1?" eq-row":""}`,children:A.map((I,Y)=>{var de,he;return o.jsx(wx,{src:Xe(I),badge:v.answer.mode==="match"?String(Y+1):((de=M==null?void 0:M[Y])==null?void 0:de.key)??"",children:v.answer.mode==="choice"&&((he=M==null?void 0:M[Y])==null?void 0:he.text)&&o.jsx("span",{className:"ia-text",children:M[Y].text})},Y)})}):o.jsx("div",{className:`q-media-grid n${Math.min(A.length,4)}${x.mechanic==="rebus"?" rebus":""}${A.length>1?" eq-row":""}${A.length>4?" wrap2":""}`,style:Js(v),children:A.map((I,Y)=>o.jsx(Qs,{src:Xe(I)},Y))}))]}),S.map((I,Y)=>/\.(mp4|webm)$/i.test(I)?o.jsx(Dx,{src:Xe(I),hidden:!!v.media.hidden,waitFor:!!v.media.voice,go:!!n.timer_started_at},Y):null),v.answer.mode==="match"&&(v.answer.right_labels??[]).some(Boolean)&&o.jsx("div",{className:`choices-grid${Ya(v.answer.right_labels??[])}`,children:v.answer.right.map((I,Y)=>{var de;return o.jsxs("div",{className:"choice-plate",style:{animationDelay:`${.3+Y*.3}s`},children:[o.jsx("span",{className:"key",children:I}),((de=v.answer.right_labels)==null?void 0:de[Y])??""]},I)})}),M&&!D&&o.jsx("div",{className:`choices-grid${Ya(M.map(I=>I.text))}`,children:M.map((I,Y)=>o.jsxs("div",{className:"choice-plate",style:{animationDelay:`${.3+Y*.35}s`},children:[o.jsx("span",{className:"key",children:I.key}),I.text]},I.key))}),(q==="after_question"||x.mechanic==="jeopardy")&&n.reveal&&o.jsxs("div",{className:"answer-reveal hud-frame",children:[o.jsx("div",{className:"answer-label",children:"ПРАВИЛЬНЫЙ ОТВЕТ"}),o.jsx("div",{className:"answer-main",children:es(v)}),v.answer_note&&o.jsx("div",{style:{opacity:.75},children:v.answer_note}),(()=>{const I=v.media.answer??[],Y=I.filter(he=>!/\.(mp3|wav|m4a|ogg)$/i.test(he)),de=I.find(he=>/\.(mp3|wav|m4a|ogg)$/i.test(he));return o.jsxs(o.Fragment,{children:[de&&o.jsx(Md,{src:Xe(de)}),Y.length>0&&o.jsx("div",{className:"q-media-grid",style:{maxHeight:"26vh"},children:Y.map((he,me)=>o.jsx("img",{src:Xe(he),alt:""},me))})]})})()]}),o.jsxs("div",{className:"host-actions",children:[o.jsx(hx,{gameState:n}),(q==="after_question"||x.mechanic==="jeopardy")&&!n.reveal&&o.jsx("button",{onClick:()=>void Gs(),children:"Показать ответ"}),n.question_index+1<x.questions.length?o.jsx("button",{onClick:()=>void Ci(n.question_index+1),children:"Дальше →"}):q==="after_round"?o.jsx("button",{onClick:()=>void vl(),children:"Время ответов →"}):o.jsx(ai,{pack:e,gameState:n})]})]})}if(n.phase==="info"){const y=((E=e==null?void 0:e.settings)==null?void 0:E.info_slides)??[],A=y[n.question_index]??y[0];if(A)return o.jsx(Cx,{pack:e,slide:A,packId:n.pack_id,gameState:n})}return n.phase==="recap"?o.jsx(Tx,{pack:e,round:x,gameState:n}):n.phase==="answer_time"?o.jsx(Ux,{pack:e,round:x,gameState:n}):n.phase==="show_answers"&&v?o.jsx(Fx,{pack:e,round:x,q:v,gameState:n}):n.phase==="scoreboard"?o.jsx(Hx,{pack:e,gameState:n}):n.phase==="break"?o.jsx(Vx,{pack:e,round:x,gameState:n}):n.phase==="counting"?o.jsx(Wx,{pack:e,gameState:n}):n.phase==="finale"?o.jsx(jx,{pack:e,gameId:n.game_id,gameState:n}):o.jsxs("div",{className:"host-screen grid-bg",children:[o.jsxs("div",{className:"mono-tag",children:["ФАЗА: ",n.phase]}),n.phase==="question"&&!v&&o.jsx("p",{style:{opacity:.7},children:"В этом раунде нет вопросов — добавь их в редакторе"}),o.jsx("div",{className:"host-actions",children:o.jsx("button",{onClick:()=>void nr("round_intro"),children:"← К титулу раунда"})})]})}function hx({gameState:n}){return n.question_index>0?o.jsx("button",{className:"ghost",onClick:()=>void Ci(n.question_index-1),children:"← Назад"}):o.jsx("button",{className:"ghost",onClick:()=>void nr("round_intro"),children:"← К титулу"})}function cl({seed:n,low:e}){const t=ee.useMemo(()=>{let i=0;for(const a of n)i=i*31+a.charCodeAt(0)>>>0;const s=()=>(i=i*1664525+1013904223>>>0,i/4294967296),r=60;return Array.from({length:r},(a,c)=>({left:(c+.5)*(100/r)+(s()-.5)*2.5,len:8+s()*34,delay:s()*.5,sway:3+s()*3}))},[n]);return o.jsx("div",{className:"icicles",children:t.map((i,s)=>o.jsx("span",{className:"icicle",style:{left:`${i.left}%`,height:i.len,"--len":`${i.len}px`,animationDelay:`${i.delay}s, ${i.delay}s`,animationDuration:`${i.sway}s, .7s`}},s))})}function fx(n){const e=(n??"").trim().length;return e<=90?"":e<=200?" n-m":e<=360?" n-l":" n-xl"}function Ya(n){const e=Math.max(0,...n.map(t=>(t??"").trim().length));return e<=28?"":e<=55?" c-m":e<=95?" c-l":" c-xl"}function ll({text:n}){const e=n.split(/(\s+)/);let t=0;const i=Ka([n]);return o.jsx("p",{ref:i,className:`q-text${Ni(n)}`,children:e.map((s,r)=>{if(/^\s+$/.test(s))return s;const a=.12*t++;return o.jsx("span",{className:"q-word",style:{animationDelay:`${a}s`},children:s},r)})})}function px(n){const e=n.join(" ").split(/\s+/).filter(Boolean);return Math.min(20,e.reduce((t,i)=>Math.max(t,i.length),0))}const Sn=ee.forwardRef(function({theme:e,lines:t},i){const s=px(t),r=t.join(`
`),a=wl(r,e==="classic"),c=e==="classic"?a.split(`
`):t;if(e!=="new_year")return o.jsx("h1",{ref:i,className:"neon-title title-anim","data-longest":s,style:{"--longest":s,"--lines":t.length},children:t.map((l,u)=>o.jsxs("span",{style:u===t.length-1&&t.length>1?{color:"var(--accent)"}:{},children:[c[u]??l,o.jsx("br",{})]},u))});let d=0;return o.jsx("h1",{ref:i,className:"neon-title","data-longest":s,style:{"--longest":s,"--lines":t.length},children:t.map((l,u)=>o.jsx("span",{style:{display:"block"},children:[...l].map((p,h)=>p===" "?o.jsx("span",{children:" "},h):o.jsx("span",{className:"ny-letter",style:{animationDelay:`${.06*d++}s`},children:p},h))},u))})});function mx(){Tl()}function gx(){try{const n=window.AudioContext??window.webkitAudioContext,e=new n,t=e.currentTime,i=e.createGain();i.gain.value=.5,i.connect(e.destination);const s=(r,a,c,d,l)=>{const u=e.createOscillator(),p=e.createGain();u.type=d,u.frequency.setValueAtTime(r,t+a),p.gain.setValueAtTime(1e-4,t+a),p.gain.linearRampToValueAtTime(l,t+a+.008),p.gain.setValueAtTime(l,t+a+c-.05),p.gain.exponentialRampToValueAtTime(1e-4,t+a+c),u.connect(p),p.connect(i),u.start(t+a),u.stop(t+a+c+.02)};for(let r=0;r<5;r++)s(1046.5,r*.22,.11,"square",.3);s(784,1.2,1.25,"square",.26),s(392,1.2,1.25,"sine",.3),setTimeout(()=>void e.close(),3e3)}catch{}}function Za({startedAt:n,seconds:e,theme:t,chime:i=!0}){const[s,r]=ee.useState(e),a=ee.useRef(!1);ee.useEffect(()=>{if(!n){r(e),a.current=!1;return}const l=()=>{const p=(Date.now()-new Date(n).getTime())/1e3,h=Math.max(0,Math.ceil(e-p));r(h),h===0&&i&&!a.current&&(a.current=!0,gx())};l();const u=setInterval(l,250);return()=>clearInterval(u)},[n,e,i]);const c=s<=10;if(t==="new_year"){const u=2*Math.PI*44,p=Math.max(0,Math.min(1,s/e)),h=Array.from({length:40},(x,v)=>{const m=v/40*Math.PI*2,f=7+v%3*3;return{x1:55+Math.cos(m)*39,y1:55+Math.sin(m)*39,x2:55+Math.cos(m)*(44+f-5),y2:55+Math.sin(m)*(44+f-5),rot:m*180/Math.PI}}),g=Array.from({length:7},(x,v)=>{const m=v/7*Math.PI*2+.4;return{cx:55+Math.cos(m)*44,cy:55+Math.sin(m)*44}});return o.jsxs("div",{className:`ny-wreath${c?" low":""}`,children:[o.jsxs("svg",{viewBox:"0 0 110 110",children:[h.map((x,v)=>o.jsx("line",{x1:x.x1,y1:x.y1,x2:x.x2,y2:x.y2,stroke:v%4===0?"#1f6b3a":"#2f8f4e",strokeWidth:"3",strokeLinecap:"round"},v)),o.jsx("circle",{className:"wr-bg",cx:"55",cy:"55",r:44}),o.jsx("circle",{className:"wr-fg",cx:"55",cy:"55",r:44,strokeDasharray:u,strokeDashoffset:u*(1-p)}),g.map((x,v)=>o.jsx("circle",{className:"wr-berry",cx:x.cx,cy:x.cy,r:"3.4"},v)),o.jsx("path",{className:"wr-bow",d:"M46,99 q9,-9 18,0 q-9,5 -18,0"})]}),o.jsx("span",{className:"val",children:s})]})}if(t==="potter")return o.jsx(Cl,{left:s,seconds:e,low:c});const d=!!n&&s>0;return o.jsxs("div",{className:`timer-wrap${c?" low":""}${d?"":" paused"}${n?"":" not-started"}`,children:[o.jsx("span",{className:"tm-orbit","aria-hidden":"true",children:o.jsx("i",{className:"tm-spark"})}),o.jsx("span",{className:`timer-num${c?" danger":""}`,children:s})]})}function xx(n,e){const t=(n??"").trim();if(!t)return null;const i=e?Math.max(0,t.length-3):3,s=e?t.slice(0,i):t.slice(i),r=e?t.slice(i):t.slice(0,i);return e?o.jsxs(o.Fragment,{children:[s,o.jsx("b",{className:"rebus-hot",children:r})]}):o.jsxs(o.Fragment,{children:[o.jsx("b",{className:"rebus-hot",children:r}),s]})}function _x(n,e){let t=0;for(const s of e)t=t*31+s.charCodeAt(0)>>>0;const i=[...n];for(let s=i.length-1;s>0;s--){t=t*1664525+1013904223>>>0;const r=t%(s+1);[i[s],i[r]]=[i[r],i[s]]}return i}function Js(n){const e=n.media.scale;if(!(e==null||e===100))return{"--ms":Math.min(100,Math.max(50,e))/100}}function Qs({src:n,children:e}){const[t,i]=ee.useState(1.5);return o.jsxs("figure",{className:"q-img",style:{flexGrow:t,flexBasis:0},children:[o.jsx("img",{src:n,alt:"",onLoad:s=>{const r=s.currentTarget;r.naturalWidth&&r.naturalHeight&&i(r.naturalWidth/r.naturalHeight)}}),e]})}const vx=5e3,_d=3300,Mx=500,Sx=900,dl=100,ul=600,hl=500;function yx(n){const e=n.answer;return e.mode==="choice"?_d+Mx+Sx:e.mode==="match"?dl+ul*Math.max(0,Math.min(e.left.length,6)-1)+hl:e.mode==="order"?dl+ul*Math.max(0,e.correct_order.length-1)+hl:1200}function bx({src:n}){const e=ee.useRef(null);return ee.useEffect(()=>{const t=e.current;if(!t)return;t.currentTime=0,t.play().catch(()=>{});const i=setTimeout(()=>{try{t.pause()}catch{}},1e4);return()=>{clearTimeout(i);try{t.pause()}catch{}}},[n]),o.jsx("div",{className:"reveal-video",children:o.jsx("video",{ref:e,src:n,playsInline:!0,muted:!1})})}function vd(n){return n>15?" rows-16":n>13?" rows-14":n>11?" rows-12":n>9?" rows-10":n>6?" rows-7":""}function Md({src:n}){return ee.useEffect(()=>{if(document.hidden)return;let e=!1;const t=Et();return t.src=n,t.loop=!1,t.play().then(()=>{if(e)try{t.pause(),t.src=""}catch{}}).catch(()=>{}),()=>{e=!0;try{t.pause(),t.src=""}catch{}}},[n]),null}function fl({side:n}){const e=n==="left"?["SYS::READY","NET 100%","NODE 07","SYNC OK","BUF 4096","CH 02"]:["LINK UP","PING 12ms","QUEUE 0","AUTH OK","TEMP 41C","RUN"];return o.jsxs("div",{className:`cyber-panel cp-${n}`,"aria-hidden":"true",children:[o.jsx("span",{className:"cp-bar"}),o.jsx("div",{className:"cp-rows",children:e.map((t,i)=>o.jsx("span",{className:"cp-row",style:{animationDelay:`${i*.4}s`},children:t},t))}),o.jsx("div",{className:"cp-code",children:Array.from({length:14},(t,i)=>o.jsx("i",{style:{width:`${2+i*7%5}px`}},i))})]})}function Ex({groups:n,onClose:e}){ee.useEffect(()=>{const i=s=>{s.key==="Escape"&&e()};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[e]);const t=n.reduce((i,s)=>i+s.length,0);return o.jsx("div",{className:"groups-overlay",onClick:e,children:o.jsxs("div",{className:"groups-modal","data-count":n.length,onClick:i=>i.stopPropagation(),children:[o.jsxs("div",{className:"gm-head",children:[o.jsxs("span",{className:"mono-tag",children:["СОСТАВЫ КОМАНД · ",n.length," · ",t," чел."]}),o.jsx("button",{className:"gm-close",onClick:e,"aria-label":"Закрыть",children:"✕"})]}),o.jsx("div",{className:"lg-list",children:n.map((i,s)=>o.jsxs("div",{className:"lg-team",children:[o.jsxs("div",{className:"lg-name",style:{color:Ud(s)},children:["Команда ",s+1]}),o.jsx("div",{className:"lg-players",children:i.join(" · ")})]},s))})]})})}function wx({src:n,badge:e,children:t}){const[i,s]=ee.useState(1.5);return o.jsxs("div",{className:"img-answer",style:{flexGrow:i,flexBasis:0},children:[o.jsxs("span",{className:"ia-frame",children:[o.jsx("span",{className:"ia-key",children:e}),o.jsx("img",{src:n,alt:"",onLoad:r=>{const a=r.currentTarget;a.naturalWidth&&a.naturalHeight&&s(a.naturalWidth/a.naturalHeight)}})]}),t]})}function Tx({pack:n,round:e,gameState:t}){const i=ee.useMemo(()=>e.questions.filter(h=>!h.hidden),[e.questions]),[s,r]=ee.useState(0),a=i[s],c=s+1>=i.length,d=()=>void vl(),l=()=>{c?d():r(h=>h+1)};if(ee.useEffect(()=>{if(!a){d();return}let h=!0;const g=()=>{h&&l()},x=setTimeout(g,vx),v=a.media.voice;if(!v)return()=>{h=!1,clearTimeout(x)};const m=Et();m.src=Xe(v),m.play().catch(()=>{});const f=()=>{clearTimeout(x),g()};return m.addEventListener("ended",f),()=>{h=!1,clearTimeout(x),m.removeEventListener("ended",f);try{m.pause()}catch{}}},[s,a==null?void 0:a.id]),!a)return null;const u=(a.media.question??[]).filter(h=>!/\.(mp3|wav|mp4|webm)$/i.test(h)),p=!!a.question_text.trim();return o.jsxs("div",{className:`host-screen grid-bg recap-screen${u.length?" has-media":""}${p?"":" no-qtext"}`,children:[o.jsxs("div",{className:"host-topbar",children:[o.jsx("span",{className:"mono-tag",children:"ПОВТОР ВОПРОСОВ"}),o.jsxs("span",{className:"qnum",children:[s+1," / ",i.length]})]}),o.jsxs("div",{className:"recap-body",children:[p&&o.jsx("p",{className:`q-text${Ni(a.question_text)}`,children:a.question_text}),u.length>0&&o.jsx("div",{className:`q-media-grid n${Math.min(u.length,4)}${u.length>1?" eq-row":""}${u.length>4?" wrap2":""}`,style:Js(a),children:u.map((h,g)=>o.jsx(Qs,{src:Xe(h)},g))})]},a.id),o.jsx("div",{className:"recap-dots","aria-hidden":"true",children:i.map((h,g)=>o.jsx("i",{className:g===s?"on":g<s?"done":""},g))}),o.jsxs("div",{className:"host-actions",children:[o.jsx("button",{className:"ghost",onClick:d,children:"Пропустить повтор"}),o.jsx("button",{onClick:l,children:c?"К ответам →":"Следующий →"})]})]})}function Ax({pack:n}){var e,t;return ee.useEffect(()=>{var c,d;const i=((c=n==null?void 0:n.settings)==null?void 0:c.lobby_music)??((d=n==null?void 0:n.settings)==null?void 0:d.bg_music);if(!i)return;const s=Et();s.src=Xe(i),s.loop=!0,s.volume=.45;let r=!1;const a=()=>{r||(r=!0,s.play().catch(()=>{}),window.removeEventListener("pointerdown",a),window.removeEventListener("keydown",a))};return s.play().then(()=>{r=!0}).catch(()=>{window.addEventListener("pointerdown",a),window.addEventListener("keydown",a)}),()=>{window.removeEventListener("pointerdown",a),window.removeEventListener("keydown",a);try{s.pause()}catch{}}},[(e=n==null?void 0:n.settings)==null?void 0:e.lobby_music,(t=n==null?void 0:n.settings)==null?void 0:t.bg_music]),null}function Rx(n,e){ee.useEffect(()=>{if(!n)return;const i=n.questions.filter(a=>!a.hidden)[e+1];if(!i)return;const s=[...i.media.question??[],...i.media.answer??[],...i.media.voice?[i.media.voice]:[]],r=[];for(const a of s){const c=Xe(a);if(/\.(mp3|wav|m4a|aac|ogg|opus|flac|mp4|webm)$/i.test(a)){const d=document.createElement(/\.(mp4|webm)$/i.test(a)?"video":"audio");d.preload="auto",d.src=c,r.push(d)}else{const d=new Image;d.src=c,r.push(d)}}return()=>{for(const a of r)try{a.src=""}catch{}}},[n,e])}function Cx({pack:n,slide:e,packId:t,gameState:i}){var c,d;const s=n.rounds.filter(l=>!l.off_scoreboard).map(l=>({id:l.id,name:(l.title_lines??[]).join(" ")||"—",count:l.questions.filter(u=>!u.hidden).length})),r=fn(i.game_id),a=qd(n,r.length);return o.jsxs(o.Fragment,{children:[o.jsx($d,{slide:e,rounds:s,stats:a,mediaUrl:Xe}),o.jsx("div",{className:"host-actions",children:o.jsx(Px,{slides:((c=n.settings)==null?void 0:c.info_slides)??[],index:Nx(n,e),packId:t,paper:((d=n.settings)==null?void 0:d.play_mode)==="paper"})})]})}function Nx(n,e){var t;return(((t=n.settings)==null?void 0:t.info_slides)??[]).findIndex(i=>i.id===e.id)}function Px({slides:n,index:e,packId:t,paper:i}){var r;const s=((r=n[e])==null?void 0:r.show_at)==="finale";return o.jsxs(o.Fragment,{children:[e>0&&o.jsx("button",{className:"ghost",onClick:()=>void Ei(e-1),children:"← Назад"}),e+1<n.length&&o.jsx("button",{className:"ghost",onClick:()=>void Ei(e+1),children:"Дальше →"}),s?i?o.jsx("button",{onClick:()=>void Xd(),children:"К подсчёту →"}):o.jsx("button",{onClick:()=>void tr(t),children:"К итогам →"}):o.jsx("button",{onClick:()=>void nr("round_intro"),children:"К раунду →"})]})}function Lx({pack:n,round:e,gameState:t}){var f;const{state:i,setState:s}=Fd(t.game_id,t.round_number),r=fn(t.game_id),a=kn(t.game_id,t.round_number,400),c=ee.useMemo(()=>e.questions.map(b=>({id:b.id,hidden:b.hidden})),[e.questions]),d=e.settings;ee.useEffect(()=>{var y;const b=d.bg_music??((y=n.settings)==null?void 0:y.bg_music);if(!b)return;const E=Et();return E.src=Xe(b),E.loop=!0,E.volume=.6,E.play().catch(()=>{}),()=>E.pause()},[e.id,d.bg_music,(f=n.settings)==null?void 0:f.bg_music]);const l=ee.useRef(!1),u=async b=>{if(!l.current){l.current=!0,s(b);try{if(await Vd(t.game_id,t.round_number,b),b.finished&&!(i!=null&&i.finished)){const E=Fo(Uo(b),d.timeoutPenalty??10),{error:y}=await kt.from("answers").upsert(E.map(A=>({team_id:A.teamId,game_id:t.game_id,question_ref:"q-blitz",round_number:t.round_number,answer_text:`место ${A.place}`,stake:A.score,updated_at:new Date().toISOString()})),{onConflict:"team_id,question_ref"});y&&console.error("блиц: итоги не записались",y)}}finally{l.current=!1}}};ee.useEffect(()=>{if(i||r.length<2)return;const b=setTimeout(()=>{const E=[...r].sort(()=>Math.random()-.5).map(y=>y.id);u(Od(E,d.teamSeconds??60))},3e3);return()=>clearTimeout(b)},[i,r.length]),ee.useEffect(()=>{if(!i||i.finished||i.current)return;const b=setTimeout(()=>{const E=Bd(c,i.used);if(!E)return void u(Co(i));Yd(E.id).catch(()=>{}),u(zd(i,E.id,Date.now()))},No);return()=>clearTimeout(b)},[i==null?void 0:i.current,i==null?void 0:i.turn,i==null?void 0:i.finished]);const p=i==null?void 0:i.current,h=p?e.questions.find(b=>b.id===p.questionId):void 0,g=i?gl(i):void 0;ee.useEffect(()=>{if(!i||!p||!h||!g)return;const b=a.find(y=>y.team_id===g&&y.question_ref===`q-${h.id}`);if(!(b!=null&&b.answer_text)||p.lastAnswer===b.answer_text)return;if(b.answer_text===kd){u(Po(ur(i,Date.now()),Date.now()));return}const E=Qr(h.answer,b.answer_text)===!0;u(Gd(i,Date.now(),E?"ok":"no",b.answer_text))},[a,p==null?void 0:p.questionId,p==null?void 0:p.lastAnswer]);const x=(p==null?void 0:p.verdict)==="no"&&p.attempts+1>=Lo;if(ee.useEffect(()=>{if(!i||!(p!=null&&p.verdict))return;const E=Math.max(0,(x?Wd:No)-(Date.now()-(p.pausedAt??Date.now()))),y=setTimeout(()=>{const A=Date.now(),S=ur(i,A),C=a.find(M=>M.team_id===g&&M.question_ref===`q-${p.questionId}`);C&&kt.from("answers").update({is_correct:p.verdict==="ok"}).eq("id",C.id).then(()=>{}),u(p.verdict==="ok"?Do(S,A):Io(S,A))},E);return()=>clearTimeout(y)},[p==null?void 0:p.verdict,p==null?void 0:p.lastAnswer]),!i)return o.jsxs("div",{className:"host-screen grid-bg bz-screen",children:[o.jsx("div",{className:"host-topbar",children:o.jsx("span",{className:"mono-tag",children:"БЛИЦ"})}),o.jsx(zo,{teams:r,rolling:!0})]});if(i.finished){const b=Fo(Uo(i),d.timeoutPenalty??10);return o.jsxs("div",{className:"host-screen grid-bg sb-screen",children:[o.jsx("div",{className:"mono-tag",children:"ИТОГИ БЛИЦА"}),o.jsxs("table",{className:"score-table",children:[o.jsx("thead",{children:o.jsxs("tr",{children:[o.jsx("th",{}),o.jsx("th",{children:"Команда"}),o.jsx("th",{children:"Очки"}),o.jsx("th",{children:"Баллы"})]})}),o.jsx("tbody",{children:b.map(E=>{var y;return o.jsxs("tr",{children:[o.jsxs("td",{children:[E.place,E.shared?"=":""]}),o.jsx("td",{children:((y=r.find(A=>A.id===E.teamId))==null?void 0:y.name)??"—"}),o.jsx("td",{children:E.points}),o.jsx("td",{children:E.score})]},E.teamId)})})]}),o.jsx("div",{className:"host-actions",children:o.jsx(ai,{pack:n,gameState:t})})]})}const v=i.current!=null||Object.values(i.correct).some(b=>b>0)||Object.values(i.missed).some(b=>b>0),m=!p&&i.lastReveal?(()=>{const b=e.questions.find(E=>E.id===i.lastReveal.questionId);if(b)return{questionText:b.question_text,answerText:es(b),verdict:i.lastReveal.verdict}})():void 0;return o.jsxs(o.Fragment,{children:[o.jsx(ou,{teams:r,state:i,bank:c,questionText:h==null?void 0:h.question_text,verdict:p==null?void 0:p.verdict,reveal:m,answerText:(p==null?void 0:p.verdict)==="ok"||(p==null?void 0:p.verdict)==="no"&&p.attempts+1>=Lo?es(h):void 0,dice:v?void 0:o.jsx(zo,{teams:r,rolling:!1,pickedId:i.order[0]})}),o.jsxs("div",{className:"host-actions",children:[(p==null?void 0:p.verdict)&&o.jsxs("button",{className:"ghost",onClick:()=>{const b=Date.now(),E=ur(i,b);u(p.verdict==="ok"?Io(E,b):Do(E,b))},children:["Исправить на «",p.verdict==="ok"?"неверно":"верно","»"]}),p&&p.verdict!=="ok"&&o.jsx("button",{className:"ghost",onClick:()=>void u(Po(i,Date.now())),children:"Скип −1"}),o.jsx("button",{className:"ghost dark",onClick:()=>{confirm("Завершить блиц досрочно?")&&u(Co(i))},children:"Завершить раунд"})]})]})}function es(n){const e="⚠ ответ не заполнен в редакторе",t=n.answer,i=t.display;return Array.isArray(i)?i.join(" · "):typeof i=="string"&&i?i:typeof t.correct=="string"&&t.correct?String(t.correct).split("/")[0].trim():typeof t.word=="string"&&t.word?t.word.toUpperCase():typeof t.correct_choice=="string"&&t.correct_choice?t.correct_choice:typeof t.correct_order=="string"&&t.correct_order?t.correct_order:Array.isArray(t.correct_pairs)&&t.correct_pairs.length?t.correct_pairs.join("  "):e}function Dx({src:n,hidden:e,waitFor:t,go:i}){const s=ee.useRef(null);return ee.useEffect(()=>{var r;t&&!i||(r=s.current)==null||r.play().catch(()=>{})},[t,i]),o.jsx("video",{ref:s,src:n,controls:!e,autoPlay:!t,style:e?{width:1,height:1,opacity:0}:{maxHeight:"46vh",borderRadius:14}})}function Ix({q:n,round:e,timerRunning:t,pack:i,startedAt:s,seconds:r,manual:a=!1,gameId:c,roundNumber:d}){const l=(n.media.question??[]).some(g=>/\.(mp3|mp4|webm|wav)$/i.test(g)),u=ee.useRef(null),p=ee.useRef(null),h=ee.useRef(!1);return ee.useEffect(()=>{if(mx(),a&&!l||t)return;let g=!1;const x=(n.media.question??[]).find(f=>/\.(mp3|wav|m4a|ogg)$/i.test(f));h.current=!1;const v=()=>{if(!g){if(h.current=!0,x){const f=Et();f.src=Xe(x),p.current=f,f.play().catch(()=>{})}ks(c&&d!=null?{gameId:c,roundNumber:d,questionRef:`q-${n.id}`}:void 0)}};if(!n.media.voice){v();return}const m=Et();return m.src=Xe(n.media.voice),u.current=m,m.onended=v,m.onerror=v,m.play().then(()=>{if(g)try{m.pause(),m.src=""}catch{}}).catch(v),()=>{var b;g=!0;const f=u.current;if(f){f.onended=null,f.onerror=null;try{f.pause(),f.src=""}catch{}}u.current=null,(b=p.current)==null||b.pause()}},[n.id,a]),ee.useEffect(()=>{if(!a||!t||l)return;let g=!1;const x=(n.media.question??[]).find(m=>/\.(mp3|wav|m4a|ogg)$/i.test(m)),v=()=>{if(g||!x)return;const m=Et();m.src=Xe(x),p.current=m,m.play().catch(()=>{})};if(n.media.voice){const m=Et();m.src=Xe(n.media.voice),u.current=m,m.onended=v,m.onerror=v,m.play().then(()=>{if(g)try{m.pause(),m.src=""}catch{}}).catch(v)}else v();return()=>{var f;g=!0;const m=u.current;if(m){m.onended=null,m.onerror=null;try{m.pause(),m.src=""}catch{}}u.current=null,(f=p.current)==null||f.pause()}},[n.id,a,t]),ee.useEffect(()=>{if(t||a)return;const g=setInterval(()=>{if(t)return;const x=u.current;x&&!x.paused&&!x.ended||ks(c&&d!=null?{gameId:c,roundNumber:d,questionRef:`q-${n.id}`}:void 0)},2e3);return()=>clearInterval(g)},[n.id,t,a]),ee.useEffect(()=>{var E;const g=e.settings.bg_music??((E=i==null?void 0:i.settings)==null?void 0:E.bg_music);if(!t||!g||l)return;const x=Et();x.src=Xe(g),x.loop=!0,x.volume=.6,x.play().catch(()=>{});let v;const m=(r??e.timer_seconds??60)*1e3,f=s?m-(Date.now()-new Date(s).getTime()):m,b=window.setTimeout(()=>{v=window.setInterval(()=>{x.volume=Math.max(0,x.volume-.1),x.volume<=.01&&(v&&clearInterval(v),x.pause())},80)},Math.max(0,f)+3e3);return()=>{clearTimeout(b),v&&clearInterval(v),x.pause()}},[t,n.id]),null}function Ux({pack:n,round:e,gameState:t}){var d;const i=e.settings.answerTimeSeconds??60,s=((d=n.settings)==null?void 0:d.play_mode)==="paper",r=fn(t.game_id),a=kn(t.game_id,t.round_number),c=e.questions.filter(l=>!l.hidden).length;return ee.useEffect(()=>{var p;const l=e.settings.bg_music??((p=n.settings)==null?void 0:p.bg_music);if(!l)return;const u=Et();return u.src=Xe(l),u.loop=!0,u.volume=.6,u.play().catch(()=>{}),()=>u.pause()},[e.id]),o.jsxs("div",{className:`host-screen grid-bg${s?" paper-answer-time":""}`,children:[o.jsxs("div",{className:"mono-tag",children:["РАУНД ",Qn(n,t.round_number)," :: ВРЕМЯ ОТВЕТОВ"]}),o.jsx("div",{className:"answer-pulse",children:o.jsx(Sn,{theme:n.theme,lines:[s?"СДАВАЙТЕ БЛАНКИ":"ОТВЕЧАЙТЕ!"]})}),o.jsx("div",{className:"meta-line",children:s?"ПЕРЕДАЙТЕ БЛАНКИ ВЕДУЩЕМУ":"КАПИТАНЫ ОТПРАВЛЯЮТ ОТВЕТЫ С ТЕЛЕФОНОВ"}),o.jsx(Za,{startedAt:t.timer_started_at,seconds:i,theme:n.theme}),!s&&o.jsx("div",{className:"answer-time-teams",children:r.map(l=>{const u=a.filter(h=>{var g;return h.team_id===l.id&&((g=h.answer_text)==null?void 0:g.trim())}).length,p=u>=c;return o.jsxs("div",{className:`at-team${p?" done":""}`,children:[o.jsx("span",{style:{color:l.color},children:l.name})," · ",u,"/",c]},l.id)})}),o.jsxs("div",{className:"host-actions",children:[o.jsx("button",{className:"ghost dark",onClick:()=>void Ci(e.questions.length-1),children:"← Назад"}),o.jsx("button",{onClick:()=>void Zi(0),children:"К ответам →"})]})]})}function Fx({pack:n,round:e,q:t,gameState:i}){var S;const s=((S=n.settings)==null?void 0:S.play_mode)==="paper",r=kn(i.game_id,i.round_number),a=i.reveal,c=fn(i.game_id),[d,l]=ee.useState([]);ee.useEffect(()=>{kt.from("teams").select("id,name,color").then(({data:C})=>l(C??[]))},[]);const u=r.filter(C=>C.question_ref===`q-${t.id}`),p=e.questions.length,h=i.question_index;ee.useEffect(()=>{if(a||document.hidden)return;const C=setTimeout(()=>{Gs()},3e3);return()=>clearTimeout(C)},[a,h]);const[g,x]=ee.useState(!1);ee.useEffect(()=>{if(x(!1),!a)return;const C=setTimeout(()=>x(!0),yx(t)+600);return()=>clearTimeout(C)},[a,t.id]),ee.useEffect(()=>{!g||document.hidden||u.forEach(C=>{if(C.is_correct!=null)return;const M=Qr(t.answer,C.answer_text);M!==null&&kt.from("answers").update({is_correct:M}).eq("id",C.id).then(()=>{})})},[g,h,u.length,u.map(C=>C.answer_text).join("|")]);const v=t.answer.mode==="choice"?t.answer.choices:null,m=(t.media.question??[]).filter(C=>!/\.(mp3|mp4|webm|wav)$/i.test(C)),f=(t.media.answer??[]).filter(C=>!/\.(mp3|mp4|webm|wav)$/i.test(C)),b=(t.media.question??[]).filter(C=>!/\.(mp3|mp4|webm|wav)$/i.test(C)),E=f.length?f:b,y=t.media.hidden?(t.media.question??[]).find(C=>/\.(mp4|webm)$/i.test(C)):void 0,A=(t.media.answer??[]).find(C=>/\.(mp3|wav|m4a|ogg)$/i.test(C));return o.jsxs("div",{className:`host-screen grid-bg${s?" paper-answers":""}`,style:{justifyContent:"flex-start"},children:[o.jsxs("div",{className:"host-topbar",children:[o.jsxs("span",{className:"mono-tag",children:["РАУНД ",Qn(n,i.round_number)," :: ОТВЕТЫ"]}),o.jsxs("span",{className:"qnum",children:["ВОПРОС ",o.jsx("b",{children:h+1})," / ",p]})]}),o.jsxs("div",{className:`answers-layout${a?" revealed":""}`,style:{marginTop:60},children:[o.jsxs("div",{className:`answers-main${a?" revealed":""}`,style:{flex:1.4,minHeight:0},children:[!a&&o.jsxs(o.Fragment,{children:[o.jsx("p",{className:`q-text${Ni(t.question_text)}`,children:t.question_text}),b.length>0&&!t.media.hidden&&o.jsx("div",{className:`q-media-grid n${Math.min(b.length,4)}${b.length>1?" eq-row":""}${b.length>4?" wrap2":""}`,style:Js(t),children:b.map((C,M)=>o.jsx(Qs,{src:Xe(C)},M))})]}),a&&t.answer.mode!=="match"&&t.question_text.trim()&&o.jsx("p",{className:`q-recall${Ni(t.question_text)}`,children:t.question_text}),a&&o.jsxs("div",{className:"answer-block reveal-in",children:[o.jsx("div",{className:"answer-label",children:"ПРАВИЛЬНЫЙ ОТВЕТ"}),y&&o.jsx(bx,{src:Xe(y)}),A&&o.jsx(Md,{src:Xe(A)}),e.mechanic==="rebus"?o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"answer-main",children:es(t)}),o.jsx("div",{className:"rebus-answer",children:b.slice(0,2).map((C,M)=>o.jsxs("figure",{className:"q-img",children:[o.jsx("img",{src:Xe(C),alt:""}),o.jsx("figcaption",{children:xx(M===0?t.service.word1:t.service.word2,M===0)})]},M))})]}):t.answer.mode==="match"?o.jsx(Gx,{q:t}):v&&m.length===v.length?o.jsx(pl,{q:t,choices:v,imgs:m}):v?o.jsx(pl,{q:t,choices:v}):t.answer.mode==="order"?o.jsx("div",{className:"order-answer",children:t.answer.correct_order.split("").map((C,M)=>{const N=t.answer.choices.find(U=>U.key===C);return o.jsxs("div",{className:"oi",children:[o.jsx("b",{children:C}),o.jsx("span",{className:"oi-pos",children:M+1}),o.jsx("span",{className:"oi-text",children:(N==null?void 0:N.text)??""})]},M)})}):o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"answer-main",children:es(t)}),E.length>0&&o.jsx("div",{className:`q-media-grid answer-media n${Math.min(E.length,4)}${E.length>1?" eq-row":""}${E.length>4?" wrap2":""}`,children:E.map((C,M)=>o.jsx(Qs,{src:Xe(C)},M))})]}),g&&t.answer_note&&o.jsx("div",{className:`answer-note${fx(t.answer_note)}`,children:t.answer_note})]})]}),!s&&o.jsxs("div",{className:"team-answers",children:[o.jsx("div",{className:"mono-tag",children:a?"ОТВЕТЫ КОМАНД":`ОТВЕТИЛИ: ${u.length}`}),u.length===0&&o.jsx("div",{style:{color:"var(--dim)"},children:"нет ответов"}),u.map(C=>{const M=c.find(U=>U.id===C.team_id)??d.find(U=>U.id===C.team_id),N=g?C.is_correct??Qr(t.answer,C.answer_text):null;return o.jsxs("div",{className:"team-answer",style:{borderLeft:`5px solid ${N===!0?"var(--ok)":N===!1?"var(--danger)":"var(--dim)"}`},children:[o.jsx("span",{className:"name",style:{color:M==null?void 0:M.color},children:(M==null?void 0:M.name)??"—"}),o.jsxs("span",{className:"text",children:[a?C.answer_text||"—":"• • •",C.stake!=null&&C.stake!==0&&o.jsxs("span",{style:{color:"var(--accent)",fontSize:".7em"},children:[" · ",C.stake]})]}),N!=null&&o.jsx("span",{className:"mark",style:{color:N?"var(--ok)":"var(--danger)"},children:N?"✓":"✗"})]},C.id)})]})]}),o.jsxs("div",{className:"host-actions",children:[h>0&&o.jsx("button",{className:"ghost",onClick:()=>void Zi(h-1,!0),children:"← Назад"}),a?h<p-1?o.jsx("button",{onClick:()=>void Zi(h+1),children:"Следующий вопрос →"}):o.jsx(ai,{pack:n,gameState:i}):o.jsx("button",{onClick:()=>void Gs(),children:"Показать ответ →"})]})]})}function pl({q:n,choices:e,imgs:t}){const[i,s]=ee.useState(0);ee.useEffect(()=>{s(0);const u=setTimeout(()=>s(1),2200),p=setTimeout(()=>s(2),_d);return()=>{clearTimeout(u),clearTimeout(p)}},[n.id]);const r=n.answer.correct_choice??"",a=e.filter(u=>u.key!==r),c=new Set(_x(a.map(u=>u.key),n.id).slice(0,2)),d=u=>i>=1||c.has(u)?i<2?"":u===r?" correct":" dimmed":" hidden-yet",l=u=>c.has(u)?0:.25*e.filter(p=>!c.has(p.key)).findIndex(p=>p.key===u);return t?o.jsx("div",{className:"choice-imgs",children:e.map((u,p)=>o.jsxs("div",{className:`choice-img${d(u.key)}`,style:{animationDelay:`${l(u.key)}s`},children:[o.jsx("img",{src:Xe(t[p]),alt:""}),o.jsxs("span",{className:"key",children:[u.key,u.text?` — ${u.text}`:""]})]},u.key))}):o.jsx("div",{className:`choices-grid${Ya(e.map(u=>u.text))}`,style:{width:"100%",marginTop:0,paddingTop:0},children:e.map(u=>o.jsxs("div",{className:`choice-plate${d(u.key)}`,style:{animationDelay:`${l(u.key)}s`},children:[o.jsx("span",{className:"key",children:u.key}),u.text]},u.key))})}function Ox({enabled:n,startedAt:e,seconds:t}){return ee.useEffect(()=>{if(!n||!e)return;const i=new Date(e).getTime()+t*1e3-Date.now(),s=setTimeout(()=>{Gs()},Math.max(0,i));return()=>clearTimeout(s)},[n,e,t]),null}function Bx({round:n,gameState:e,isLast:t}){const i=n.settings.autoAdvanceSec??0;return ee.useEffect(()=>{if(!i||!e.timer_started_at||t)return;const r=new Date(e.timer_started_at).getTime()+(n.timer_seconds+i)*1e3,a=Math.max(500,r-Date.now()),c=setTimeout(()=>{Ci(e.question_index+1)},a);return()=>clearTimeout(c)},[e.timer_started_at,e.question_index,i]),null}function zx({pack:n,round:e,gameState:t}){const i=e.settings.themes??[],[s,r]=ee.useState(null),a=(t.jeopardy_opened??[]).filter(m=>typeof m=="string"),[c,d]=ee.useState([]),[l,u]=ee.useState(null),p=[...new Set([...a,...c])],h=async m=>{d(m);const{error:f}=await kt.from("game_sessions").update({jeopardy_opened:m}).eq("id",ti());u(f?"Плитки не сохраняются: "+f.message+". Выполни миграцию 0006_jeopardy_opened.sql.":null),await kt.from("game_sessions").update({timer_started_at:null,reveal:!1}).eq("id",ti())},g=e.title_lines.join(" ")||"СВОЯ ИГРА",x=wl(g,n.theme==="classic");if(i.length===0)return o.jsxs("div",{className:"host-screen grid-bg",children:[o.jsx("div",{className:"mono-tag",children:"СВОЯ ИГРА"}),o.jsx("p",{children:"Темы не заполнены — добавь их в редакторе раунда"}),o.jsx("div",{className:"host-actions",children:o.jsx("button",{onClick:()=>void nr("round_intro"),children:"← К титулу"})})]});const v=Math.max(...i.map(m=>m.tiles.length));return o.jsxs("div",{className:"host-screen grid-bg jp-screen",children:[o.jsx("h1",{className:"neon-title jp-title",children:n.theme==="classic"?x:g}),o.jsxs("div",{className:"jp-board",style:{gridTemplateColumns:`repeat(${i.length}, minmax(0, 1fr))`,gridTemplateRows:`auto repeat(${v}, minmax(0, 1fr))`},children:[l&&o.jsxs("div",{className:"jp-save-err",children:["⚠ ",l]}),i.map((m,f)=>o.jsxs("div",{className:"jp-theme-name",style:{gridColumn:f+1,gridRow:1},children:[m.name||`Тема ${f+1}`,m.hint&&o.jsx("span",{className:"jp-theme-hint",children:m.hint})]},`h${f}`)),i.map((m,f)=>m.tiles.map((b,E)=>{const y=p.includes(`${f}-${E}`);return o.jsx("button",{className:`jp-tile${y?" done":""}`,disabled:y,"data-c":f%8,style:{gridColumn:f+1,gridRow:E+2},onClick:()=>{const A=i.slice(0,f).reduce((S,C)=>S+C.tiles.length,0)+E;Ci(A).then(()=>ks({gameId:t.game_id,roundNumber:t.round_number,questionRef:Hd(t.round_number,A)})),r({t:f,i:E})},children:y?"·":b.value},`${f}-${E}`)}))]}),o.jsx("div",{className:"host-actions",children:o.jsx(ai,{pack:n,gameState:t})}),s&&o.jsx(kx,{packTheme:n.theme,round:e,gameState:t,theme:i[s.t],tile:i[s.t].tiles[s.i],tileIndex:i.slice(0,s.t).reduce((m,f)=>m+f.tiles.length,0)+s.i,onClose:()=>{h([...p,`${s.t}-${s.i}`]),r(null)}})]})}function kx({round:n,gameState:e,theme:t,tile:i,tileIndex:s,onClose:r,packTheme:a}){const c=n.settings.clipSeconds??30,d=ee.useRef(null),[l,u]=ee.useState(c),[p,h]=ee.useState(!1),[g,x]=ee.useState(!1),v=kn(e.game_id,e.round_number),m=fn(e.game_id),[f,b]=ee.useState(null),E=()=>{var S;if((S=d.current)==null||S.stop(),!i.audio){h(!1),b("у плитки не задан трек");return}b(null),u(c),d.current=Eu(Xe(i.audio),c,{onStart:()=>h(!0),onTick:C=>u(C),onEnd:()=>h(!1),onError:C=>{h(!1),b(C)}})};ee.useEffect(()=>(E(),()=>{var S;(S=d.current)==null||S.stop()}),[s]);const y=v.filter(S=>jd(S.question_ref,e.round_number)===s).sort((S,C)=>+new Date(S.updated_at)-+new Date(C.updated_at)),A=async(S,C)=>{await kt.from("answers").update({is_correct:C}).eq("id",S)};return ml.createPortal(o.jsx("div",{className:`jp-overlay theme-${a??"classic"}`,children:o.jsxs("div",{className:"jp-modal hud-frame",children:[o.jsxs("div",{className:"jp-modal-head",children:[o.jsxs("div",{children:[o.jsx("div",{className:"jp-modal-theme",children:t.name}),o.jsxs("div",{className:"mono-tag",children:["ПЛИТКА · ",i.value]})]}),o.jsx("div",{className:`jp-count${p?" on":""}`,children:String(l).padStart(2,"0")})]}),g&&o.jsxs("div",{className:"answer-reveal hud-frame",style:{padding:"12px 18px"},children:[o.jsx("div",{className:"answer-label",children:"ПРАВИЛЬНЫЙ ОТВЕТ"}),o.jsx("div",{className:"answer-main",style:{fontSize:"clamp(24px,3vw,40px)"},children:i.correct})]}),o.jsxs("div",{className:"jp-answers",children:[o.jsx("div",{className:"mono-tag",children:g?"ОТВЕТЫ (ПО СКОРОСТИ)":`ОТВЕТИЛИ: ${y.length}`}),y.length===0&&o.jsx("div",{style:{color:"var(--dim)"},children:"ждём ответы…"}),y.map((S,C)=>{const M=m.find(N=>N.id===S.team_id);return o.jsxs("div",{className:"jp-answer",style:{borderLeft:`3px solid ${S.is_correct===!0?"var(--ok)":S.is_correct===!1?"var(--danger)":"var(--dim)"}`},children:[o.jsxs("span",{className:"pos",children:["#",C+1]}),o.jsx("span",{className:"name",style:{color:M==null?void 0:M.color},children:(M==null?void 0:M.name)??"—"}),o.jsx("span",{className:"txt",children:g?S.answer_text||"—":"• • •"}),g&&o.jsxs(o.Fragment,{children:[o.jsx("button",{className:`jp-grade ok${S.is_correct===!0?" chosen":""}`,onClick:()=>void A(S.id,!0),children:"✓"}),o.jsx("button",{className:`jp-grade no${S.is_correct===!1?" chosen":""}`,onClick:()=>void A(S.id,!1),children:"✗"})]})]},S.id)})]}),o.jsxs("div",{className:"jp-modal-foot",children:[!g&&o.jsx("button",{onClick:()=>x(!0),children:"Показать ответ"}),o.jsx("button",{className:"ghost",onClick:E,children:"↻ Переслушать"}),f&&o.jsxs("div",{className:"jp-audio-err",children:["🔇 ",f,o.jsx("button",{className:"ghost",style:{marginLeft:10},onClick:()=>void bu(Xe(i.audio)).then(S=>alert(S)),children:"что с файлом?"})]}),y.some(S=>S.is_correct==null)&&o.jsxs("div",{className:"jp-ungraded",children:["⚠ не оценено: ",y.filter(S=>S.is_correct==null).length]}),o.jsx("button",{className:"ghost dark",onClick:r,children:"Закрыть плитку"})]})]})}),document.body)}function Gx({q:n}){if(n.answer.mode!=="match")return null;const e=n.answer,t=(n.media.question??[]).filter(s=>!/\.(mp3|mp4|webm|wav)$/i.test(s)),i=e.correct_pairs;return o.jsx("div",{className:`match-answer n${Math.min(e.left.length,6)}`,children:e.left.map((s,r)=>{var d;const a=((d=i.find(l=>l.startsWith(s)))==null?void 0:d.slice(s.length))??"—",c=(e.right_labels??[])[(e.right??[]).indexOf(a)]||a;return o.jsxs("div",{className:"mi",children:[t[r]&&o.jsx("img",{src:Xe(t[r]),alt:""}),o.jsxs("div",{className:"mi-label",children:[o.jsxs("b",{children:[s," → ",a]}),c&&c!==a&&o.jsx("span",{className:"mi-text",children:c})]})]},s)})})}function Hx({pack:n,gameState:e}){const t=fn(e.game_id),i=kn(e.game_id),s=Sl(n,t,i),r=yl(n,t,i),a=n.rounds.filter(g=>!g.off_scoreboard),c=bl(t,s,i,r),d=c.map(g=>g.team),[l,u]=ee.useState(0);ee.useEffect(()=>{if(u(0),d.length===0)return;const g=setInterval(()=>u(x=>x>=d.length?x:x+1),2200);return()=>clearInterval(g)},[d.length,e.round_number]);const p=ee.useRef(null),h=Ka([d.length,a.length],{shrinkBefore:p});return o.jsxs("div",{className:"host-screen grid-bg sb-screen",children:[o.jsx("div",{className:"mono-tag",children:"ПОЛОЖЕНИЕ КОМАНД"}),o.jsx("h2",{className:"sb-title",ref:p,children:"ПРОМЕЖУТОЧНЫЕ РЕЗУЛЬТАТЫ"}),o.jsx("div",{className:"sb-table-wrap",children:o.jsxs("table",{ref:h,className:`score-table${vd(d.length)}`,children:[o.jsx("thead",{children:o.jsxs("tr",{children:[o.jsx("th",{}),o.jsx("th",{children:"Команда"}),a.map((g,x)=>o.jsxs("th",{children:["Р",x+1]},g.id)),o.jsx("th",{children:"Σ"})]})}),o.jsx("tbody",{children:d.map((g,x)=>{const v=c.find(b=>b.team.id===g.id),m=(v==null?void 0:v.place)??1,f=x>=d.length-l;return o.jsxs("tr",{className:`sb-row${f?" is-in":" is-veiled"}${m===1?" leader":""}`,children:[o.jsxs("td",{children:[m<=3?o.jsx("span",{className:"sb-medal",children:o.jsx(ea,{theme:n.theme,place:m})}):m,(v==null?void 0:v.shared)&&o.jsx("span",{className:"sb-eq",children:"="})]}),o.jsx("td",{style:{color:g.color,fontFamily:"var(--font-display)"},children:o.jsx("span",{className:"sb-name",children:g.name})}),a.map(b=>{const E=r.get(g.id)??[];return o.jsx("td",{children:E[n.rounds.indexOf(b)]??0},b.id)}),o.jsx("td",{className:"total",children:s.get(g.id)??0})]},g.id)})})]})}),o.jsx("div",{className:"host-actions",children:o.jsx(ai,{pack:n,gameState:e})})]})}function Vx({pack:n,round:e,gameState:t}){const i=e.settings.break_after_minutes??10,[s,r]=ee.useState(i*60);ee.useEffect(()=>{const d=t.timer_started_at?new Date(t.timer_started_at).getTime():Date.now(),l=()=>r(Math.max(0,Math.round(i*60-(Date.now()-d)/1e3)));l();const u=setInterval(l,500);return()=>clearInterval(u)},[t.timer_started_at,i]);const a=String(Math.floor(s/60)).padStart(2,"0"),c=String(s%60).padStart(2,"0");return o.jsxs("div",{className:"host-screen grid-bg break-screen",children:[o.jsx("div",{className:"mono-tag accent",children:"АНТРАКТ"}),o.jsx(Sn,{theme:n.theme,lines:["ПЕРЕРЫВ"]}),o.jsx(Ks,{theme:n.theme}),o.jsxs("div",{className:"break-timer",children:[a,":",c]}),o.jsx("div",{className:"host-actions",children:o.jsx(ai,{pack:n,gameState:t})})]})}function Wx({pack:n,gameState:e}){var c,d;const[i,s]=ee.useState(300);ee.useEffect(()=>{const l=e.timer_started_at?new Date(e.timer_started_at).getTime():Date.now(),u=()=>s(Math.max(0,Math.round(5*60-(Date.now()-l)/1e3)));u();const p=setInterval(u,500);return()=>clearInterval(p)},[e.timer_started_at]),ee.useEffect(()=>{var p,h;const l=((p=n.settings)==null?void 0:p.finale_music)??((h=n.settings)==null?void 0:h.bg_music);if(!l||document.hidden)return;const u=Et();return u.src=Xe(l),u.loop=!0,u.volume=.55,u.play().catch(()=>{}),()=>{try{u.pause(),u.src=""}catch{}}},[(c=n.settings)==null?void 0:c.finale_music,(d=n.settings)==null?void 0:d.bg_music]);const r=String(Math.floor(i/60)).padStart(2,"0"),a=String(i%60).padStart(2,"0");return o.jsxs("div",{className:"host-screen grid-bg break-screen counting-screen",children:[o.jsx("div",{className:"mono-tag accent",children:"ПОДВОДИМ ИТОГИ"}),o.jsx(Sn,{theme:n.theme,lines:["СЧИТАЕМ","БАЛЛЫ"]}),o.jsx(Ks,{theme:n.theme}),o.jsxs("div",{className:"break-timer",children:[r,":",a]}),o.jsx("div",{className:"counting-sub",children:"Скоро объявим победителей"}),o.jsx("div",{className:"host-actions",children:o.jsx("button",{onClick:()=>void tr(e.pack_id,!0),children:"К итогам →"})})]})}function jx({pack:n,gameId:e,gameState:t}){var M,N,U,O,k,Q;const i=fn(e),s=kn(e),r=Sl(n,i,s),a=yl(n,i,s),c=bl(i,r,s,a),d=!!t.reveal,l=t.question_index??0,[u,p]=ee.useState(!((M=n.settings)!=null&&M.show_final_cinematic));ee.useEffect(()=>{var q,I;const B=((q=n.settings)==null?void 0:q.finale_music)??((I=n.settings)==null?void 0:I.bg_music);if(!B||document.hidden||!u)return;const D=Et();return D.src=Xe(B),D.loop=!0,D.volume=.55,D.play().catch(()=>{}),()=>{try{D.pause(),D.src=""}catch{}}},[(N=n.settings)==null?void 0:N.finale_music,(U=n.settings)==null?void 0:U.bg_music,u]);const h=ee.useRef(null),g=Ka([c.length],{shrinkBefore:h}),v=n.rounds.map((B,D)=>({r:B,i:D})).filter(B=>!B.r.off_scoreboard).map(({r:B,i:D})=>{var Y;let q=null,I=-1/0;for(const de of i){const he=((Y=a.get(de.id))==null?void 0:Y[D])??0;he>I&&(I=he,q=de)}return{round:B,idx:D,team:q,score:I}}),m=3e3,f=1e4,b=v.length;ee.useEffect(()=>{if(d||l>b||!u)return;const D=setTimeout(()=>void Ei(l+1),l===b?f:m);return()=>clearTimeout(D)},[d,l,b,u]);const[E,y]=ee.useState(0);if(ee.useEffect(()=>{if(y(0),c.length===0)return;let B=!1,D=0,q;const I=()=>{B||(D+=1,y(D),!(D>=c.length)&&(q=setTimeout(I,Math.max(320,900-90*D))))};return q=setTimeout(I,Math.max(320,900-90*D)),()=>{B=!0,clearTimeout(q)}},[c.length,l,d]),!u)return o.jsx(Q0,{onDone:()=>p(!0)});const A=["#ffd700","#ff2fa0","#00e5ff","#b6ff3c","#ff8c42"],S=o.jsx(o.Fragment,{children:Array.from({length:5},(B,D)=>o.jsxs("div",{className:"fw-burst",style:{left:`${12+D*19}%`,top:`${18+D%3*14}%`},children:[o.jsx("span",{className:"fw-flash",style:{background:`radial-gradient(circle, ${A[D%A.length]}55, transparent 70%)`,"--dur":`${2.2+D*.3}s`,"--delay":`${D*.45}s`}}),Array.from({length:10},(q,I)=>o.jsx("span",{className:"fw-spark",style:{background:A[(D+I)%A.length],"--a":`${I*36}deg`,"--dur":`${2.2+D*.3}s`,"--delay":`${D*.45}s`}},I))]},D))}),C=o.jsxs("div",{className:"fin-breakdown",children:[o.jsx("div",{className:"mono-tag",children:"РАЗБИВКА ПО РАУНДАМ"}),o.jsx("div",{className:"fin-table-wrap",children:o.jsxs("table",{ref:g,className:`fin-table${vd(c.length)}`,children:[o.jsx("thead",{children:o.jsxs("tr",{children:[o.jsx("th",{}),o.jsx("th",{children:"Команда"}),n.rounds.map((B,D)=>!B.off_scoreboard&&o.jsxs("th",{children:["Р",Qn(n,D)]},B.id)),o.jsx("th",{children:"Σ"})]})}),o.jsx("tbody",{children:c.map(({team:B,place:D,shared:q},I)=>{const Y=I>=c.length-E;return o.jsxs("tr",{className:`fin-row${D<=3?" top3":""}${D===1?" fin-first":""}${Y?" is-in":" is-veiled"}`,children:[o.jsxs("td",{className:"fin-pos",children:[D,q&&o.jsx("span",{className:"sb-eq",children:"="})]}),o.jsx("td",{style:{color:B.color},children:o.jsx("span",{className:"sb-name",children:B.name})}),n.rounds.map((de,he)=>{var me;return!de.off_scoreboard&&o.jsx("td",{children:((me=a.get(B.id))==null?void 0:me[he])??0},de.id)}),o.jsx("td",{children:o.jsx("b",{children:r.get(B.id)??0})})]},B.id)})})]})})]});if(d){const B=[...new Set(c.map(I=>I.place))].filter(I=>I<=3).sort((I,Y)=>Y-I);if(l>=B.length)return o.jsxs("div",{className:"host-screen grid-bg fin-screen",children:[S,o.jsx("div",{className:"mono-tag",children:"ИТОГИ ИГРЫ"}),o.jsx(Sn,{ref:h,theme:n.theme,lines:["РЕЗУЛЬТАТЫ"]}),C,o.jsx("div",{className:"host-actions",children:o.jsx("button",{onClick:()=>{confirm("Начать новую игру?")&&Kr()},children:"⟲ Новая игра"})})]});const D=B[l],q=c.filter(I=>I.place===D);return o.jsxs("div",{className:"host-screen grid-bg fin-screen",onClick:()=>void Ei(l+1),children:[D===1&&S,o.jsx("div",{className:"mono-tag",children:"НАГРАЖДЕНИЕ"}),o.jsxs("div",{className:`fin-award p${D}`,children:[o.jsxs("div",{className:"fin-award-place",children:[D," МЕСТО"]}),o.jsx("div",{className:"fin-award-medal",children:o.jsx(ea,{theme:n.theme,place:D})}),q.length>0?q.map(I=>o.jsx("div",{className:"fin-award-name",style:{color:I.team.color},children:I.team.name},I.team.id)):o.jsx("div",{className:"fin-award-name",children:"—"})]})]})}if(l<b){const B=v[l];return o.jsxs("div",{className:"host-screen grid-bg fin-screen",onClick:()=>void Ei(l+1),children:[o.jsx("div",{className:"mono-tag",children:"ВСПОМИНАЕМ ИГРУ"}),o.jsxs("div",{className:"fin-slide",children:[o.jsxs("div",{className:"fin-slide-round",children:["Раунд ",Qn(n,B.idx)," · ",B.round.title_lines.join(" ")]}),o.jsx("div",{className:"fin-slide-label",children:"лучший результат"}),o.jsx("div",{className:"fin-slide-team",style:{color:(O=B.team)==null?void 0:O.color},children:((k=B.team)==null?void 0:k.name)??"—"})]}),o.jsx("div",{className:"fin-progress",children:o.jsx("i",{style:{animationDuration:"3s"}})},l),o.jsx("div",{className:"fin-dots",children:v.map((D,q)=>o.jsx("span",{className:q===l?"on":""},q))})]})}if(l===b){const B=c.filter(D=>D.place===1);return o.jsxs("div",{className:"host-screen grid-bg fin-screen",onClick:()=>void Ei(l+1),children:[S,o.jsx("div",{className:"mono-tag",children:B.length>1?"ПОБЕДИТЕЛИ ИГРЫ":"ПОБЕДИТЕЛЬ ИГРЫ"}),o.jsxs("div",{className:"fin-award p1",children:[o.jsx("div",{className:"fin-award-medal",children:o.jsx(ea,{theme:n.theme,place:1})}),B.length>0?B.map(D=>o.jsx("div",{className:"fin-award-name",style:{color:D.team.color},children:D.team.name},D.team.id)):o.jsx("div",{className:"fin-award-name",children:"—"}),o.jsx("div",{className:"fin-award-score",children:((Q=B[0])==null?void 0:Q.total)??0})]}),o.jsx("div",{className:"fin-progress",children:o.jsx("i",{style:{animationDuration:"10s"}})},"w")]})}return o.jsxs("div",{className:"host-screen grid-bg fin-screen",children:[S,o.jsx("div",{className:"mono-tag",children:"ИТОГИ ИГРЫ"}),o.jsx(Sn,{theme:n.theme,lines:["РЕЗУЛЬТАТЫ"]}),C,o.jsx("div",{className:"host-actions",children:o.jsx("button",{onClick:()=>{confirm("Начать новую игру?")&&Kr()},children:"⟲ Новая игра"})})]})}export{t_ as HostScreen,Ya as choicesLenClass,fx as noteClass,mx as stopAllMedia};
